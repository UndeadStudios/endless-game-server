...
public class TradeStage1Interface extends Interface {
    ...
    protected void build() {
        ...
        bind("Remove Item", (player, slotId, itemId, option) -> {
            ...
            final com.zenyte.game.world.entity.player.container.impl.Trade trade = player.getTrade();
            final com.zenyte.game.item.Item item = trade.getContainer().get(slotId);
            if (item == null) {
                return;
            }
            if (option == 5) {
