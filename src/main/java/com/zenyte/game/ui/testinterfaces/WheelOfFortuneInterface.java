...
public class WheelOfFortuneInterface extends Interface {
    ...
    public void open(Player player) {
        final com.zenyte.game.content.wheeloffortune.WheelOfFortune wheelOfFortune = player.getWheelOfFortune();
        int type = wheelOfFortune.isPendingReward() ? 1 : 0;
        if (!wheelOfFortune.isPendingReward()) {
            wheelOfFortune.roll();
        }
        final com.zenyte.game.world.entity.player.container.Container container = wheelOfFortune.getContainer();
        final com.zenyte.game.item.Item reward = wheelOfFortune.getPrize();
