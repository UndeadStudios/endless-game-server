...
public class ExperienceTrackerInterface extends Interface {
    ...
    private static final int[] SKILLS = new int[] {ATTACK, STRENGTH, RANGED, MAGIC, DEFENCE, HITPOINTS, PRAYER, AGILITY, HERBLORE, THIEVING, CRAFTING, RUNECRAFTING, MINING, SMITHING, FISHING, COOKING, FIREMAKING, WOODCUTTING, FLETCHING, SLAYER, FARMING, CONSTRUCTION, HUNTER};
