...
public class ChartershipInterface extends Interface {
    ...
    private void charter(final Player player, final CharterLocation destination) {
        final com.zenyte.game.content.sailing.CharterLocation location = CharterLocation.getLocation(player.getLocation());
        if (location == null || destination == null) {
            return;
        }
        final com.zenyte.game.item.Item cost = new Item(995, destination.getCosts()[location.ordinal()]);
