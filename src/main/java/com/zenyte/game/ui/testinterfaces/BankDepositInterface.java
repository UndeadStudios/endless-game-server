...
public class BankDepositInterface extends Interface {
    ...
    protected void build() {
        bind("Interact with Item", (player, slotId, itemId, option) -> {
            ...
            final com.zenyte.game.ui.testinterfaces.BankDepositInterface.ItemOption op = ItemOption.of(option);
        ...
        bind("Deposit loot", player -> {
            ...
            final com.zenyte.game.world.entity.player.container.Container container = lootingBag.getContainer();
    ...
    private enum ItemOption {
        ...
        private static final ItemOption of(final int option) {
            final com.zenyte.game.ui.testinterfaces.BankDepositInterface.ItemOption opt = Utils.findMatching(values, v -> v.optionId == option);
            if (opt == null) {
