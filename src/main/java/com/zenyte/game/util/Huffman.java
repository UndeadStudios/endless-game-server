...
public final class Huffman {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(Huffman.class);
    ...
    public static final void load() {
        try {
            ...
            final mgi.tools.jagcached.cache.Group group = archive.findGroupByName("huffman");
