...
public class ShopInventoryInterface extends Interface {
    ...
    protected void build() {
        bind("Interact with item", ((player, slotId, itemId, option) -> {
            ...
            final com.zenyte.game.shop.Shop shop = (Shop) shopAttr;
            ...
            final com.zenyte.game.shop.ShopInventoryInterface.ItemOption op = ItemOption.of(option);
    ...
    enum ItemOption {
        ...
        private static ItemOption of(final int option) {
            final com.zenyte.game.shop.ShopInventoryInterface.ItemOption constant = Utils.findMatching(values, value -> value.optionId == option);
            if (constant == null) {
