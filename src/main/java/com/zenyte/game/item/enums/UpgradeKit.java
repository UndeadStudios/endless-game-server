...
public enum UpgradeKit {
    STEAM_STAFF(12795, 12798, 11787), MYSTIC_STEAM_STAFF(12796, 12798, 11789), LAVA_STAFF(21198, 21202, 3053), MYSTIC_LAVA_STAFF(21200, 21202, 3054), DRAGON_PICKAXE(12797, 12800, 11920), ODIUM_WARD(12807, 12802, 11926), MALEDICTION_WARD(12806, 12802, 11924), GRANITE_MAUL(12848, 12849, 4153);
