...
public class ClanChannelFull implements GamePacketEncoder {
	...
	public GamePacketOut encode() {
		final com.zenyte.game.packet.ServerProt prot = ServerProt.CLANCHANNEL_FULL;
		final com.zenyte.network.io.RSBuffer buffer = new RSBuffer(prot);
		final io.netty.buffer.ByteBuf prebuiltBuffer = builder.getBuffer().resetReaderIndex();
