...
public class PacketDispatcher {
	...
	public void initFriendsList() {
		final java.util.List<java.lang.String> friends = player.getSocialManager().getFriends();
		final java.util.ArrayList<com.zenyte.game.packet.out.UpdateFriendList.FriendEntry> list = new ArrayList<UpdateFriendList.FriendEntry>(friends.size());
		for (final java.lang.String friend : friends) {
	...
	public void initIgnoreList() {
		final java.util.List<java.lang.String> ignores = player.getSocialManager().getIgnores();
		final java.util.ArrayList<com.zenyte.game.packet.out.UpdateIgnoreList.IgnoreEntry> list = new ArrayList<UpdateIgnoreList.IgnoreEntry>(ignores.size());
		for (final java.lang.String ignore : ignores) {
