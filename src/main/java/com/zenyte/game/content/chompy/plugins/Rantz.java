...
public class Rantz extends NPCPlugin {
        ...
        bind("Talk-to", (player, npc) -> {
            player.getDialogueManager().start(new Dialogue(player, npc) {
                ...
                public void buildDialogue() {
                    ...
                    final com.zenyte.game.item.Item bow = new Item(ItemId.OGRE_BOW);
                    ...
                    final com.zenyte.game.item.Item coins = new Item(ItemId.COINS_995, amount);
                    ...
                    final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.content.chompy.ChompyBirdHat> hats = getHats(player);
                    ...
                    if (hats.isEmpty()) {
                        ...
                        hats.iterator().forEachRemaining(hat -> {
                            final com.zenyte.game.item.Item item = new Item(hat.getItemId(), 1);
                    ...
                    final com.zenyte.game.item.Item bellows = new Item(ItemId.OGRE_BELLOWS, 1);
    ...
    private ObjectArrayList<ChompyBirdHat> getHats(final Player player) {
        final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.content.chompy.ChompyBirdHat> list = new ObjectArrayList<ChompyBirdHat>();
