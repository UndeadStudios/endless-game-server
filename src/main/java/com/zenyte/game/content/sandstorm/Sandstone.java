...
public enum Sandstone {
    ONE_KG(ItemId.SANDSTONE_1KG, 1), TWO_KG(ItemId.SANDSTONE_2KG, 2), FIVE_KG(ItemId.SANDSTONE_5KG, 4), TEN_KG(ItemId.SANDSTONE_10KG, 8);
    ...
    private Sandstone(final int itemId, final int bucketsOfSand) {
        this.itemId = itemId;
