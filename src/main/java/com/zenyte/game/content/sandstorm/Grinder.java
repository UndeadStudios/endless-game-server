...
public class Grinder implements ObjectAction {
    ...
    public static void deposit(@NotNull final Player player) {
        ...
        for (final com.zenyte.game.content.sandstorm.Sandstone sandstone : Sandstone.SANDSTONES) {
        ...
        final java.lang.Number newBucketsOfSand = player.incrementNumericAttribute(BUCKET_OF_SAND_AMOUNT_KEY, bucketsOfSandToAdd);
