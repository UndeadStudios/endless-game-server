...
public class BedabinCarpet extends MagicCarpet {
	...
	public CameraPositionAction getStartCameraPositionAction() {
		final com.zenyte.game.world.entity.Location pos = forward ? new Location(3302, 3110, 0) : new Location(3183, 3052, 0);
		return new CameraPositionAction(player, pos, 2500, -128, 0);
	}

	@Override
	public CameraPositionAction getEndCameraPositionAction() {
		final com.zenyte.game.world.entity.Location pos = forward ? new Location(3300, 3109, 0) : new Location(3177, 3048, 0);
		return new CameraPositionAction(player, pos, 2500, -128, 0);
	}

	@Override
	public CameraLookAction getStartCameraLookAction() {
		final com.zenyte.game.world.entity.Location pos = forward ? new Location(3308, 3109, 0) : new Location(3179, 3043, 0);
		return new CameraLookAction(player, pos, 0, -128, 0);
	}

	@Override
	public CameraLookAction getEndCameraLookAction() {
		final com.zenyte.game.world.entity.Location pos = forward ? new Location(3308, 3109, 0) : new Location(3181, 3044, 0);
		return new CameraLookAction(player, pos, 0, -128, 0);
	}
}
