...
public class AlchemicalDoor implements ObjectAction {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AlchemicalDoor.class);
    ...
    private static void open(final Player player) {
        final com.zenyte.game.content.kebos.alchemicalhydra.instance.AlchemicalHydraInstance instance = (AlchemicalHydraInstance) player.getArea();
        for (final com.zenyte.game.world.object.WorldObject door : instance.getDoors()) {
            World.removeObject(door);
        }
        for (final com.zenyte.game.world.object.WorldObject door : instance.getGraphicalDoors()) {
