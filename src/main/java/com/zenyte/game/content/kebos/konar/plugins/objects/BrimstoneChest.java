...
public class BrimstoneChest implements ObjectAction {
    ...
    private enum ChestReward {
        UNCUT_DIAMOND(12, new ImmutableItem(1618, 25, 35)), UNCUT_RUBY(12, new ImmutableItem(1620, 25, 35)), COAL(12, new ImmutableItem(454, 300, 500)), COINS(12, new ImmutableItem(995, 50000, 150000)), GOLD_ORE(15, new ImmutableItem(445, 100, 200)), DRAGON_ARROWTIPS(15, new ImmutableItem(11237, 50, 200)), IRON_ORE(20, new ImmutableItem(441, 350, 500)), RUNE_FULL_HELM(20, new ImmutableItem(1164, 2, 4)), RUNE_PLATEBODY(20, new ImmutableItem(1128, 1, 2)), RUNE_PLATELEGS(20, new ImmutableItem(1080, 1, 2)), RAW_FISH(20, null), RUNITE_ORE(30, new ImmutableItem(452, 10, 15)), STEEL_BAR(30, new ImmutableItem(2354, 300, 500)), MAGIC_LOGS(30, new ImmutableItem(1514, 120, 160)), DRAGON_DART_TIP(30, new ImmutableItem(11232, 40, 160)), PALM_TREE_SEED(60, new ImmutableItem(5289, 2, 4)), MAGIC_SEED(60, new ImmutableItem(5316, 2, 3)), CELASTRUS_SEED(60, new ImmutableItem(22869, 2, 4)), DRAGONFRUIT_TREE_SEED(60, new ImmutableItem(22877, 2, 4)), REDWOOD_TREE_SEED(60, new ImmutableItem(22871, 1, 1)), TORSTOL_SEED(60, new ImmutableItem(5304, 3, 5)), SNAPDRAGON_SEED(60, new ImmutableItem(5300, 3, 5)), RANARR_SEED(60, new ImmutableItem(5295, 3, 5)), PURE_ESSENCE(60, new ImmutableItem(7937, 3000, 6000)), BROKEN_DRAGON_HASTA(200, new ImmutableItem(22963, 1, 1)), MYSTIC_HAT_DUSK(1000, new ImmutableItem(23047, 1, 1)), MYSTIC_ROBE_TOP_DUSK(1000, new ImmutableItem(23050, 1, 1)), MYSTIC_ROBE_BOTTOM_DUSK(1000, new ImmutableItem(23053, 1, 1)), MYSTIC_GLOVES_DUSK(1000, new ImmutableItem(23056, 1, 1)), MYSTIC_BOOTS_DUSK(1000, new ImmutableItem(23059, 1, 1));
        ...
        static {
            int total = 0;
            for (final com.zenyte.game.content.kebos.konar.plugins.objects.BrimstoneChest.ChestReward entry : values()) {
                final double probability = 1.0 / entry.rate;
                final int weight = (int) (1000000 * probability);
                total += weight;
                final com.zenyte.game.item.ImmutableItem reward = entry.reward == null ? new ImmutableItem(-1, 0, 0, weight) : entry.reward;
        ...
        private static final Optional<Item> randomReward(@NotNull final Player player) {
            ...
            int current = 0;
            for (final java.util.Map.Entry<com.zenyte.game.content.kebos.konar.plugins.objects.BrimstoneChest.ChestReward, com.zenyte.game.item.ImmutableItem> reward : rewards.entrySet()) {
                final com.zenyte.game.item.ImmutableItem item = reward.getValue();
                if ((current += (int) item.getRate()) >= random) {
                    if (item.getId() == -1) {
                        final java.util.Optional<com.zenyte.game.content.kebos.konar.plugins.objects.BrimstoneChest.ChestReward.FishReward> fishReward = rollFish(player);
                        if (!fishReward.isPresent()) {
                            return Optional.empty();
                        }
                        final com.zenyte.game.content.kebos.konar.plugins.objects.BrimstoneChest.ChestReward.FishReward fish = fishReward.get();
        ...
        private static final Optional<FishReward> rollFish(@NotNull final Player player) {
            ...
            final it.unimi.dsi.fastutil.objects.ObjectOpenHashSet<com.zenyte.game.content.kebos.konar.plugins.objects.BrimstoneChest.ChestReward.FishReward> fishSet = new ObjectOpenHashSet<FishReward>();
            for (final com.zenyte.game.content.kebos.konar.plugins.objects.BrimstoneChest.ChestReward.FishReward reward : FishReward.values) {
        ...
        private enum FishReward {
            RAW_TUNA(0, new ImmutableItem(360, 100, 350)), RAW_LOBSTER(35, new ImmutableItem(378, 100, 350)), RAW_SWORDFISH(50, new ImmutableItem(372, 100, 300)), RAW_MONKFISH(62, new ImmutableItem(7945, 100, 300)), RAW_SHARK(80, new ImmutableItem(384, 100, 250)), RAW_SEA_TURTLE(79, new ImmutableItem(396, 80, 200)), RAW_MANTA_RAY(81, new ImmutableItem(390, 80, 160));
            private final int levelThreshold;
            private final ImmutableItem reward;
            private static final FishReward[] values = values();

            private FishReward(final int levelThreshold, final ImmutableItem reward) {
                this.levelThreshold = levelThreshold;
                this.reward = reward;
            }
        }

        private ChestReward(final double rate, final ImmutableItem reward) {
            this.rate = rate;
            this.reward = reward;
        }
    }
