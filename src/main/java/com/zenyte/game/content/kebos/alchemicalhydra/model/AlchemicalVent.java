...
public enum AlchemicalVent {
    RED(34568, new Location(1371, 10263, 0), POISON, FLAME), GREEN(34569, new Location(1371, 10272, 0), LIGHTNING, POISON), BLUE(34570, new Location(1362, 10272, 0), FLAME, LIGHTNING);
    ...
    private AlchemicalVent(final int objectId, final Location location, final HydraPhase weakeningPhase, final HydraPhase empoweringPhase) {
