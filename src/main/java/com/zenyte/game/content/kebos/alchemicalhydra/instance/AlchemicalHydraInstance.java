...
public class AlchemicalHydraInstance extends DynamicArea implements CycleProcessPlugin, LogoutPlugin, DeathPlugin, CannonRestrictionPlugin, LootBroadcastPlugin {
    ...
    private VentObject redVent;
    private VentObject greenVent;
    private VentObject blueVent;
    private VentObject[] vents;
    private WorldObject[] doors;
    private WorldObject[] graphicalDoors;
    private Rectangle innerCenter;
    private Rectangle outerCenter;
    ...
    public final List<FireWallBlock> buildWallTiles() {
        final com.zenyte.game.world.entity.Location tile = getStaticLocation(player.getLocation());
        final com.zenyte.game.content.kebos.alchemicalhydra.model.FireWall firewall = FireWall.select(tile);
    ...
    public void constructed() {
        ...
        final com.zenyte.game.world.entity.Location currentTile = getLocation(player.getLocation());
    ...
    public void process() {
        ...
        if (entered) {
            if (ventDelay == 5) {
                for (final com.zenyte.game.content.kebos.alchemicalhydra.model.VentObject vent : vents) {
