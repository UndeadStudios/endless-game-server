...
public class RocksObstacle implements ObjectAction {
    ...
    private enum Rocks {
        ...
        static {
            for (final com.zenyte.game.content.kebos.konar.plugins.objects.RocksObstacle.Rocks r : all) {
        ...
        private Rocks(final int rotation, final BiFunction<Player, WorldObject, Location> handler) {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        final com.zenyte.game.content.kebos.konar.plugins.objects.RocksObstacle.Rocks rocks = Rocks.get(rotation);
        if (rocks == null) {
            return;
        }
        final java.util.function.BiFunction<com.zenyte.game.world.entity.player.Player, com.zenyte.game.world.object.WorldObject, com.zenyte.game.world.entity.Location> handler = rocks.getHandler();
        final com.zenyte.game.world.entity.Location destination = handler.apply(player, object);
