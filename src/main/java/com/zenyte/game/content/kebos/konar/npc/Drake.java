    ...
    public int attack(Entity target) {
        if (attacks >= 7) {
            if (target instanceof Player) {
                ...
                final com.zenyte.game.world.entity.npc.impl.slayer.dragons.Dragonfire.DragonfireBuilder dragonfire = new Dragonfire.DragonfireBuilder(DragonfireType.CHROMATIC_DRAGONFIRE, 8, DragonfireProtection.getProtection(player), builder) {
                    @Override
