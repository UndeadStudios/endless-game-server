...
public enum LumbridgeDiary implements Diary {
	...
	CATCH_IMPLING(MEDIUM, p -> p.inArea("Puro-Puro"), "Catch an Essence or Eclectic impling in Puro-Puro."), CRAFT_LAVA_RUNES(MEDIUM, NO_PREDICATE, "Craft some Lava runes at the fire altar in Al Kharid."), //done
	...
	LIGHT_MINING_HELMET(HARD, true, "Light your mining helmet in the Lumbridge castle", "basement."), RECHARGE_PRAYER(HARD, CLAN_WARS::inArea, "Recharge your prayer at Clan Wars with Smite activated."), //done
	...
	static {
		...
		for (final com.zenyte.game.content.achievementdiary.diaries.LumbridgeDiary value : VALUES) {
