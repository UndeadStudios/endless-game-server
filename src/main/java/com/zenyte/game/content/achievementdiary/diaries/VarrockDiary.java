...
public enum VarrockDiary implements Diary {
	...
	CHOP_DOWN_DYING_TREE(EASY, p -> p.inArea("Lumberyard"), "Chop down a dying tree in the Lumber Yard."), BUY_NEWSPAPER(EASY, true, "Buy a newspaper."), GIVE_DOG_BONE(EASY, true, "Give a dog a bone!"), SPIN_AND_FIRE_A_BOWL(EASY, false, 1 | 2, p -> p.inArea("Barbarian Village"), "Spin a bowl on the pottery wheel and fire it in the oven in", "Barb Village.") {
		@Override
	...
	PURCHASE_AND_EQUIP_SPOTTIER_CAPE(HARD, true, "Trade furs with the Fancy Dress Seller for a spottier cape", "and equip it."), OBTAIN_153_KUDOS(HARD, true, "Speak to Orlando Smith when you have achieved 153", "Kudos."), MAKE_WAKA_CANOE(HARD, NO_PREDICATE, "Make a Waka Canoe near Edgeville."), //done
	...
	static {
		...
		for (final com.zenyte.game.content.achievementdiary.diaries.VarrockDiary value : VALUES) {
