...
public enum WesternProvincesDiary implements Diary {
    ...
    CATCH_A_DASHING_KEBBIT(HARD, true, "Catch a Dashing Kebbit."), COMPLETE_APE_ATOLL_COURSE_LAP(HARD, true, "Complete a lap of the Ape Atoll agility course."), CHOP_AND_BURN_MAHOGANY_LOGS(HARD, false, 1 | 2, p -> p.inArea("Ape Atoll"), "Chop and burn some Mahogany logs on Ape Atoll.") {
        @Override
        public boolean flagging() {
            return true;
        }
    ...
    //done
    MINE_ADAMANTITE_IN_TIRANNWN(HARD, true, "Mine some Adamantite ore in Tirannwn."), CHECK_PALM_TREE_HEALTH(HARD, "Check the health of your Palm tree in Lletya."), //done
    ...
    static {
        ...
        for (final com.zenyte.game.content.achievementdiary.diaries.WesternProvincesDiary value : VALUES) {
