...
public enum FremennikDiary implements Diary {
    ...
    OBTAIN_SUPPORT_FROM_KINGDOM(HARD, true, "Obtain 100% support from your kingdom subjects."), TELEPORT_TO_WATERBIRTH_ISLAND(HARD, NO_PREDICATE, "Teleport to Waterbirth Island."), //done
    ...
    static {
        ...
        for (final com.zenyte.game.content.achievementdiary.diaries.FremennikDiary value : VALUES) {
