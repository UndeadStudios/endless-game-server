...
public enum KourendDiary implements Diary {
    ...
    BROWSE_WARRENWS_GENERAL_STORE(EASY, true, "Browse the Warrens General Store."), TAKE_LANDS_END_BOAT(EASY, NO_PREDICATE, "Take a boat to Land\'s End."), //done
    ...
    static {
        ...
        for (final com.zenyte.game.content.achievementdiary.diaries.KourendDiary value : VALUES) {
    ...
    public DiaryChunk[] chunks() {
        return new DiaryChunk[] {new DiaryChunk(7933, 12, 7929), new DiaryChunk(7934, 13, 7930), new DiaryChunk(7935, 10, 7931), new DiaryChunk(7936, 8, 7932)};
    }
