...
public enum FaladorDiary implements Diary {
	...
	REPAIR_BROKEN_STRUT(EASY, NO_PREDICATE, "Repair a broken strut in the Motherlode Mine."), CLAIM_A_SECURITY_BOOK(EASY, true, "Claim a security book from the Security guard at Port", "Sarim jail."), SMITH_BLURITE_LIMBS(EASY, NO_PREDICATE, "Smith some Blurite Limbs on Doric\'s Anvil."),  // done
	...
	static {
		...
		for (final com.zenyte.game.content.achievementdiary.diaries.FaladorDiary value : VALUES) {
