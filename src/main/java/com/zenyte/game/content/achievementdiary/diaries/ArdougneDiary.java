...
public enum ArdougneDiary implements Diary {
	...
	GRAPPLE_YANILLE_SOUTH_WALL(MEDIUM, true, "Grapple over Yanille\'s south wall."), HARVEST_STRAWBERRIES(MEDIUM, "Harvest some strawberries from the Ardougne farming", "patch."), CAST_ARDOUGNE_TELEPORT_SPELL(MEDIUM, NO_PREDICATE, "Cast the Ardougne Teleport spell."), //done
	...
	STEAL_FROM_KING_LATHAS_CHEST(HARD, true, "Attempt to steal from King Lathas\' chest."), GET_PUT_TO_MONKEY_CAGE(HARD, true, "Have a zookeeper put you in Ardougne Zoo\'s monkey", "cage."), TELEPORT_WATCHTOWER(HARD, NO_PREDICATE, "Teleport to the Watchtower."), //done
	...
	static {
		...
		for (final com.zenyte.game.content.achievementdiary.diaries.ArdougneDiary value : VALUES) {
	...
	public DiaryChunk[] chunks() {
		return new DiaryChunk[] {new DiaryChunk(6291, 10, 4499), new DiaryChunk(6292, 12, 4500), new DiaryChunk(6293, 12, 4501), new DiaryChunk(6294, 8, 4502)};
	}
