...
public final class DarkAltarRoom extends RaidArea {
    ...
    public void loadRoom() {
        final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.entity.Location> tiles = new ObjectArrayList<>(Arrays.asList(spawnLocations[index]));
        ...
        for (final com.zenyte.game.world.entity.Location t : tiles) {
