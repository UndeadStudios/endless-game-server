...
public final class Vanguard extends RaidNPC<VanguardRoom> implements CombatScript {
	...
	public void sendDeath() {
		final com.zenyte.game.content.chambersofxeric.npc.Vanguard[] vanguards = room.getVanguards();
		final int amount = (int) (vanguards[0].getCombatDefinitions().getHitpoints() * 0.33F);
		final com.zenyte.game.content.chambersofxeric.npc.Vanguard zero = vanguards[0];
		final com.zenyte.game.content.chambersofxeric.npc.Vanguard one = vanguards[1];
		final com.zenyte.game.content.chambersofxeric.npc.Vanguard two = vanguards[2];
	...
	private final Set<Location> getRandomTiles(@NotNull final Entity target) {
		final it.unimi.dsi.fastutil.objects.ObjectOpenHashSet<com.zenyte.game.world.entity.Location> set = new ObjectOpenHashSet<Location>();
		...
		while (--count > 0) {
			...
			final com.zenyte.game.world.entity.Location tile = target.getLocation().transform(Utils.random(-3, 3), Utils.random(-3, 3), 0);
	...
	public int attack(final Entity target) {
		if (getId() == NpcId.VANGUARD_7529) {
			...
			getRandomTiles(target).forEach(tile -> {
				...
				final com.zenyte.game.world.entity.Location targetTile = first ? new Location(target.getLocation()) : tile;
