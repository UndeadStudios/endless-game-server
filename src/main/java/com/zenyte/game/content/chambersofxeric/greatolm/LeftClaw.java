...
public final class LeftClaw extends GreatOlmClaw {
    ...
    boolean shouldClench() {
        final org.apache.commons.lang3.mutable.MutableInt collectiveDamage = new MutableInt();
    ...
    protected void spawnClawlessObject() {
        ...
        final com.zenyte.game.world.object.WorldObject defeatedClaw = new WorldObject(29885, 10, side == OlmRoom.LEFT ? OlmRoom.leftSideLeftClawObject.getRotation() : OlmRoom.rightSideLeftClawObject.getRotation(), room.getLocation(side == OlmRoom.LEFT ? OlmRoom.leftSideLeftClawObject : OlmRoom.rightSideLeftClawObject));
