...
public enum BossPattern {
    ...
    public final List<RaidRoom> random(final int length) {
        ...
        final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.content.chambersofxeric.map.RaidRoom> list = new ObjectArrayList<RaidRoom>(length);
