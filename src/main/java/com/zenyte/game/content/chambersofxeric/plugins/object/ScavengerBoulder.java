    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        player.getRaid().ifPresent(raid -> {
            if (option.equalsIgnoreCase("Push")) {
                ...
                final com.zenyte.game.content.chambersofxeric.room.LargeScavengerRoom.BlockingObject blockingObject = (LargeScavengerRoom.BlockingObject) object;
                final com.zenyte.game.util.Direction direction = player.getX() < object.getX() ? Direction.EAST : player.getX() > object.getX() ? Direction.WEST : player.getY() > object.getY() ? Direction.SOUTH : Direction.NORTH;
                if (blockingObject.getLevelRequired() == -1) {
                    final int dir = Utils.getMoveDirection(direction.getOffsetX(), direction.getOffsetY());
                ...
                player.getActionManager().setAction(new Action() {
                    ...
                    public int processWithDelay() {
                        ...
                        for (final com.zenyte.game.world.entity.player.Player player : blockingObject.getInteractingPlayers()) {
                        ...
                        final com.zenyte.game.content.chambersofxeric.plugins.object.ScavengerBoulder.BoulderNPC boulder = new BoulderNPC(object, direction, destination -> {
