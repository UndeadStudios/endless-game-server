...
public class SharedStorageInterface extends StorageInterface {
    ...
    public void open(final Player player) {
        final com.zenyte.game.content.chambersofxeric.Raid raid = player.getRaid().orElseThrow(RuntimeException::new);
        final com.zenyte.game.content.chambersofxeric.storageunit.SharedStorage storage = raid.constructOrGetSharedStorage();
