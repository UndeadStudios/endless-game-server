...
public final class MuttadileRoom extends RaidArea implements CycleProcessPlugin {
    ...
    public void unleashLargeMuttadile() {
        ...
        final com.zenyte.game.util.Direction dir = largeMuttadile.getMovementDirection();
    ...
    public void clearPath() {
        ...
        WorldTasksManager.schedule(() -> {
            for (final com.zenyte.game.world.entity.Location tendril : tendrilSpawnLocations[index]) {
    ...
    public void loadRoom() {
        ...
        final com.zenyte.game.world.entity.Location location = getObjectLocation(treeSpawnLocations[index], 2, 2, getRotation());
