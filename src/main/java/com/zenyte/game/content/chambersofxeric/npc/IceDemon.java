...
public final class IceDemon extends RaidNPC<IceDemonRoom> implements CombatScript {
	...
	public int attack(final Entity target) {
		final org.apache.commons.lang3.mutable.MutableBoolean magicPrayer = new MutableBoolean();
		final org.apache.commons.lang3.mutable.MutableBoolean rangedPrayer = new MutableBoolean();
		getPossibleTargets(EntityType.PLAYER).forEach(t -> {
			final com.zenyte.game.world.entity.player.Player player = (Player) t;
			final com.zenyte.game.content.skills.prayer.PrayerManager prayers = player.getPrayerManager();
		...
		setAnimation(attack);
		final com.zenyte.game.world.entity.Location targetTile = new Location(target.getLocation());
		if (style == 0) {
			...
			WorldTasksManager.schedule(() -> {
				...
				for (final com.zenyte.game.world.entity.player.Player p : getRoom().getRaid().getPlayers()) {
