...
public final class DeathlyRoom extends RaidArea {
    ...
    public void loadRoom() {
        ...
        final com.zenyte.game.world.entity.Location[] mages = mageSpawnLocations[index];
        final com.zenyte.game.world.entity.Location[] rangers = rangerSpawnLocations[index];
        ...
        final com.zenyte.game.world.object.WorldObject barrier = barrierLocations[index];
