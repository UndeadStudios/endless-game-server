...
public final class RaidFishing extends Action {
    ...
    public boolean start() {
        final java.util.Optional<com.zenyte.game.content.skills.fishing.FishingTool.Tool> tool = FishingTool.FISHING_ROD.getTool(player);
        if (!tool.isPresent()) {
        ...
        for (final com.zenyte.game.content.chambersofxeric.skills.RaidFish data : RaidFish.values) {
    ...
    public RaidFishing(final WorldObject spot) {
        this.spot = spot;
    }
}
