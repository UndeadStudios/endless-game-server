...
public final class LuxGrub extends RaidNPC<VespulaRoom> {
	...
	public void feed(@NotNull final Player player, @NotNull final OptionalInt optionalSlot) {
		...
		final com.zenyte.game.item.Item item = !optionalSlot.isPresent() ? null : inventory.getItem(optionalSlot.getAsInt());
	...
	public void sendDeath() {
		...
		WorldTasksManager.schedule(() -> {
			...
			for (final com.zenyte.game.content.chambersofxeric.npc.LuxGrub grub : this.room.getGrubs()) {
				final com.zenyte.game.content.chambersofxeric.npc.VespineSoldier relatedSoldier = grub.soldier;
