	...
	public int attack(final Entity target) {
		...
		if (melee) {
			...
			if (magic == 0) {
				...
				final com.zenyte.game.world.entity.masks.Hit hit = magic(target, combatDefinitions.getMaxHit());
				World.sendSoundEffect(getLocation(), vulnStartSound);
				final com.zenyte.game.world.entity.SoundEffect sound = hit.getDamage() == 0 ? splashSound : vulnHitSound;
				...
				final com.zenyte.game.world.entity.masks.Hit hit = magic(target, (int) ((25 + (raid.getOriginalPlayers().size() / 4)) * (raid.isChallengeMode() ? 1.5F : 1.0F)));
				...
				final com.zenyte.game.world.entity.SoundEffect sound = hit.getDamage() == 0 ? splashSound : fireHitSound;
