...
public final class Swap implements OlmCombatScript {
				...
				case 2: 
					...
					pairs.forEach(pair -> {
						...
						if (distance == 0) {
							...
							final com.zenyte.game.world.entity.player.Player secondaryPlayer = pair.getSecondary();
	...
	private static final class PlayerPair {
		...
		public void setSecondary(final Player secondary) {
			this.secondary = secondary;
		}
		...
		public void setTile(final Location tile) {
			this.tile = tile;
		}
