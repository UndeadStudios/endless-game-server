...
public final class AcidSpray implements OlmCombatScript {
	...
	public void handle(final GreatOlm olm) {
		...
		while (trycount-- > 0 && count > 0) {
			...
			count--;
			final com.zenyte.game.world.Projectile projectile = new Projectile(1364, 65, 0, 30, 15, 0, 0, 10);
			WorldTasksManager.schedule(new WorldTask() {
				...
				public void run() {
					...
					final com.zenyte.game.content.chambersofxeric.greatolm.AcidPool pool = new AcidPool(t);
