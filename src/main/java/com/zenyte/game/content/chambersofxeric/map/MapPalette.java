...
class MapPalette implements Iterable<MapChunk> {
     ...
     */
    void crop() {
        final java.awt.Point minimum = getMinimumPoint();
        final java.awt.Point maximum = getMaximumPoint();
        ...
        final com.zenyte.game.content.chambersofxeric.map.MapChunk[][] croppedPalette = new MapChunk[maxX - minX][maxY - minY];
        for (int x = minX; x < maxX; x++) {
            for (int y = minY; y < maxY; y++) {
                final com.zenyte.game.content.chambersofxeric.map.MapChunk chunk = palette[x][y];
    ...
    private final void print() {
        ...
        for (final com.zenyte.game.content.chambersofxeric.map.MapChunk room : this) {
     ...
     * The last direction in which way the chunk was facing.
     */
    public void setLastDirection(@NotNull final ChunkDirection lastDirection) {
        if (lastDirection == null) {
            throw new NullPointerException("lastDirection is marked non-null but is null");
        }
