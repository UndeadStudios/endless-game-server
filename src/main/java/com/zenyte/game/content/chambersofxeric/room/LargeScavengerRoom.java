...
public final class LargeScavengerRoom extends ScavengerRoom {
    ...
    public void loadRoom() {
        ...
        final int skill = id == ROCK ? Skills.MINING : id == TREE ? Skills.WOODCUTTING : Skills.STRENGTH;
    ...
    public static final class BlockingObject extends WorldObject {
        ...
        public boolean equals(@org.jetbrains.annotations.Nullable final Object o) {
            ...
            if (this$interactingPlayers == null ? other$interactingPlayers != null : !this$interactingPlayers.equals(other$interactingPlayers)) return false;
            return true;
        }
