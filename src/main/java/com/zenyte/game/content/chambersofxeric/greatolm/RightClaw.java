...
public final class RightClaw extends GreatOlmClaw {
	...
	protected void spawnClawlessObject() {
		...
		final com.zenyte.game.world.object.WorldObject defeatedClaw = new WorldObject(29888, 10, side == OlmRoom.LEFT ? OlmRoom.leftSideRightClawObject.getRotation() : OlmRoom.rightSideRightClawObject.getRotation(), room.getLocation(side == OlmRoom.LEFT ? OlmRoom.leftSideRightClawObject : OlmRoom.rightSideRightClawObject));
