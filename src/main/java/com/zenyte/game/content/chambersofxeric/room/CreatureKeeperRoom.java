...
public final class CreatureKeeperRoom extends RaidArea implements CycleProcessPlugin {
   ...
   public static final void onServerLaunch(final ServerLaunchEvent event) {
      final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.object.WorldObject> firstRoomList = new ObjectArrayList<WorldObject>(64);
      final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.object.WorldObject> secondRoomList = new ObjectArrayList<WorldObject>(64);
      final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.object.WorldObject> thirdRoomList = new ObjectArrayList<WorldObject>(64);
      staticChests.add(firstRoomList);
      staticChests.add(secondRoomList);
      staticChests.add(thirdRoomList);
      final it.unimi.dsi.fastutil.objects.ObjectCollection<com.zenyte.game.world.object.WorldObject> objects = World.getRegion(13140, true).getObjects().values();
      for (final com.zenyte.game.world.object.WorldObject object : objects) {
         if (object == null || object.getId() != 29742) {
            continue;
         }
         final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.object.WorldObject> list = object.getX() < 3294 ? firstRoomList : secondRoomList;
         list.add(object);
      }
      for (final com.zenyte.game.world.object.WorldObject object : World.getRegion(13396, true).getObjects().values()) {
         if (object == null || object.getId() != 29742) {
            continue;
         }
   ...
   public void loadRoom() {
      final java.util.List<com.zenyte.game.world.object.WorldObject> staticSpawns = staticChests.get(index);
      assert staticSpawns != null;
      final it.unimi.dsi.fastutil.ints.IntOpenHashSet usedChests = new IntOpenHashSet();
   ...
   private final void recalculateHayPosition() {
      final com.zenyte.game.world.entity.Location hay = new Location(Integer.MAX_VALUE);
      for (int x = this.hay.getX() - 4; x < this.hay.getX() + 4; x++) {
         for (int y = this.hay.getY() - 4; y < this.hay.getY() + 4; y++) {
            final com.zenyte.game.world.region.Region region = World.getRegion(Location.getRegionId(x, y), true);
            final com.zenyte.game.world.object.WorldObject[] objects = region.getObjects(getToPlane(), x & 63, y & 63);
            final com.zenyte.game.world.object.WorldObject matchingObject = Utils.findMatching(objects, obj -> obj != null && (obj.getId() == 3471 || obj.getId() == 3472));
   ...
   public static final class Trough extends WorldObject {
      ...
      public boolean equals(@org.jetbrains.annotations.Nullable final Object o) {
         ...
         if (!(o instanceof CreatureKeeperRoom.Trough)) return false;
         final CreatureKeeperRoom.Trough other = (CreatureKeeperRoom.Trough) o;
         if (!other.canEqual((Object) this)) return false;
         if (!super.equals(o)) return false;
         if (this.getStage() != other.getStage()) return false;
         return true;
      }
   ...
   private static final class Chest extends WorldObject {
      ...
      public boolean equals(@org.jetbrains.annotations.Nullable final Object o) {
         if (o == this) return true;
         if (!(o instanceof CreatureKeeperRoom.Chest)) return false;
   ...
   private static final class ChestLootingAction extends Action {
      ...
      public int processWithDelay() {
         ...
         if (Utils.random(100) <= success) {
            player.unlock();
            final org.apache.commons.lang3.mutable.MutableInt typeInt = new MutableInt(room.batHash == chest.getPositionHash() ? 20 : room.poisonHashes.contains(chest.getPositionHash()) ? 19 : Utils.random(18));
            ...
            if (type < 10) {
               ...
               final org.apache.commons.lang3.mutable.MutableInt amount = new MutableInt(1);
               ...
               final com.zenyte.game.item.Item psykk = new Item(batsItem);
