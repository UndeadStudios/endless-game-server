...
public final class IceDemonRoom extends RaidArea {
    ...
    public void processBraziers() {
        for (final com.zenyte.game.content.chambersofxeric.room.IceDemonRoom.Brazier brazier : braziers) {
            brazier.process();
        }
    }
    ...
    public void loadRoom() {
        final com.zenyte.game.world.entity.Location stormTile = getNPCLocation(iceDemonLocations[index][0], 2);
        ...
        while (icefiends.size() != count) {
            ...
            final com.zenyte.game.content.chambersofxeric.npc.IcefiendNPC icefiend = new IcefiendNPC(getLocation(icefiendSpawnLocations[index][random]));
            icefiend.spawn();
