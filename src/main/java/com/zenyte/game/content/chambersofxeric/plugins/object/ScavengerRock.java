            ...
            if (option.equalsIgnoreCase("Mine")) {
                ...
                player.getActionManager().setAction(new Action() {
                    ...
                    public boolean start() {
                        final java.util.Optional<com.zenyte.game.content.skills.mining.MiningDefinitions.PickaxeDefinitions.PickaxeResult> optionalAxe = MiningDefinitions.PickaxeDefinitions.get(player, true);
                    ...
                    public int processWithDelay() {
                        ...
                        if (Utils.random(Math.max(5, Math.min(20, raid.getOriginalPlayers().size() / 3))) == 0) {
                            final com.zenyte.game.world.object.WorldObject remnants = new WorldObject(blockingObject);
