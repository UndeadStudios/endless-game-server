...
public final class RaidFarming {
    ...
    public void handle(final Player player, final WorldObject object, final String option) {
        final com.zenyte.game.content.chambersofxeric.skills.RaidFarming.HerbPatch patch = patches.get(object.getPositionHash());
        switch (option) {
        case "Inspect": 
    ...
    private enum PatchType {
        ...
        private PatchType(final int objectId, final int seedId, final int produceId, final int level, final int plantingXp, final int harvestingXp) {
    ...
    private static final class HerbHarvestAction extends Action {
        ...
        public boolean process() {
            for (final java.lang.String clearingPlayer : patch.clearingPlayers) {
                final java.util.Optional<com.zenyte.game.world.entity.player.Player> player = World.getPlayer(clearingPlayer);
                if (!player.isPresent()) {
                    continue;
                }
    ...
    private static final class HerbClearAction extends Action {
        ...
        @Override
        public boolean start() {
            final com.zenyte.game.content.chambersofxeric.skills.RaidFarming.PatchType type = patch.type;
    ...
    private static final class HerbPlantAction extends Action {
        ...
        public int processWithDelay() {
            ...
            final com.zenyte.game.content.chambersofxeric.skills.RaidFarming.HerbPatch herbPatch = new HerbPatch(object, type);
