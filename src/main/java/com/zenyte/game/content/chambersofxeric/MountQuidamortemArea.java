...
public class MountQuidamortemArea extends GreatKourend {
    ...
    static final void onLeave(@NotNull final Player player) {
        ...
        if (owner) {
            ...
            if (raid != null) {
                final it.unimi.dsi.fastutil.objects.ObjectOpenHashSet<com.zenyte.game.world.entity.player.Player> players = new ObjectOpenHashSet<>(party.getRaid().getPlayers());
                for (final com.zenyte.game.world.entity.player.Player target : channel.getMembers()) {
    ...
    public static final boolean appiontAnotherPartyLeader(@NotNull final Player player) {
        ...
        if (raid != null) {
            final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.entity.player.Player> eligibleLeaders = new ObjectArrayList<Player>();
            ...
            if (!eligibleLeaders.isEmpty()) {
                ...
                final com.zenyte.game.world.entity.player.Player bestChoice = eligibleLeaders.get(eligibleLeaders.size() - 1);
