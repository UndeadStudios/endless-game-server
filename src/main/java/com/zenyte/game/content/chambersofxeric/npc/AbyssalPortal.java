...
public class AbyssalPortal extends RaidNPC<VespulaRoom> implements CombatScript {
    ...
    public void onDeath(final Entity source) {
        ...
        if (pillarObject != null) {
            final com.zenyte.game.world.object.WorldObject depletedPillar = new WorldObject(pillarObject);
    ...
    public void processNPC() {
        ...
        if (++ticks % 8 == 0) {
            int count = 0;
            for (final com.zenyte.game.content.chambersofxeric.npc.LuxGrub grub : room.getGrubs()) {
    ...
    public List<Entity> getPossibleTargets(final EntityType type) {
        ...
        for (final com.zenyte.game.world.entity.player.Player player : raid.getPlayers()) {
            ...
            for (final com.zenyte.game.world.entity.Location tile : room.getHitTiles()) {
    ...
    public int attack(Entity target) {
        final com.zenyte.game.world.entity.Location destinationTile = new Location(target.getLocation());
    ...
    public void setPillarObject(final WorldObject pillarObject) {
