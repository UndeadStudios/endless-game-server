...
public class Bat extends RaidNPC<ResourcesRoom> {
    ...
    public enum BatType {
        GUANIC(7587, 20870, 1, 5), PRAEL(7588, 20872, 15, 9), GIRAL(7589, 20874, 30, 13), PHLUXIA(7590, 20876, 45, 17), KRYKET(7591, 20878, 60, 21), MURNG(7592, 20880, 75, 25), PSYKK(7593, 20882, 90, 29);
        ...
        private BatType(final int id, final int itemId, final int level, final int experience) {
            this.id = id;
            this.itemId = itemId;
            this.level = level;
