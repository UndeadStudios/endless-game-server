	...
	public void execute(final Tekton tekton) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				if (ticks == 0) {
					final com.zenyte.game.world.entity.Location respawnTile = tekton.getRespawnTile();
					final com.zenyte.game.world.entity.pathfinding.RouteResult steps = RouteFinder.findRoute(tekton.getX(), tekton.getY(), tekton.getPlane(), tekton.getSize(), new TileStrategy(respawnTile.getX(), respawnTile.getY()), true);
