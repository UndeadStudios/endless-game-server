...
public enum GliderLocation {
    TA_QUIR_PRIW(new Location(2465, 3501, 3)), GANDIUS(new Location(2969, 2973, 0)), KAR_HEWO(new Location(3284, 3214, 0)), LEMANTO_ANDRA(new Location(3321, 3429, 0)), SINDARPOS(new Location(2848, 3498, 0)), LEMANTOLLY_UNDRI(new Location(2543, 2970, 0)), OOKOOKOLLY_UNDRI(new Location(2711, 2801, 0));
    ...
    public static GliderLocation getGlider(final Player player) {
        for (final com.zenyte.game.content.glider.GliderLocation glider : VALUES) {
