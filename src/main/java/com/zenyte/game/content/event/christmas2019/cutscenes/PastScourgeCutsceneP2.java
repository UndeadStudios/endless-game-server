    ...
    public void build() {
        ...
        addActions(0, () -> player.setLocation(instance.getLocation(2079, 5404, 0)), () -> player.getAppearance().setInvisible(true), () -> player.getVarManager().sendBit(4606, 1), () -> {
            ...
            for (final com.zenyte.game.content.event.christmas2019.cutscenes.FrozenGuest guest : FrozenGuest.getValues()) {
                final com.zenyte.game.world.entity.npc.NPC npc = new NPC(guest.getCutsceneBaseNPC(), instance.getLocation(guest.getTile()), guest.getDirection(), 0);
                npc.spawn();
        ...
        for (int i = 0; i < length; i++) {
            ...
            addActions(16 + (i * 2), () -> {
                ...
                final com.zenyte.game.world.entity.Location tile = instance.getLocation(guest.getTile());
