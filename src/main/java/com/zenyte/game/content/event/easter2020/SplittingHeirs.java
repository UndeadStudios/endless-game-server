...
public class SplittingHeirs {
    ...
    public static boolean progressedAtLeast(final Player player, final Stage progress) {
        final com.zenyte.game.content.event.easter2020.Stage currentProgress = getProgress(player);
    ...
    public static void refreshAllVarbits(final Player player) {
        final com.zenyte.game.content.event.easter2020.Stage progress = getProgress(player);
