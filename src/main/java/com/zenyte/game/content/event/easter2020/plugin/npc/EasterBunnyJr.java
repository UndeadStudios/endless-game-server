            ...
            public void handle(Player player, NPC npc) {
                ...
                player.getDialogueManager().start(new Dialogue(player, EasterConstants.EASTER_BUNNY_JR) {
                    ...
                    public void buildDialogue() {
                        final com.zenyte.game.content.event.easter2020.Stage progress = SplittingHeirs.getProgress(player);
                        if (progress == Stage.BIRD_FED_SPEAK_TO_BUNNY_JR) {
                            ...
                            npc("Yes indeedy! I just need to...", Expression.EASTER_BUNNY_VERY_HAPPY).executeAction(() -> {
                                try {
                                    final com.zenyte.game.world.region.dynamicregion.AllocatedArea area = MapBuilder.findEmptyChunk(3, 3);
                                    final com.zenyte.game.content.event.easter2020.RedCarpetInstance instance = new RedCarpetInstance(area);
