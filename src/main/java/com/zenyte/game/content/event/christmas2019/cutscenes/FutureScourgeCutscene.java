...
public class FutureScourgeCutscene extends Cutscene {
    ...
    @Override
    public void build() {
        final java.lang.String impName = ChristmasUtils.getImpName(player);
        ...
        final com.zenyte.game.world.object.WorldObject object = new WorldObject(46226, 10, 3, instance.getLocation(2469, 5401, 1));
        addActions(303, () -> {
        ...
        final com.zenyte.game.world.entity.player.cutscene.FadeScreen fadeScreen = new FadeScreen(player);
        addActions(322, fadeScreen::fade, () -> AChristmasWarble.progress(player, AChristmasWarble.ChristmasWarbleProgress.SANTA_FREED));
        final com.zenyte.game.world.entity.Location pLoc = instance.getLocation(2464, 5401, 0);
        final com.zenyte.game.world.entity.Location iLoc = instance.getLocation(2465, 5401, 0);
        addActions(325, () -> {
        ...
        final com.zenyte.game.world.entity.player.cutscene.FadeScreen fs = new FadeScreen(player);
    ...
    private void executeOptions(final int startTime, final Emote[] options, final Emote correctOption, final int jumpStage) {
        overrideActions(startTime, new DialogueAction(new Dialogue(player) {
            @Override
            public void buildDialogue() {
                final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.entity.player.dialogue.Dialogue.DialogueOption> optionsList = new ObjectArrayList<DialogueOption>();
                for (int i = 0; i < options.length; i++) {
                    final int index = i;
                    final com.zenyte.game.world.entity.player.Emote option = options[i];
