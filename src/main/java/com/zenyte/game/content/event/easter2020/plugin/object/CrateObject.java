...
public class CrateObject implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        final com.zenyte.game.content.event.easter2020.plugin.object.CrateObject.Contents crate = Contents.byPositionHash.get(object.getPositionHash());
    ...
    public Object[] getObjects() {
        final it.unimi.dsi.fastutil.ints.IntArraySet ids = new IntArraySet();
    ...
    enum Contents {
        ...
        private Contents(final int objectId, final Location location, final int itemContents, final String message) {
