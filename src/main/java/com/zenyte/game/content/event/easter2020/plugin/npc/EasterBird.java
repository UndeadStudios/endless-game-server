...
public class EasterBird extends NPCPlugin implements ItemOnNPCAction {
    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                final com.zenyte.game.content.event.easter2020.plugin.object.SeedBowl.Contents requiredFood = SeedBowl.getRequiredBowl(player);
    ...
    public Object[] getItems() {
        final java.lang.Object[] food = SeedBowl.Contents.byFoodItemId.keySet().stream().filter(i -> i != -1).toArray();
    ...
    public enum Varbit {
        ...
        private Varbit(final int varbit, final int value) {
            this.varbit = varbit;
            this.value = value;
        }
