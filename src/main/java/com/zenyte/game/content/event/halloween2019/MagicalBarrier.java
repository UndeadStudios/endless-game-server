...
public class MagicalBarrier implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        WorldTasksManager.scheduleOrExecute(() -> {
            final com.zenyte.game.world.entity.Location destination = object.transform((object.getRotation() & 1) == 0 ? Direction.EAST : Direction.NORTH, player.matches(object) ? 1 : 0);
