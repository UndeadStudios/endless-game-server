...
public class PresentScourgeCutscene extends Cutscene {
    ...
    private final void jumpToOptions() {
        overrideActions(31, new DialogueAction(new Dialogue(player) {
            @Override
            public void buildDialogue() {
                final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.entity.player.dialogue.Dialogue.DialogueOption> optionsList = new ObjectArrayList<DialogueOption>(options.size());
                for (int i = 0; i < options.size(); i++) {
                    final java.lang.String option = options.get(i);
