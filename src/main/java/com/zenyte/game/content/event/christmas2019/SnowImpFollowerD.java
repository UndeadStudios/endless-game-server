...
public class SnowImpFollowerD extends Dialogue {
    ...
    public void buildDialogue() {
        final com.zenyte.game.content.event.christmas2019.AChristmasWarble.ChristmasWarbleProgress progress = AChristmasWarble.getProgress(player);
        final java.lang.String impName = ChristmasUtils.getImpName(player);
        if (progress == null) {
            return;
        }
        final java.util.ArrayList<com.zenyte.game.world.entity.player.dialogue.Dialogue.DialogueOption> options = new ArrayList<DialogueOption>();
        switch (progress) {
        case FROZEN_GUESTS: 
