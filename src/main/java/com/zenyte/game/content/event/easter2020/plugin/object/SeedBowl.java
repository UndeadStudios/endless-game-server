...
public class SeedBowl implements ObjectAction, ItemOnObjectAction {
    public static void foodOnBowl(final Player player, final Item item) {
        ...
        final com.zenyte.game.content.event.easter2020.plugin.object.SeedBowl.Contents bowl = Contents.byFoodItemId.get(item.getId());
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        final com.zenyte.game.content.event.easter2020.plugin.object.SeedBowl.Contents bowl = Contents.byBowlId.get(object.getId(player));
    ...
    public enum Contents {
        ...
        private Contents(final int bowlObjectId, final int foodItemId, final int foodBagObjectId, final String foodMessage, final EasterBird.Varbit varbit) {
