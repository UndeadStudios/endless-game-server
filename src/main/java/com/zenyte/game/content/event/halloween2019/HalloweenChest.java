...
public class HalloweenChest implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        if (option.equalsIgnoreCase("Open")) {
            ...
            if (bitpacked == -1) {
                final it.unimi.dsi.fastutil.ints.IntArrayList ops = new IntArrayList();
            ...
            final com.zenyte.game.world.entity.Location first = options[firstIndex >= options.length ? 0 : firstIndex];
            final com.zenyte.game.world.entity.Location second = options[secondIndex >= options.length ? 1 : secondIndex];
