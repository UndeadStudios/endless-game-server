...
public class AChristmasWarble {
    ...
    public static boolean progressedAtLeast(final Player player, final ChristmasWarbleProgress progress) {
        final com.zenyte.game.content.event.christmas2019.AChristmasWarble.ChristmasWarbleProgress currentProgress = getProgress(player);
    ...
    public static void start(final Player player) {
        ...
        final com.zenyte.game.world.entity.npc.NPC introducer = list.get(0);
    ...
    public enum ChristmasWarbleProgress {
        ...
        private ChristmasWarbleProgress(final int stage) {
            this.stage = stage;
        }
    }
}
