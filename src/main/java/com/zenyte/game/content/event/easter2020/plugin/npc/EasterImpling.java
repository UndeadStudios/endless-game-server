...
public class EasterImpling extends NPCPlugin {
    ...
    public void handle() {
        bind("Catch", ((player, npc) -> {
            ...
            player.lock(3);
            final com.zenyte.game.content.event.easter2020.plugin.npc.EasterImpling.Npc impling = Npc.forNpcId.get(npc.getId());
    ...
    public enum Npc {
        ...
        private Npc(final int npcId, final int varbitId, final Location location) {
            this.npcId = npcId;
