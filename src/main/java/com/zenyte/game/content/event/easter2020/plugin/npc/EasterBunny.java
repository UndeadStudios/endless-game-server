            ...
            public void buildDialogue() {
                ...
                if (progress == Stage.NOT_STARTED) {
                    ...
                    npc("It\'ll be good to get out of this suit.", Expression.EASTER_BUNNY_VERY_HAPPY).executeAction(() -> {
                        try {
                            final com.zenyte.game.world.region.dynamicregion.AllocatedArea area = MapBuilder.findEmptyChunk(5, 5);
                            final com.zenyte.game.content.event.easter2020.OutsideInstance instance = new OutsideInstance(area);
