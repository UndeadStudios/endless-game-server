...
public class HalloweenSurfaceArea extends Area implements FullMovementPlugin {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(HalloweenSurfaceArea.class);
    ...
    public boolean processMovement(Player player, int x, int y) {
        ...
        try {
            for (final com.zenyte.game.content.event.halloween2019.HalloweenCrow crow : HalloweenCrow.crows) {
