    ...
    public static final void slash(@NotNull final Player player, @NotNull final WorldObject web, @NotNull final Item weapon) {
        ...
        WorldTasksManager.scheduleOrExecute(() -> {
            if (player.matches(web)) {
                final com.zenyte.game.world.entity.Location dest = web.transform(web.getRotation() == 1 ? Direction.NORTH : web.getRotation() == 0 ? Direction.WEST : web.getRotation() == 2 ? Direction.EAST : Direction.SOUTH, 1);
