...
public class FrozenGuestPlugin implements ObjectAction, ItemOnObjectAction {
    ...
    private final void throwWater(@NotNull final Player player, @NotNull final WorldObject object, @NotNull final OptionalInt bucketSlot) {
        final com.zenyte.game.content.event.christmas2019.cutscenes.FrozenGuest guest = Utils.findMatching(FrozenGuest.getValues(), g -> g.getBaseObject() == object.getId());
        ...
        final com.zenyte.game.world.entity.npc.NPC npc = World.findNPC(guest.getBaseNPC(), guest.getTile(), 1).orElseThrow(RuntimeException::new);
