...
//        World.spawnNPC(EasterConstants.SAD_EASTER_BUNNY, new Location(3091, 3468), Direction.NORTH, 0);
//        World.spawnNPC(EasterConstants.HAPPY_EASTER_BUNNY, new Location(3091, 3468), Direction.NORTH, 0);
//        World.spawnNPC(EasterConstants.POST_QUEST_EASTER_BUNNY, new Location(3091, 3468), Direction.NORTH, 0);
...
//        if (!player.getPrivilege().eligibleTo(Privilege.COMMUNITY_MANAGER) ||!player.getPrivilege().eligibleTo(Privilege.OWNER)) {
//            player.lock(2);
