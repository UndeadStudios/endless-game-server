...
public class EasterConstants {
    ...
    public enum EasterItem {
        SUNFLOWER_SEEDS(30117), CRACKER_BITS(30118), WORM_BITS(30119), POPPY_SEEDS(30120), CHIMNEY(30121), COG(30122), PISTONS(30123), WET_PIPE(30124), CLEAN_PIPE(30125), SOOTY_PIPE(30126), INCUBATOR_BLUEPRINTS(30127), IMPLING_JAR(30129), IMPLING_NET(30128), EASTER_IMPLING_JAR(30130), CHOCATRICE_CAPE(30116), EASTER_CARROT(30131);
        ...
        private EasterItem(final int itemId) {
            this.itemId = itemId;
        }
    }
}
