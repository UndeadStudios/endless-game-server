...
public class ScourgeCupboard implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        final com.zenyte.game.content.event.christmas2019.ScourgeCupboard.Cupboard cupboard = Cupboard.forObjectId(object.getId());
        switch (option) {
        case "Search": 
    ...
    private enum Cupboard {
        ...
        private Cupboard(final int objectId, final int varbit) {
