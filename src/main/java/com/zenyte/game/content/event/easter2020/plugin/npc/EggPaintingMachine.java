    ...
    public void handle() {
        bind("Look-at", new OptionHandler() {
            ...
            public void handle(Player player, NPC npc) {
                ...
                final com.zenyte.game.item.Item item = new Item(EasterItem.EASTER_IMPLING_JAR.getItemId());
            ...
            public void click(final Player player, final NPC npc, final NPCOption option) {
                final com.zenyte.game.world.object.WorldObject object = World.getObjectWithType(npc.getId() == EasterConstants.EGG_PAINTING_MACHINE_BASE_WEST ? westernPaintingMachine : easternPaintingMachine, 10);
