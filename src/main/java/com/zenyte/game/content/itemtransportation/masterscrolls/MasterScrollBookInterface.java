...
public class MasterScrollBookInterface extends Interface {
    ...
    public void open(Player player) {
        final java.lang.Object scrollBook = player.getTemporaryAttributes().get("Master scroll book item attr");
        if (!(scrollBook instanceof Item)) {
            return;
        }
        final com.zenyte.game.item.Item book = (Item) scrollBook;
        player.getInterfaceHandler().sendInterface(this);
        for (final com.zenyte.game.content.itemtransportation.masterscrolls.ScrollBookTeleport teleport : ScrollBookTeleport.values) {
    ...
    private final void refresh(@NotNull final Player player, @NotNull final Item book, @NotNull final ScrollBookTeleport teleport) {
        final com.zenyte.game.world.entity.player.VarManager vm = player.getVarManager();
    ...
    private final void setFavourite(@NotNull final Player player, @NotNull final ScrollBookTeleport teleport) {
        ...
        player.getDialogueManager().start(new Dialogue(player) {
            ...
            public void buildDialogue() {
                final java.lang.String label = Utils.formatString(teleport.toString());
    ...
    private static final boolean isEmpty(@NotNull final Item scrollBook) {
        final java.util.Map<java.lang.String, java.lang.Object> attrs = scrollBook.getAttributes();
