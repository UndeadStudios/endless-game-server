...
public class Sailing {
	...
	public static void sail(final Player player, final String departure, final String destination) {
		...
		final com.zenyte.game.world.entity.Location location = LOCATIONS.get(value);
		final java.lang.Integer delay = DELAYS.get(value);
		player.lock(delay);
	...
	public static void sailZeah(final Player player, final String destination) {
		final com.zenyte.game.world.entity.Location location = destination.equals("Port Sarim") ? PORT_SARIM_LOCATION : destination.equals("Piscarilius House") ? PISCARILIUS_LOCATION : LANDS_END_LOCATION;
