...
public interface PlunderableObject {
    ...
    default void reward(final Player player) {
        ...
        final com.zenyte.game.content.pyramidplunder.PlunderRewardTier tier = getRewardTiers().get(randomIndex);
        final java.util.Collection<com.zenyte.game.content.pyramidplunder.PlunderReward> possibleRewards = PlunderReward.get(tier);
        final com.zenyte.game.content.pyramidplunder.PlunderReward reward = Utils.getRandomCollectionElement(possibleRewards);
    ...
    default void giveSceptre(final Player player) {
        final com.zenyte.game.item.Item sceptreItem = sceptre.generateResult();
        final com.zenyte.game.world.entity.player.container.ContainerResult result = player.getInventory().addItem(sceptreItem);
