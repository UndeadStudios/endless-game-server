...
public enum PlunderReward {
    IVORY_COMB(PlunderRewardTier.IVORY, ItemId.IVORY_COMB, 50), STONE_SEAL(PlunderRewardTier.STONE, ItemId.STONE_SEAL, 150), GOLD_SEAL(PlunderRewardTier.GOLD, ItemId.GOLD_SEAL, 750), POTTERY_SCARAB(PlunderRewardTier.POTTERY, ItemId.POTTERY_SCARAB, 75), STONE_SCARAB(PlunderRewardTier.STONE, ItemId.STONE_SCARAB, 175), GOLD_SCARAB(PlunderRewardTier.GOLD, ItemId.GOLDEN_SCARAB, 1000), POTTERY_STATUETTE(PlunderRewardTier.POTTERY, ItemId.POTTERY_STATUETTE, 100), STONE_STATUETTE(PlunderRewardTier.STONE, ItemId.STONE_STATUETTE, 200), GOLDEN_STATUETTE(PlunderRewardTier.GOLD, ItemId.GOLDEN_STATUETTE, 1250);
    ...
    private PlunderReward(final PlunderRewardTier tier, final int itemId, final int coins) {
        this.tier = tier;
        this.itemId = itemId;
        this.coins = coins;
    }
