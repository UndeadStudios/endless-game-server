...
public class PlunderDoor implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        final com.zenyte.game.content.pyramidplunder.PlunderRoom currentRoom = PlunderRoom.get(player.getVarManager().getBitValue(ROOM_VARBIT));
    ...
    private void handleNextRoomDoor(final Player player, final WorldObject object, final PlunderRoom currentRoom) {
        final com.zenyte.game.content.pyramidplunder.PlunderRoom nextRoom = currentRoom.next();
    ...
    private void openDoor(final Player player, final WorldObject object, final PlunderRoom currentRoom, final PlunderRoom nextRoom, final boolean usingLockpick) {
        ...
        player.getSkills().addXp(Skills.THIEVING, usingLockpick ? currentRoom.getDoorExp() / 2 : currentRoom.getDoorExp());
    }
