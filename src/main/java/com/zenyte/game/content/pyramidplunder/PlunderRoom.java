...
public enum PlunderRoom {
    ...
    private PlunderRoom(final int roomId, final int level, final double urnExp, final double chestExp, final double sarcophagusExp, final double doorExp, final double trapExp, final ImmutableLocation start, final RSPolygon polygon) {
        this.roomId = roomId;
        this.level = level;
        this.urnExp = urnExp;
    ...
    public double getChestExp() {
        return this.chestExp;
    }

    public double getSarcophagusExp() {
        return this.sarcophagusExp;
    }
