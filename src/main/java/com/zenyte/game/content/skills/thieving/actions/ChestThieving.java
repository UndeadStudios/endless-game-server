...
public class ChestThieving extends Action {
    ...
    public static boolean handleChest(final Player player, final WorldObject object, final boolean searchForTraps) {
        final com.zenyte.game.content.skills.thieving.Chest chest = Chest.getChest(object.getId());
        if (chest == null) {
            return false;
        }
    ...
    private boolean isChestLooted() {
        final java.lang.String attribute = "thieving_chest_last_looted_" + object.getPositionHash();
