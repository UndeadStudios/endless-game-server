...
public final class BasicRunecraftingAction extends Action {
	...
	public int processWithDelay() {
		...
		if (rune.getEssenceType() == 1 || rune.getEssenceType() == 2) {
			...
			final java.util.OptionalInt slot = ChipDarkEssenceBlockItemAction.findFragmentsSlot(player);
		...
		if (player.getFollower() != null) {
			final com.zenyte.game.content.follower.Pet pet = player.getFollower().getPet();
