...
public class FiremakingAction extends Action {
    ...
    public boolean start() {
        ...
        final java.lang.Object burnDelay = player.getTemporaryAttributes().remove("BurnDelay");
    ...
    public int processWithDelay() {
        final com.zenyte.game.world.entity.Location location = new Location(player.getX(), player.getY(), player.getPlane());
        final com.zenyte.game.world.flooritem.FloorItem item = World.getRegion(location.getRegionId()).getFloorItem(data.getLogs().getId(), location, player);
    ...
    private void light() {
        ...
        final com.zenyte.game.world.object.WorldObject object = new WorldObject(data.getObjectId(), 10, 1, location);
