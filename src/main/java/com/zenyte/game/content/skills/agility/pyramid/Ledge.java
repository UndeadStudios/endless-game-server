...
public class Ledge implements FailableAgilityPyramidObstacle, IrreversibleDirection {
    ...
    private void cross(final Player player, final WorldObject object, final boolean success) {
        final com.zenyte.game.util.Direction walkDirection = object.getFaceDirection().getCounterClockwiseDirection(6);
        final com.zenyte.game.world.entity.Location destination = player.getLocation().transform(walkDirection, 5);
        final com.zenyte.game.world.entity.SoundEffect sound = new SoundEffect(2451, 1, 20, success ? 5 : 2);
        ...
        WorldTasksManager.schedule(new WorldTask() {
            ...
            public void run() {
                ...
                if (!success) {
                    final com.zenyte.game.world.entity.Location fallDestination = AgilityPyramidArea.getLowerTile(player.getLocation().transform(object.getFaceDirection(), 2));
                    if (ticks == 3) {
