...
public enum Rune {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(Rune.class);
    ...
    static {
        final it.unimi.dsi.fastutil.ints.Int2IntMap runeEnum = EnumDefinitions.getIntEnum(982).getValues();
