...
public final class PlankMake implements ItemSpell {
	...
	private static enum PlankData {
		LOGS(960, 70), OAK_LOGS(8778, 175), TEAK_LOGS(8780, 350), MAHOGANY_LOGS(8782, 1050);
		private final int plank;
		private final int cost;
		public static final ImmutableMap<Integer, PlankData> DATA = ImmutableMap.of(1511, LOGS, 1521, OAK_LOGS, 6333, TEAK_LOGS, 6332, MAHOGANY_LOGS);
