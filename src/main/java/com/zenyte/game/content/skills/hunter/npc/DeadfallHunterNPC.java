...
public class DeadfallHunterNPC extends HunterNPC implements Spawnable {
    ...
    public void interact() {
        ...
        final com.zenyte.game.world.object.WorldObject originalTrap = Objects.requireNonNull(trap.getDefaultObjects().get(0));
        final int rotation = originalTrap.getRotation();
        final com.zenyte.game.world.entity.Location location = originalTrap.transform(rotation == 0 ? 1 : 0, rotation == 3 ? 1 : 0, 0);
