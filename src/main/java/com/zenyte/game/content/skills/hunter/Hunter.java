...
public class Hunter {
    ...
    public static final void onInitialization(@NotNull final InitializationEvent event) {
        ...
        final com.zenyte.game.content.skills.hunter.Hunter otherHunter = savedPlayer.getHunter();
        if (otherHunter == null) {
            return;
        }
        final java.util.List<com.zenyte.game.content.skills.hunter.object.Birdhouse> birdHouses = otherHunter.builtBirdhouses;
        if (birdHouses == null) {
            return;
        }
    ...
    public static final void onLogout(@NotNull final LogoutEvent event) {
        ...
        final java.util.List<com.zenyte.game.content.skills.hunter.object.HunterTrap> traps = hunter.traps;
        for (HunterTrap trap : traps) {
            final java.lang.Runnable removalRunnable = trap.getRemovalRunnable();
    ...
    public Optional<Birdhouse> findBirdhouse(final int objectId) {
        ...
        for (final com.zenyte.game.content.skills.hunter.object.Birdhouse birdhouse : builtBirdhouses) {
    ...
    public void removeBirdhouse(@NotNull final Birdhouse birdhouse) {
        final com.zenyte.game.content.skills.hunter.BirdHousePosition position = birdhouse.getPosition();
        builtBirdhouses.removeIf(bh -> bh.getPosition() == position);
        final com.zenyte.game.world.entity.player.Player p = player.get();
    ...
    public void process() {
        for (final com.zenyte.game.content.skills.hunter.object.HunterTrap trap : traps) {
