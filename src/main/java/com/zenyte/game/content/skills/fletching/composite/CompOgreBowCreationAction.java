...
public class CompOgreBowCreationAction extends Action {
    ...
    public int processWithDelay() {
        if (ticks == 0) {
            ...
            final it.unimi.dsi.fastutil.ints.IntList mats = isStringing ? CompOgreBowItemOnItemAction.strungMats : CompOgreBowItemOnItemAction.unstrungMats;
            final com.zenyte.game.item.Item product = isStringing ? CompOgreBowItemOnItemAction.strungBow : CompOgreBowItemOnItemAction.unstrungBow;
            player.getInventory().deleteItemsIfContains(mats, () -> {
                ...
                final java.lang.String itemString = isStringing ? "a composite ogre bow" : "an unstrung composite bow";
    ...
    public CompOgreBowCreationAction(final int amount, final boolean isStringing) {
        this.amount = amount;
