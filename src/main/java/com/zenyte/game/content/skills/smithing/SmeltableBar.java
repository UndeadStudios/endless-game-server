...
public enum SmeltableBar {
	BRONZE_BAR(1, 6.25, new Item(2349), new Item(436), new Item(438)), IRON_BAR(15, 12.5, new Item(2351), new Item(440)), BLURITE_BAR(8, 8, new Item(9467), new Item(668)), SILVER_BAR(20, 13.67, new Item(2355), new Item(442)), STEEL_BAR(30, 17.5, new Item(2353), new Item(440), new Item(453, 2)), GOLD_BAR(40, 22.5, new Item(2357), new Item(444)), MITHRIL_BAR(50, 30, new Item(2359), new Item(447), new Item(453, 4)), ADAMANTITE_BAR(70, 37.5, new Item(2361), new Item(449), new Item(453, 6)), RUNITE_BAR(85, 50, new Item(2363), new Item(451), new Item(453, 8));
