...
public class TreeGnomeStrongholdShortcut implements Shortcut {
    ...
    public void startSuccess(final Player player, final WorldObject object) {
        ...
        WorldTasksManager.schedule(() -> {
            ...
            final com.zenyte.game.world.entity.Location dest = object.getId() != 16534 ? new Location(2486, 3515, 0) : new Location(2489, 3521, 0);
            final com.zenyte.game.world.entity.masks.ForceMovement fm = new ForceMovement(dest, t * 30, ForceMovement.SOUTH);
            player.setAnimation(CLIMB);
