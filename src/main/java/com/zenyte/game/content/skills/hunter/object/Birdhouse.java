...
public class Birdhouse {
    ...
    public int getLengthInMinutes() {
        final com.zenyte.game.world.entity.player.Player player = playerWeakReference.get();
        if (player == null) {
            return 50;
        }
    ...
    public void refreshVarbits() {
        ...
        final com.zenyte.game.content.skills.hunter.node.BirdHouseState state = getState();
        final com.zenyte.game.content.skills.hunter.node.BirdHouseType type = getType();
        final com.zenyte.game.content.skills.hunter.BirdHousePosition position = getPosition();
