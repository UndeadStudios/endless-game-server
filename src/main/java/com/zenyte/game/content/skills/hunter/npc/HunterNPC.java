...
abstract class HunterNPC extends NPC {
    ...
    public void processNPC() {
        if (trap != null) {
            ...
            if (player != null && !player.isNulled()) {
                final com.zenyte.game.content.skills.hunter.TrapState state = trap.getState();
    ...
    protected void checkTraps() {
        ...
        final java.util.List<com.zenyte.game.world.entity.Entity> possibleTargets = getPossibleTargets(EntityType.NPC);
        ...
        final com.zenyte.game.content.skills.hunter.npc.HunterDummyNPC dummy = (HunterDummyNPC) target;
        final java.lang.ref.WeakReference<com.zenyte.game.content.skills.hunter.object.HunterTrap> trapReference = dummy.getTrap();
        if (trapReference == null) {
            return;
        }
        final com.zenyte.game.content.skills.hunter.object.HunterTrap randomTrap = trapReference.get();
    ...
    protected boolean isPotentialTarget(final Entity entity) {
        ...
        final com.zenyte.game.content.skills.hunter.npc.HunterDummyNPC npc = (HunterDummyNPC) entity;
        if (npc.getId() == trapType.getActiveDummyNpcId()) {
            final java.lang.ref.WeakReference<com.zenyte.game.content.skills.hunter.object.HunterTrap> trapReference = npc.getTrap();
            if (trapReference == null) {
                return false;
            }
    ...
    protected static double successProbability(final int level, @NotNull final HunterPrey prey) {
        ...
        final int neverFailLevel = prey.neverFailLevel();
