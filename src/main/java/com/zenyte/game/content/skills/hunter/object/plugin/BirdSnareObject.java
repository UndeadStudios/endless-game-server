...
public class BirdSnareObject implements HunterObjectPlugin {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        final com.zenyte.game.content.skills.hunter.object.HunterTrap trap = HunterUtils.findTrap(TrapType.BIRD_SNARE, object, null).orElseThrow(RuntimeException::new);
        switch (option) {
        case "Check": 
