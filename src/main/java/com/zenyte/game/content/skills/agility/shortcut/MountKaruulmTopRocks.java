...
public class MountKaruulmTopRocks implements Shortcut {
    ...
    public void startSuccess(final Player player, final WorldObject object) {
        if (object.getY() <= 3788) {
            final com.zenyte.game.world.entity.Location destination = new Location(1324, 3790, 0);
            ...
            WorldTasksManager.schedule(() -> {
                ...
                WorldTasksManager.schedule(() -> {
                    ...
                    WorldTasksManager.schedule(() -> {
                        final com.zenyte.game.world.entity.Location dest = new Location(1324, 3795, 0);
            ...
            final com.zenyte.game.world.entity.Location destination = new Location(1324, 3791, 0);
            ...
            WorldTasksManager.schedule(() -> {
                ...
                WorldTasksManager.schedule(() -> {
                    player.addWalkSteps(player.getX(), player.getY() - 1, 1, false);
                    WorldTasksManager.schedule(() -> {
                        final com.zenyte.game.world.entity.Location dest = new Location(1324, 3787, 0);
