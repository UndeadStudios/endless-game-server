...
public enum FarmingContract {
    ...
    public static FarmingContract generateContract(@NotNull final Player player, @NotNull final FarmingContractDifficulty difficulty) {
        final it.unimi.dsi.fastutil.objects.ObjectArrayList<java.lang.Object> possibleContracts = new ObjectArrayList<>();
    ...
    public void reward(@NotNull final Player player) {
        final com.zenyte.game.item.Item seedPack = createSeedPack(player);
    ...
    private Item createSeedPack(@NotNull final Player player) {
        final com.zenyte.game.item.Item seedPack = new Item(ItemId.SEED_PACK);
        ...
        final com.zenyte.game.content.skills.farming.contract.FarmingContractDifficulty difficulty = FarmingContractDifficulty.getByName(player.getAttributes().get(CONTRACT_DIFFICULTY_ATTR).toString());
        final com.zenyte.game.content.skills.farming.contract.FarmingContractTier tier = FarmingContractTier.get(productGrowthTime, difficulty);
        applySeedPackAttributes(player, seedPack, tier);
        return seedPack;
    }

    private void applySeedPackAttributes(@NotNull final Player player, @NotNull final Item seedPack, @NotNull final FarmingContractTier tier) {
