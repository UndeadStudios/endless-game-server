...
public class HesporiCaveEntrance implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        final com.zenyte.game.world.entity.Location destination = object.getId() == 34435 ? new Location(1230, 3729, 0) : new Location(1243, 10081, 0);
        final com.zenyte.game.world.entity.player.cutscene.FadeScreen screen = new FadeScreen(player, () -> player.setLocation(destination));
        screen.fade();
