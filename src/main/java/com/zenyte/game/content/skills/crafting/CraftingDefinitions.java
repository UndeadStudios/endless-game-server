...
public class CraftingDefinitions {
	...
	public enum GemCuttingData {
		OPAL(1, 15, new Animation(890), new Item(1625), new Item(1609)), JADE(13, 20, new Animation(891), new Item(1627), new Item(1611)), RED_TOPAZ(16, 25, new Animation(892), new Item(1629), new Item(1613)), SAPPHIRE(20, 50, new Animation(888), new Item(1623), new Item(1607)), EMERALD(27, 67.5, new Animation(889), new Item(1621), new Item(1605)), RUBY(34, 85, new Animation(887), new Item(1619), new Item(1603)), DIAMOND(43, 107.5, new Animation(886), new Item(1617), new Item(1601)), DRAGONSTONE(55, 137.5, new Animation(885), new Item(1631), new Item(1615)), ONYX(67, 167.5, new Animation(2717), new Item(6571), new Item(6573)), AMETHYST(83, 60, new Animation(6295), new Item(21347), new Item(21338, 15), new Item(21350, 15), new Item(21352, 5)), ZENYTE(89, 200, new Animation(7185), new Item(19496), new Item(19493));
	...
	public enum JewelleryData {
		OPAL_RING(1, 10, 4, 0, new Item(21081), new Item(1609), SILVER_BAR), OPAL_NECKLACE(16, 35, 4, 3, new Item(21090), new Item(1609), SILVER_BAR), OPAL_BRACELET(22, 45, 4, 9, new Item(21117), new Item(1609), SILVER_BAR), OPAL_AMULET(27, 55, 4, 6, new Item(21099), new Item(1609), SILVER_BAR), JADE_RING(13, 32, 4, 1, new Item(21084), new Item(1611), SILVER_BAR), JADE_NECKLACE(25, 54, 4, 4, new Item(21093), new Item(1611), SILVER_BAR), JADE_BRACELET(29, 60, 4, 10, new Item(21120), new Item(1611), SILVER_BAR), JADE_AMULET(34, 70, 4, 7, new Item(21102), new Item(1611), SILVER_BAR), TOPAZ_RING(16, 35, 4, 2, new Item(21087), new Item(1613), SILVER_BAR), TOPAZ_NECKLACE(32, 70, 4, 5, new Item(21096), new Item(1613), SILVER_BAR), TOPAZ_BRACELET(38, 75, 4, 11, new Item(21123), new Item(1613), SILVER_BAR), TOPAZ_AMULET(45, 80, 4, 8, new Item(21105), new Item(1613), SILVER_BAR), UNSTRUNG_SYMBOL(16, 50, 6, 0, new Item(1714), SILVER_BAR), UNSTRUNG_EMBLEM(17, 50, 6, 1, new Item(1720), SILVER_BAR), TIARA(23, 52.5, 6, 5, new Item(5525), SILVER_BAR), SILVER_BOLTS(21, 50, 6, 4, new Item(9382, 10), SILVER_BAR), GOLD_RING(5, 15, 7, new Item(1635), GOLD_BAR), GOLD_NECKLACE(6, 20, 21, new Item(1654), GOLD_BAR), GOLD_BRACELET(7, 25, 46, new Item(11069), GOLD_BAR), GOLD_AMULET(8, 30, 34, new Item(1673), GOLD_BAR), SAPPHIRE_RING(20, 40, 8, new Item(1637), new Item(1607), GOLD_BAR), SAPPHIRE_NECKLACE(22, 55, 22, new Item(1656), new Item(1607), GOLD_BAR), SAPPHIRE_BRACELET(23, 60, 48, new Item(11071), new Item(1607), GOLD_BAR), SAPPHIRE_AMULET(24, 65, 35, new Item(1675), new Item(1607), GOLD_BAR), EMERALD_RING(27, 55, 9, new Item(1639), new Item(1605), GOLD_BAR), EMERALD_NECKLACE(29, 60, 23, new Item(1658), new Item(1605), GOLD_BAR), EMERALD_BRACELET(30, 65, 49, new Item(11076), new Item(1605), GOLD_BAR), EMERALD_AMULET(31, 70, 36, new Item(1677), new Item(1605), GOLD_BAR), RUBY_RING(34, 70, 10, new Item(1641), new Item(1603), GOLD_BAR), RUBY_NECKLACE(40, 75, 24, new Item(1660), new Item(1603), GOLD_BAR), RUBY_BRACELET(42, 80, 50, new Item(11085), new Item(1603), GOLD_BAR), RUBY_AMULET(50, 85, 37, new Item(1679), new Item(1603), GOLD_BAR), DIAMOND_RING(43, 85, 11, new Item(1643), new Item(1601), GOLD_BAR), DIAMOND_NECKLACE(56, 90, 25, new Item(1662), new Item(1601), GOLD_BAR), DIAMOND_BRACELET(58, 95, 51, new Item(11092), new Item(1601), GOLD_BAR), DIAMOND_AMULET(70, 100, 38, new Item(1681), new Item(1601), GOLD_BAR), DRAGONSTONE_RING(55, 100, 12, new Item(1645), new Item(1615), GOLD_BAR), DRAGONSTONE_NECKLACE(72, 105, 26, new Item(1664), new Item(1615), GOLD_BAR), DRAGONSTONE_BRACELET(74, 110, 52, new Item(11115), new Item(1615), GOLD_BAR), DRAGONSTONE_AMULET(80, 150, 39, new Item(1683), new Item(1615), GOLD_BAR), ONYX_RING(67, 115, 13, new Item(6575), new Item(6573), GOLD_BAR), ONYX_NECKLACE(82, 120, 27, new Item(6577), new Item(6573), GOLD_BAR), ONYX_BRACELET(84, 125, 53, new Item(11130), new Item(6573), GOLD_BAR), ONYX_AMULET(90, 165, 40, new Item(6579), new Item(6573), GOLD_BAR), ZENYTE_RING(89, 150, 14, new Item(19538), new Item(19493), GOLD_BAR), ZENYTE_NECKLACE(92, 165, 28, new Item(19535), new Item(19493), GOLD_BAR), ZENYTE_BRACELET(95, 180, 54, new Item(19532), new Item(19493), GOLD_BAR), ZENYTE_AMULET(98, 200, 41, new Item(19501), new Item(19493), GOLD_BAR), SLAYER_RING(75, 15, 15, new Item(11866), new Item(4155), GOLD_BAR), ETERNAL_SLAYER_RING(75, 15, 15, new Item(21268), new Item(21270), GOLD_BAR);
		private final Item product;
		private final Item[] materials;
		private final int level;
	...
	public enum LeatherShieldData {
		HARD_LEATHER_SHIELD(41, 70, new Animation(7386), new Item(22269), new Item(22251), new Item(1743, 2), new Item(4819, 15)), SNAKESKIN_SHIELD(56, 100, new Animation(7387), new Item(22272), new Item(22254), new Item(6289, 2), new Item(4820, 15)), GREEN_DRAGONHIDE_SHIELD(62, 124, new Animation(7387), new Item(22275), new Item(22257), new Item(1745, 2), new Item(1539, 15)), BLUE_DRAGONHIDE_SHIELD(69, 140, new Animation(7387), new Item(22278), new Item(22260), new Item(2505, 2), new Item(4822, 15)), RED_DRAGONHIDE_SHIELD(76, 156, new Animation(7387), new Item(22281), new Item(22263), new Item(2507, 2), new Item(4823, 15)), BLACK_DRAGONHIDE_SHIELD(83, 172, new Animation(7387), new Item(22284), new Item(22266), new Item(2509, 2), new Item(4824, 15));
		private final int level;
		private final double xp;
		private final Item product;
		private final Item[] materials;
