 ...
 */
public class RellekkaRooftopCourse implements AgilityCourse {
    ...
    public Class<?>[] getObstacles() {
        return new Class<?>[] { RoughWall.class, Gap.class, TightRope.class, Gap2.class, Gap3.class, TightRope2.class, PileOfFish.class };
    }
