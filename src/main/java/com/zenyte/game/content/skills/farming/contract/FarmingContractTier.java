...
public enum FarmingContractTier {
    ...
    public static FarmingContractTier get(@NonNegative final int growthMinutes, @NotNull final FarmingContractDifficulty difficulty) {
        final com.zenyte.game.content.skills.farming.contract.FarmingContractTier baseTier = getTierByLength(growthMinutes);
        return baseTier.increase(difficulty.getTierBonus());
    }

    public static FarmingContractTier getById(@NonNegative final int tierId) {
        final com.zenyte.game.content.skills.farming.contract.FarmingContractTier tier = tiersById.get(tierId);
    ...
    private FarmingContractTier(final int tierId, final int maxRolls, final FarmingContractRoll lowRolls, final FarmingContractRoll mediumRolls, final FarmingContractRoll highRolls) {
        this.tierId = tierId;
