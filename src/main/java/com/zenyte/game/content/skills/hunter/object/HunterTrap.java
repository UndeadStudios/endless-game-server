...
public final class HunterTrap {
    ...
    public void setup(@NotNull final Optional<Runnable> onSetup) {
        ...
        final com.zenyte.game.content.skills.hunter.npc.HunterDummyNPC dummy = npc.get();
        if (dummy != null) {
            dummy.spawn();
        }
        final com.zenyte.game.world.entity.player.Player player = this.player.get();
        if (player != null) {
    ...
    public void process() {
        ...
        for (final com.zenyte.game.content.skills.hunter.object.HunterTrap.TickRunnable tickRunnable : tickRunnables) {
    ...
    public Optional<Runnable> findCollapseRunnable() {
        final com.zenyte.game.content.skills.hunter.object.HunterTrap.TickRunnable runnable = Utils.findMatching(tickRunnables, tickRunnable -> tickRunnable.tick == TimeUnit.MINUTES.toTicks(3));
        if (runnable == null) {
    ...
    public boolean equals(final Object obj) {
        ...
        final com.zenyte.game.content.skills.hunter.object.HunterTrap trap = (HunterTrap) obj;
    ...
    private static class TickRunnable {
        ...
        public TickRunnable(final int tick, final Runnable runnable) {
            this.tick = tick;
     ...
     * The prey which got caught in this trap.
     */
    public void setPrey(@Nullable final TrapPrey prey) {
        this.prey = prey;
    }

    @Nullable
    public Runnable getRemovalRunnable() {
        return this.removalRunnable;
    }

    public void setRemovalRunnable(@Nullable final Runnable removalRunnable) {
