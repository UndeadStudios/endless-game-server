...
public class DraynorVillageStile implements Shortcut {
    ...
    public void startSuccess(final Player player, final WorldObject object) {
        ...
        final com.zenyte.game.world.entity.Location destination = object.getX() == 3043 ? object.transform(player.getX() > object.getX() ? -1 : 2, 0, 0) : object.transform(0, player.getY() > object.getY() ? -1 : 2, 0);
        final com.zenyte.game.world.entity.masks.ForceMovement forceMovement = new ForceMovement(destination, 60, Utils.getFaceDirection(destination.getX() - player.getX(), destination.getY() - player.getY()));
