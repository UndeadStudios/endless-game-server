...
public class TuraelD extends Dialogue {
	...
	public void buildDialogue() {
		...
		if (player.getSlayer().getCompletedTasks() == 0 && player.getSlayer().getAssignment() == null) {
			...
			options(TITLE, "I need another assignment.", "Have you any rewards for me, or anything to trade?", "Let\'s talk about the difficulty of my assignments.", "Er... Nothing...").onOptionOne(() -> {
