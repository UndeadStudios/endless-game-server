...
public class Lvl7Enchant implements ItemSpell {
	...
	public boolean spellEffect(final Player player, final Item item, final int slot) {
		final com.zenyte.game.content.skills.magic.actions.JewelleryEnchantment.JewelleryEnchantmentItem data = JewelleryEnchantmentItem.getDataByMaterial(item, JewelleryEnchantmentType.LVL7_ENCHANTMENT);
		if (data != null) {
