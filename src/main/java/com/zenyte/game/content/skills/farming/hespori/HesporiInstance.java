...
public final class HesporiInstance extends DynamicArea implements FullMovementPlugin, DeathPlugin, LootBroadcastPlugin {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(HesporiInstance.class);
    /**
    ...
    void setBlooming() {
        ...
        for (int i = flowers.length - 1; i >= 0; i--) {
            final com.zenyte.game.content.skills.farming.hespori.Flower flower = flowers[i];
            flower.reset();
            flower.bloom();
        }
    }
    ...
    void finish() {
        ...
        final com.zenyte.game.content.skills.farming.FarmingSpot spot = owner.getFarming().create(patch);
    ...
    public void constructed() {
        ...
        for (int i = 0; i < 4; i++) {
            final com.zenyte.game.content.skills.farming.hespori.Flower.FlowerPosition position = Flower.FlowerPosition.values[i];
            final com.zenyte.game.content.skills.farming.hespori.Flower flower = new Flower(this, position);
            flower.spawn();
            flower.bloom();
            flowers[i] = flower;
        }
    ...
    public void enter(Player player) {
        final java.util.Map<java.lang.Object, java.lang.Object> attr = player.getTemporaryAttributes();
    ...
    public boolean processMovement(Player player, int x, int y) {
        final java.lang.Object entanglement = player.getTemporaryAttributes().remove(Hespori.entanglementAttrKey);
