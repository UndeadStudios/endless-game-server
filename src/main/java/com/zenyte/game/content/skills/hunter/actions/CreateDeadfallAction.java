...
public final class CreateDeadfallAction extends ConstructableHunterTrapAction {
    ...
    public int processWithDelay() {
        ...
        final com.zenyte.game.content.skills.hunter.npc.HunterDummyNPC dummy = new HunterDummyNPC(DEADFALL.getActiveDummyNpcId(), object);
        ...
        final com.zenyte.game.world.object.WorldObject object = new WorldObject(DEADFALL.getObjectId(), this.object.getType(), this.object.getRotation(), this.object);
        final com.zenyte.game.world.object.WorldObject collapsedObject = new WorldObject(DEADFALL.getCollapsedObjectId(), this.object.getType(), this.object.getRotation(), this.object);
        final com.zenyte.game.content.skills.hunter.object.HunterTrap trap = new HunterTrap(player, dummy, this.object, Collections.singletonList(this.object), Collections.singletonList(object), Collections.singletonList(collapsedObject), DEADFALL);
        dummy.setTrap(trap);
    ...
    public CreateDeadfallAction(final WorldObject object, final OptionalInt logsSlot) {
        this.object = object;
