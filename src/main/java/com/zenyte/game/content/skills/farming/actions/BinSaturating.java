...
public class BinSaturating extends Action {
    ...
    public boolean start() {
        final com.zenyte.game.content.skills.farming.CompostBin bin = spot.getCompostBin();
        final java.util.Optional<com.zenyte.game.content.skills.farming.CompostBinType> type = bin.getType();
    ...
    public BinSaturating(final FarmingSpot spot, final Item item) {
        this.spot = spot;
        this.item = item;
    }
}
