...
public class HerosGuildCrevice implements Shortcut {
    ...
    private static Location WEST_CREVICE = new Location(2899, 9901, 0);
    private static Location EAST_CREVICE = new Location(2914, 9895, 0);

    private static Location WEST_EXIT = new Location(2898, 9902, 0);
    private static Location EAST_EXIT = new Location(2915, 9894, 0);

    @Override
    public boolean preconditions(final Player player, final WorldObject object) {
        if (!DiaryReward.FALADOR_SHIELD3.eligibleFor(player)) {
