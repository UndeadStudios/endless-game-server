...
public enum NetTrap {
    ...
    public static NetTrap findTrap(final int objectId) throws IllegalArgumentException {
        final com.zenyte.game.content.skills.hunter.node.NetTrap value = Utils.findMatching(values, v -> v.youngTree == objectId || v.bentYoungTree == objectId || v.type.getObjectId() == objectId);
    ...
    private NetTrap(final int youngTree, final int bentYoungTree, final TrapType type) {
