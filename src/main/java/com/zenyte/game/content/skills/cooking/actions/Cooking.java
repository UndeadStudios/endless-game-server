...
public class Cooking extends Action {
    ...
    public int processWithDelay() {
        ...
        if (isBurning()) {
            ...
            final java.lang.String message = data.getMessage().equals("") ? "You successfully cook the " + ItemDefinitions.get(data.getCooked()).getName().toLowerCase() + "." : data.getMessage();
            ...
            final com.zenyte.game.item.Item item = new Item(data.getCooked(), 1);
