...
public final class Magic {
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(Magic.class);
	...
	public static final Optional<CombatSpell> getCombatSpell(@NotNull final Spellbook spellbook, @NotNull final String name) {
		final com.zenyte.game.content.skills.magic.spells.MagicSpell spell = spellbook.getSpellCollection().get(name);
	...
	public static final void add(final Class<? extends MagicSpell> c) {
		try {
			if (c.isEnum()) {
				...
				for (final com.zenyte.game.content.skills.magic.spells.MagicSpell spell : possibleValues) {
			...
			final com.zenyte.game.content.skills.magic.spells.MagicSpell spell = c.newInstance();
			final com.zenyte.game.content.skills.magic.Spellbook spellbook = spell.getSpellbook();
			spellbook.getSpellCollection().put(spell.getSpellName(), spell);
