    ...
    private static final void tease(@NotNull final Player player, @NotNull final NPC npc) {
        player.getActionManager().setAction(new Action() {
            ...
            public boolean start() {
                final java.lang.String name = npc.getName(player).toLowerCase();
            ...
            public int processWithDelay() {
                final java.util.Optional<com.zenyte.game.content.skills.hunter.npc.PitfallHunterNPC> teasedNPC = HunterUtils.getTeasedNPC(player);
                if (teasedNPC.isPresent()) {
                    final com.zenyte.game.content.skills.hunter.npc.PitfallHunterNPC creature = teasedNPC.get();
