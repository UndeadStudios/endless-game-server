...
public enum AbyssObstacle {
	...
	static {
		for (final com.zenyte.game.content.skills.runecrafting.abyss.AbyssObstacle obstacle : VALUES) {
	...
	private AbyssObstacle(final int id, final Location destination, final ObstacleType type) {
		this.id = id;
