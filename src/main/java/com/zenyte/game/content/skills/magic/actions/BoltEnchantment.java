...
public class BoltEnchantment extends Action {
	...
	public enum BoltEnchantmentData {
		...
		public static List<BoltEnchantmentData> getData(final Player player, final boolean skipRunes) {
			final java.util.ArrayList<com.zenyte.game.content.skills.magic.actions.BoltEnchantment.BoltEnchantmentData> list = new ArrayList<BoltEnchantmentData>();
			for (final com.zenyte.game.content.skills.magic.actions.BoltEnchantment.BoltEnchantmentData data : BoltEnchantmentData.VALUES) {
				final com.zenyte.game.content.skills.magic.SpellState state = new SpellState(player, data.getLevel(), data.getRunes());
	...
	public boolean check() {
		...
		if (!state.check(false) || !player.getInventory().containsItem(data.getBolt())) {
			...
			for (final com.zenyte.game.item.Item rune : data.getRunes()) {
				builder.append(rune.getAmount());
				builder.append(" ");
				builder.append(rune.getName().toLowerCase().replaceAll(" rune", ""));
				builder.append(", ");
			}
			final java.lang.String message = builder.toString().replaceAll(", $", "");
