...
public final class CraftingTable implements ObjectInteraction {
	...
	private static enum Craftable {
		CLOCKWORK(new Item(8792), 8, 15, new Item(2353)), TOY_HORSEY(new Item(2526), 10, 15, new Item(960)), TOY_SOLDIER(new Item(7759), 13, 15, new Item(8792), new Item(960)), WOODEN_CAT(new Item(10891), 16, 15, new Item(960), new Item(6814)), TOY_DOLL(new Item(7763), 18, 15, new Item(8792), new Item(960)), SEXTANT(new Item(2574), 23, 15, new Item(2353)), WATCH(new Item(2575), 28, 15, new Item(8792), new Item(2353)), CLOCKWORK_SUIT(new Item(10595), 30, 15, new Item(8792), new Item(960), new Item(950)), TOY_MOUSE(new Item(7767), 33, 15, new Item(8792), new Item(960)), TOY_CAT(new Item(7771), 85, 15, new Item(8792), new Item(860));
