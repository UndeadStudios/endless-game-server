...
public final class Portal implements ObjectInteraction {
	...
	public Object[] getObjects() {
		final java.util.ArrayList<java.lang.Object> list = new ArrayList<Object>(TeleportPortal.VALUES.length * 3);
		for (final com.zenyte.game.content.skills.construction.TeleportPortal portal : TeleportPortal.VALUES) {
	...
	public void handleObjectAction(Player player, Construction construction, RoomReference reference, WorldObject object, int optionId, String option) {
		if (option.equals("enter")) {
			final com.zenyte.game.content.skills.construction.TeleportPortal portal = TeleportPortal.MAP.get(object.getId());
			if (portal == null) {
				return;
			}
