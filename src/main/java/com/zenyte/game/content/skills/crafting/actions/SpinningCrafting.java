...
public class SpinningCrafting extends Action {
	...
	public boolean start() {
		...
		for (final com.zenyte.game.item.Item materials : data.getMaterials()) {
	...
	public SpinningCrafting(final SpinningData data, final WorldObject object, final int amount) {
		this.data = data;
		this.object = object;
		this.amount = amount;
	}
