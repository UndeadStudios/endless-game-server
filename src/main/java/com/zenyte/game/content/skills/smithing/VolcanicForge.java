...
public class VolcanicForge extends Action {
	...
	public int processWithDelay() {
		final com.zenyte.game.world.entity.Location location = new Location(player.getX(), player.getY() - 1, player.getPlane());
		switch (ticks++) {
		case 0: 
		...
		case 2: 
			...
			for (final java.lang.Integer item : WARDS.get(ward)) {
	...
	public VolcanicForge(final int ward) {
		this.ward = ward;
	}
}
