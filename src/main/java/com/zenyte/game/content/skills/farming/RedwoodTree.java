...
public final class RedwoodTree {
    ...
    long nextDelay() {
        ...
        for (final it.unimi.dsi.fastutil.objects.Object2LongMap.Entry<com.zenyte.game.content.skills.farming.RedwoodTree.RedwoodTreeBranch> entry : map.object2LongEntrySet()) {
    ...
    public enum RedwoodTreeBranch {
        ...
        private RedwoodTreeBranch(final int id) {
            this.id = id;
        }
