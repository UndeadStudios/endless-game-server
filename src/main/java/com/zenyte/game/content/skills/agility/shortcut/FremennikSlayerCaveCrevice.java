...
public class FremennikSlayerCaveCrevice implements Shortcut {
	...
	private static Location WEST_CREVICE = new Location(2731, 10008, 0);
	private static Location EAST_CREVICE = new Location(2734, 10008, 0);
	
	private static Location WEST_EXIT = new Location(2730, 10008, 0);
	private static Location EAST_EXIT = new Location(2735, 10008, 0);
