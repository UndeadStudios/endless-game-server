...
public class Curing extends Action {
    ...
    public boolean start() {
        ...
        if (spot.isTreePatch() || spot.getPatch().getType() == PatchType.BUSH_PATCH) {
            ...
            final com.zenyte.game.content.skills.magic.SpellState spell = new SpellState(player, Objects.requireNonNull(Magic.getSpell(Spellbook.LUNAR, "cure plant", ObjectSpell.class)));
            if (!containsCure) {
