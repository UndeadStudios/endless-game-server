...
public class TrollheimWildyRockyHandholds implements Shortcut {
    ...
    public void startSuccess(final Player player, final WorldObject object) {
        final com.zenyte.game.world.entity.Location destination = LV_47_BOTTOM;
        final com.zenyte.game.world.entity.masks.ForceMovement forceMovement = new ForceMovement(destination, 7 * 30, ForceMovement.WEST);
