...
public enum FavouriteSlot {
    FIRST(1, 8172), SECOND(2, 8173), THIRD(3, 8174), FOURTH(4, 8175), FIFTH(5, 8176), SIXTH(6, 8177), SEVENTH(7, 8178), EIGHT(8, 8179);
    ...
    private FavouriteSlot(final int slot, final int varbit) {
        this.slot = slot;
        this.varbit = varbit;
    }
