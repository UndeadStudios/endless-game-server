...
public final class Construction {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(Construction.class);
    @Expose
    ...
    private void addRoof(final RoomReference reference) {
        ...
        if (reference.getPlane() > 0) {
            try {
                if (decoration < 4) MapBuilder.copySquare(allocatedArea, 1, Room.ROOFS_A.getChunkX(), Room.ROOFS_A.getChunkY(), decoration, chunkX + reference.getX() - yardOffset, chunkY + reference.getY() - yardOffset, reference.getPlane() + 1, reference.getRotation());
                 else MapBuilder.copySquare(allocatedArea, 1, Room.ROOFS_B.getChunkX(), Room.ROOFS_B.getChunkY(), decoration, chunkX + reference.getX() - yardOffset, chunkY + reference.getY() - yardOffset, reference.getPlane() + 1, reference.getRotation());
            } catch (Exception e) {
                log.error(Strings.EMPTY, e);
            }
        }
