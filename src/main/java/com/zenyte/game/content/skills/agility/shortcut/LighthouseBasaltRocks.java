...
public class LighthouseBasaltRocks implements Shortcut {
    ...
    static {
        ...
        //Reverse fill.
        final it.unimi.dsi.fastutil.objects.Object2ObjectOpenHashMap<com.zenyte.game.world.entity.Location, com.zenyte.game.world.entity.Location> altMap = new Object2ObjectOpenHashMap<Location, Location>();
        for (final it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<com.zenyte.game.world.entity.Location, com.zenyte.game.world.entity.Location> entry : routeMap.object2ObjectEntrySet()) {
    ...
    public void startSuccess(final Player player, final WorldObject object) {
        final com.zenyte.game.world.entity.Location dest = routeMap.get(player.getLocation());
