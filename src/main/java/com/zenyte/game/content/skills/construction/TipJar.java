...
public final class TipJar {
	...
	public void onLogout() {
		...
		final com.zenyte.game.world.entity.player.container.ContainerResult req = player.getBank().add(new Item(995, (int) Math.min(Integer.MAX_VALUE, amount)));
	...
	public boolean isBankCoinsOnLogout() {
		return this.bankCoinsOnLogout;
	}

	public void setDisplayingNotifications(final boolean displayingNotifications) {
		this.displayingNotifications = displayingNotifications;
	}

	public void setBankCoinsOnLogout(final boolean bankCoinsOnLogout) {
