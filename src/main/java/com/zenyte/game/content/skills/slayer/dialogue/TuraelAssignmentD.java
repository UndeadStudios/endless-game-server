...
public final class TuraelAssignmentD extends Dialogue {
	...
	public void buildDialogue() {
		if (player.getSlayer().getAssignment() != null) {
			...
			final com.zenyte.game.content.skills.slayer.RegularTask data = player.getSlayer().getAssignment().getTask() instanceof BossTask ? null : ((RegularTask) player.getSlayer().getAssignment().getTask());
			if (data == null || (player.getSlayer().getMaster() == SlayerMaster.KRYSTILIA || data.getCertainTaskSet(SlayerMaster.TURAEL) == null || data.getCertainTaskSet(SlayerMaster.TURAEL).getMaximumAmount() < player.getSlayer().getAssignment().getAmount())) {
				...
				options(TITLE, "Yes please.", "No, thanks.").onOptionOne(() -> {
					final com.zenyte.game.content.skills.slayer.Assignment task = player.getSlayer().generateTask(SlayerMaster.TURAEL);
		...
		final com.zenyte.game.content.skills.slayer.Assignment task = slayer.generateTask(SlayerMaster.TURAEL);
