...
public class RellekkaBridge implements Shortcut {
    ...
    public void startSuccess(Player player, WorldObject object) {
        ...
        final com.zenyte.game.world.entity.masks.Appearance appearance = player.getAppearance();
        final com.zenyte.game.util.Direction direction = isEast ? Direction.WEST : Direction.EAST;
        ...
        WorldTasksManager.schedule(() -> {
            ...
            final com.zenyte.game.world.entity.Location destination = player.getLocation().transform(direction, 2);
        ...
        WorldTasksManager.schedule(() -> {
            final com.zenyte.game.world.entity.Location destination = player.getLocation().transform(direction, 1);
            player.addWalkSteps(destination.getX(), destination.getY(), -1, false);
        }, 5);
    }
