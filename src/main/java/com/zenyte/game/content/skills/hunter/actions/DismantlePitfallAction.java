...
public class DismantlePitfallAction extends BuiltHunterTrapAction {
    ...
    public int processWithDelay() {
        ...
        if (prey != null) {
            final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.item.ImmutableItem> items = new ObjectArrayList<>(prey.getItems());
    ...
    public DismantlePitfallAction(final WorldObject object, final HunterTrap trap) {
        this.object = object;
        this.trap = trap;
    }
}
