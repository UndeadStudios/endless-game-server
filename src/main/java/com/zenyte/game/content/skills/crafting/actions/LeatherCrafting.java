...
public class LeatherCrafting extends Action {
	...
	public int processWithDelay() {
		final com.zenyte.game.item.Item product = PRODUCTS[category][slotId];
		if (ticks == 0) {
			if (category != 10) {
	...
	public LeatherCrafting(final int category, final int slotId, final int amount) {
