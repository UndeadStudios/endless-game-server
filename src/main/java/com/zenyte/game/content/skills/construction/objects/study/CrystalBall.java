...
public final class CrystalBall implements ItemOnObjectAction {
	...
	private static enum Staff {
		...
		private Staff(final int staffId, final Animation start, final Animation end) {
			this(staffId, start, end, null);
		}
		
		private Staff(final int staffId, final Animation start, final Animation end, final Item cost) {
