...
public enum BasketData {
    APPLE(new Item(1955), new Item(5378), new Item(5386)), BANANA(new Item(1963), new Item(5408), new Item(5416)), ORANGE(new Item(2108), new Item(5388), new Item(5396)), STRAWBERRY(new Item(5504), new Item(5398), new Item(5406)), TOMATO(new Item(1982), new Item(5960), new Item(5968));
