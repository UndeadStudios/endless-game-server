...
public enum PoisonableWeapon {
    ...
    static {
        for (final com.zenyte.game.content.skills.herblore.PoisonableWeapon weapon : ALL) {
    ...
    private PoisonableWeapon(final int base, final int id, final PoisonAttachement attachement) {
        this.base = base;
        this.id = id;
