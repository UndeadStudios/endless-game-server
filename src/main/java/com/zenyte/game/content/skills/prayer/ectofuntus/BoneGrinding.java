...
public class BoneGrinding extends Action {
    ...
    enum Bonemeal {
        ...
        private Bonemeal(final Bones bones, final int bonemeal) {
            this.bones = bones;
    ...
    public int processWithDelay() {
        final com.zenyte.game.content.skills.prayer.ectofuntus.BoneGrinding action = this;
        final com.zenyte.game.content.skills.prayer.ectofuntus.BoneGrinding.Stage stage = this.stage;
        ...
        case COLLECTING: 
            final int boneId = player.getNumericAttribute("ectofuntus grinded bone").intValue();
            final com.zenyte.game.content.skills.prayer.ectofuntus.BoneGrinding.Bonemeal bonemeal = Utils.findMatching(Bonemeal.values, meal -> Utils.findMatching(meal.bones.getBones(), b -> b.getId() == boneId) != null);
            if (bonemeal == null) {
                return -1;
            }
