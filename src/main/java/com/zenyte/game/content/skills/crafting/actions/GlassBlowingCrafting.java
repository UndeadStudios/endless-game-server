...
public class GlassBlowingCrafting extends Action {
	...
	public int processWithDelay() {
		final java.lang.String product = data.getProduct().getDefinitions().getName().toLowerCase();
	...
	public GlassBlowingCrafting(final GlassBlowingData data, final int amount) {
		this.data = data;
		this.amount = amount;
	}
}
