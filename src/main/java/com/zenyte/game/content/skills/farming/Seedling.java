...
public enum Seedling {
    ...
    static {
        for (final com.zenyte.game.content.skills.farming.Seedling seed : values) {
    ...
    private Seedling(final int seed, final int seedling, final int wateredSeedling, final int sapling) {
        this.seed = seed;
