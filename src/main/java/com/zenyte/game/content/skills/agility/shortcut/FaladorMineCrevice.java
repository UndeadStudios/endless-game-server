...
public class FaladorMineCrevice implements Shortcut {
    ...
    private static Location WEST_CREVICE = new Location(3029, 9806, 0);
    private static Location EAST_CREVICE = new Location(3034, 9806, 0);

    private static Location WEST_EXIT = new Location(3028, 9806, 0);
    private static Location EAST_EXIT = new Location(3035, 9806, 0);
