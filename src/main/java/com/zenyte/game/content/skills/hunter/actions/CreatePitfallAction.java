...
public class CreatePitfallAction extends ConstructableHunterTrapAction {
    ...
    public int processWithDelay() {
        ...
        final com.zenyte.game.content.skills.hunter.npc.HunterDummyNPC dummy = new HunterDummyNPC(PITFALL.getActiveDummyNpcId(), object);
        final com.zenyte.game.content.skills.hunter.object.HunterTrap trap = new HunterTrap(player, dummy, object, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), PITFALL);
    ...
    public CreatePitfallAction(final WorldObject object, final OptionalInt logsSlot) {
        this.object = object;
