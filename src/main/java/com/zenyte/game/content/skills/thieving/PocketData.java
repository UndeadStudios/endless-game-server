...
public enum PocketData {
	MAN(1, -40, 8, CoinPouch.MAN, true, 5, 1, 1, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.MAN.getItemId())}, "Man", "Woman"), FARMER(10, -30, 14.5, CoinPouch.FARMER, true, 5, 1, 1, new String[] {"Cor blimey mate, what are ye doing in me pockets?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.FARMER.getItemId()), new ImmutableItem(5318, 1)}, "Farmer"), FEMALE_HAM_MEMBER(15, -25, 18.5, CoinPouch.HAM_MEMBER, true, 4, 1, 3, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(688), new ImmutableItem(686), new ImmutableItem(687), new ImmutableItem(314, 1, 7), new ImmutableItem(882, 1, 15), new ImmutableItem(1351), new ImmutableItem(1205), new ImmutableItem(1265), new ImmutableItem(1129), new ImmutableItem(1349), new ImmutableItem(1203), new ImmutableItem(1267), new ImmutableItem(4298), new ImmutableItem(4300), new ImmutableItem(4302), new ImmutableItem(4304), new ImmutableItem(4306), new ImmutableItem(4308), new ImmutableItem(4310), new ImmutableItem(886, 1, 15), new ImmutableItem(1353), new ImmutableItem(1207), new ImmutableItem(1269), new ImmutableItem(CoinPouch.HAM_MEMBER.getItemId()), new ImmutableItem(946), new ImmutableItem(1511), new ImmutableItem(1733), new ImmutableItem(321, 1, 3), new ImmutableItem(2138), new ImmutableItem(1734, 2, 10), new ImmutableItem(590), new ImmutableItem(1625), new ImmutableItem(453), new ImmutableItem(1739), new ImmutableItem(199), new ImmutableItem(201), new ImmutableItem(203), new ImmutableItem(440), new ImmutableItem(1627)}, 2541) {
		@Override
	...
	"Master Farmer", "Martin the Master Gardener"), GUARD(40, 40, 46.8, CoinPouch.GUARD, true, 5, 2, 2, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.GUARD.getItemId())}, "Guard"), FREMENNIK_CITIZEN(45, 40, 65, CoinPouch.FREMENNIK, true, 5, 2, 2, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.FREMENNIK.getItemId())}, 3937, 3938, 3939, 3940, 3941, 3942, 3943, 3944, 3945, 3946), BEARDED_POLLNIVNIAN_BANDIT(45, 45, 65, CoinPouch.KHARIDIAN_BANDIT, true, 5, 5, 5, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.KHARIDIAN_BANDIT.getItemId())}, 736, 737), BANDIT(53, 53, 79.5, CoinPouch.KHARIDIAN_BANDIT, true, 5, 3, 3, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.KHARIDIAN_BANDIT.getItemId()), new ImmutableItem(175, 1), new ImmutableItem(1523, 1)}, "Bandit"), KNIGHT(55, 48, 84.3, CoinPouch.KNIGHT_OF_ARDOUGNE, true, 5, 3, 3, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.KNIGHT_OF_ARDOUGNE.getItemId())}, "Knight of Ardougne"), POLLNIVNIAN_BANDIT(55, 55, 84.3, CoinPouch.KHARIDIAN_BANDIT, true, 5, 5, 5, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.KHARIDIAN_BANDIT.getItemId())}, 734, 735), YANILLE_WATCHMAN(65, 65, 137.5, CoinPouch.WATCHMAN, true, 5, 3, 3, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.WATCHMAN.getItemId()), new ImmutableItem(2309, 1)}, 3251), MENAPHITE_THUG(65, 65, 137.5, CoinPouch.KHARIDIAN_BANDIT, true, 5, 5, 5, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.KHARIDIAN_BANDIT.getItemId())}, "Menaphite thug"), PALADIN(70, 70, 151.75, CoinPouch.PALADIN, true, 5, 3, 3, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.PALADIN.getItemId()), new ImmutableItem(562, 2)}, "Paladin"), GNOME(75, 75, 198.5, CoinPouch.GNOME, true, 5, 1, 1, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.GNOME.getItemId()), new ImmutableItem(557), new ImmutableItem(444), new ImmutableItem(569), new ImmutableItem(2150), new ImmutableItem(2162)}, "Gnome", "Gnome woman"), HERO(80, 80, 275, CoinPouch.HERO, true, 6, 4, 4, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.HERO.getItemId()), new ImmutableItem(565), new ImmutableItem(1601), new ImmutableItem(1993), new ImmutableItem(560, 2), new ImmutableItem(569), new ImmutableItem(444)}, 3106), ELF(85, 85, 353, CoinPouch.ELF, true, 6, 5, 5, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(CoinPouch.ELF.getItemId()), new ImmutableItem(561, 3), new ImmutableItem(1601), new ImmutableItem(1993), new ImmutableItem(560, 2), new ImmutableItem(569), new ImmutableItem(444)}, "Elf", "Arvel", "Mawrth", "Goreu", "Kelyn", "Ysgawyn"), TZHAAR_HUR(90, 90, 103.5, true, 5, 4, 4, new String[] {"What do you think you\'re doing?"}, new ImmutableItem[] {new ImmutableItem(6529, 3, 14), new ImmutableItem(1623), new ImmutableItem(1621), new ImmutableItem(1619), new ImmutableItem(1617)}, "TzHaar-Hur");
	...
	public List<Item> generateRandomLoot(final boolean doubleLoot) {
		if (isRandomLoot()) {
			final com.zenyte.game.item.ImmutableItem random = getLoot()[Utils.random(getLoot().length - 1)];
			...
			int current = 0;
			for (final com.zenyte.game.item.ImmutableItem loot : this.loot) {
	...
	private List<Item> generateLootItems(final ImmutableItem item, final boolean doubleLoot, final int baseMultiplier) {
		final java.util.ArrayList<com.zenyte.game.item.Item> rewards = new ArrayList<Item>();
	...
	PocketData(final int level, final int successLevel, final double experience, final CoinPouch coinPouch, final boolean randomLoot, final int stunTime, final int minDamage, final int maxDamage, final String[] possibleMessages, final ImmutableItem[] loot, final Object... npcs) {
		...
		int weight = 0;
		if (!randomLoot) {
			for (final com.zenyte.game.item.ImmutableItem item : loot) {
