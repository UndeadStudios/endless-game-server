...
public class StrongholdSlayerDungeonTunnel implements Shortcut {
    ...
    public void startSuccess(final Player player, final WorldObject object) {
        ...
        final com.zenyte.game.world.entity.Location west = new Location(WEST.getX(), player.getY(), player.getPlane());
        final com.zenyte.game.world.entity.Location middle = new Location(MIDDLE.getX(), player.getY(), player.getPlane());
        final com.zenyte.game.world.entity.Location east = new Location(EAST.getX(), player.getY(), player.getPlane());
