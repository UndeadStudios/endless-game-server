...
public enum ClanRank {
	ANYONE(-1, 0, "Anyone"), FRIENDS(0, 0, "Any friends"), RECRUIT(1, 0, "Recruit+"), CORPORAL(2, 1, "Corporal+"), SERGEANT(3, 2, "Sergeant+"), LIEUTENANT(4, 3, "Lieutenant+"), CAPTAIN(5, 4, "Captain+"), GENERAL(6, 5, "General+"), OWNER(7, 6, "Only me"), ADMINISTRATOR(127, 6, "Administrator"), NO_RESTRICTION(-1, 0, "No restriction");
