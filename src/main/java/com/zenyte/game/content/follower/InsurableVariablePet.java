...
public enum InsurableVariablePet {
    NOON(49), PET_DARK_CORE(285), PET_SMOKE_DEVIL(995), KALPHITE_PRINCESS(1686), PET_SNAKELING(1687), VETION_JR(1688), BABY_CHINCHOMPA(1689), RIFT_GUARDIAN(1690), ROCK_GOLEM(1691), OLMLET(1711), IKKLE_HYDRA(2176);
    ...
    public OptionalInt getParentId() {
        final mgi.types.config.enums.IntEnum parentEnum = EnumDefinitions.getIntEnum(985);
