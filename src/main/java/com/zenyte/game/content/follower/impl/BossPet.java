...
public enum BossPet implements Pet {
    KALPHITE_PRINCESS_FIRST(12647, 6638, 3000, KalphitePrincessD.class, 963, 965), KALPHITE_PRINCESS_SECOND(12654, 6637, 3000, KalphitePrincessD.class), PET_CHAOS_ELEMENTAL(11995, 2055, 300, PetChaosElementalD.class, 2054), PET_DAGANNOTH_PRIME(12644, 6629, 5000, PetDagannothPrimeD.class, 2266), PET_DAGANNOTH_REX(12645, 6630, 5000, PetDagannothRexD.class, 2267), PET_DAGANNOTH_SUPREME(12643, 6628, 5000, PetDagannothSupremeD.class, 2265), PET_DARK_CORE(12816, 318, 5000, PetDarkCoreD.class, 319), PET_GENERAL_GRAARDOR(12650, 6632, 5000, PetGeneralGraardorD.class, 2215), PET_KRIL_TSUTSAROTH(12652, 6634, 5000, PetKrilTsutsarothD.class, 3129), PET_KREE_ARRA(12649, 6631, 5000, PetKreeArraD.class, 3162), PET_ZILYANA(12651, 6633, 5000, PetZilyanaD.class, 2205), PET_KRAKEN(12655, 6640, 3000, PetKrakenD.class, 494), PET_SMOKE_DEVIL(12648, 6639, 3000, PetSmokeDevilD.class, 499), PET_SMOKE_DEVIL_REGULAR(22663, 8483, 3000, PetSmokeDevilD.class), GREEN_PET_SNAKELING(12921, 2130, 4000, PetSnakelingD.class, 2042, 2043, 2044), RED_PET_SNAKELING(12939, 2131, 4000, PetSnakelingD.class), TURQOISE_PET_SNAKELING(12940, 2132, 4000, PetSnakelingD.class), PRINCE_BLACK_DRAGON(12653, 6636, 3000, PrinceBlackDragonD.class, 239), SCORPIAS_OFFSPRING(13181, 5561, 2000, ScorpiasOffspringD.class, 6615), VENENATIS_OFFSPRING(13177, 5557, 2000, VenenatisSpiderlingD.class, 6610), CALLISTO_CUB(13178, 5558, 2000, CallistoCubD.class, 6609), PURPLE_VETION(13179, 5559, 2000, VetionD.class, 6611, 6612), ORANGE_VETION(13180, 5560, 2000, VetionD.class), VORKI(21992, 8029, 2000, VorkiD.class, 8061), HELLPUPPY(13247, 3099, 3000, HellpuppyD.class, 5862), BABY_MOLE(12646, 6635, 3000, BabyMoleD.class, 5779, 6499), NOON(21748, 7892, 3000, NoonD.class, 7888), MIDNIGHT(21750, 7893, 3000, MidnightD.class), PET_PENANCE_QUEEN(12703, 6674, 1000, PetPenanceQueenD.class), ABYSSAL_ORPHAN(13262, 5884, 2560, AbyssalOrphanD.class), TZREK_JAD(13225, 5893, 200, TzRekJadD.class), SKOTOS(21273, 7671, 65, SkotosD.class, 7286), OLMLET(20851, 7520, 65, OlmletD.class), JAL_NIB_REK(21291, 7675, 100, JalNibRekD.class), PET_CORPOREAL_CRITTER(22318, 8010, 5000, PetDarkCoreD.class, 319), PUPPADILE(22376, 8201), TEKTINY(22378, 8202), VANGUARD(22380, 8203), VASA_MINIRIO(22382, 8204), VESPINA(22384, 8205), LIL_ZIK(22473, 8337), IKKLE_HYDRA_GREEN(22746, 8492, 3000, IkkleHydraD.class, 8621), IKKLE_HYDRA_BLUE(22748, 8493, 3000, IkkleHydraD.class), IKKLE_HYDRA_RED(22750, 8494, 3000, IkkleHydraD.class), IKKLE_HYDRA_LAST(22752, 8495, 3000, IkkleHydraD.class), TZREK_ZUK(22319, 8011), PHOENIX(20693, 7370, RewardCrate.PHOENIX_PET_CHANCE, PhoenixD.class);
    ...
    public int getRarity(final Player player, final int bossId) {
        ...
        if (Constants.BOOSTED_BOSS_PETS && !this.equals(OLMLET)) finalRarity = (int) (rarity - (rarity * Constants.BOOSTED_BOSS_PET_RATE));
    ...
    static {
        for (final com.zenyte.game.content.follower.impl.BossPet pet : VALUES) {
    ...
    public boolean roll(final Player player, final int rarity) {
        ...
        final com.zenyte.game.item.Item item = new Item(itemId);
    ...
    public static boolean isKQ(final Pet pet) {
        for (final com.zenyte.game.content.follower.impl.BossPet p : kalphiteQueens) {
            if (p.equals(pet)) {
                return true;
            }
        }
    ...
    public static boolean isSnakeling(final Pet pet) {
        for (final com.zenyte.game.content.follower.impl.BossPet p : snakelings) {
            if (p.equals(pet)) {
                return true;
            }
        }
    ...
    public static boolean isGrotesqueGuardian(final Pet pet) {
        for (final com.zenyte.game.content.follower.impl.BossPet p : grotesqueGuardians) {
            if (p.equals(pet)) {
                return true;
            }
        }
    ...
    public static boolean isVetion(final Pet pet) {
        for (final com.zenyte.game.content.follower.impl.BossPet p : vetions) {
            if (p.equals(pet)) {
                return true;
            }
        }
