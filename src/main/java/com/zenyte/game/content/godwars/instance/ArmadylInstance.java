...
public class ArmadylInstance extends GodwarsInstance {
    ...
    IntList possibleKillcountMonsters() {
        return new IntArrayList(new int[] {NpcId.AVIANSIE_3182, NpcId.AVIANSIE_3174, NpcId.SPIRITUAL_WARRIOR_3166, NpcId.WEREWOLF_3136, NpcId.WEREWOLF_3136, NpcId.BLOODVELD_3138, NpcId.AVIANSIE_3171, NpcId.AVIANSIE_3175, NpcId.AVIANSIE_3176, NpcId.GORAK_3141, NpcId.SPIRITUAL_MAGE_3168});
    }

    @Override
    List<Location> possibleSpawnTiles() {
        return Collections.unmodifiableList(Arrays.asList(new ImmutableLocation(1172, 4226, 0), new ImmutableLocation(1175, 4227, 0), new ImmutableLocation(1173, 4230, 0), new ImmutableLocation(1174, 4233, 0), new ImmutableLocation(1177, 4235, 0), new ImmutableLocation(1178, 4231, 0), new ImmutableLocation(1179, 4228, 0), new ImmutableLocation(1180, 4236, 0), new ImmutableLocation(1182, 4231, 0), new ImmutableLocation(1184, 4227, 0), new ImmutableLocation(1186, 4229, 0), new ImmutableLocation(1188, 4226, 0), new ImmutableLocation(1189, 4232, 0), new ImmutableLocation(1192, 4233, 0), new ImmutableLocation(1195, 4233, 0), new ImmutableLocation(1195, 4229, 0)));
    }
    ...
    public void constructed() {
        ...
        final com.zenyte.game.content.godwars.npcs.KreeArra kree = new KreeArra(minions, NpcId.KREEARRA, getLocation(new ImmutableLocation(1207, 4234, 0)), Direction.SOUTH, 2);
        killcountNPCS.add(kree.spawn());
        killcountNPCS.addAll(Arrays.asList(minions));
        final com.zenyte.game.world.entity.Location southWestCorner = getLocation(1199, 4229, 0);
        final com.zenyte.game.world.entity.Location northEastCorner = getLocation(1213, 4252, 0);
