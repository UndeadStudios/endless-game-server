...
public class SaradominInstance extends GodwarsInstance {
    ...
    public void constructed() {
        ...
        final com.zenyte.game.content.godwars.npcs.CommanderZilyana zilyana = new CommanderZilyana(minions, NpcId.COMMANDER_ZILYANA, getLocation(new ImmutableLocation(1172, 4437, 0)), Direction.SOUTH, 2);
