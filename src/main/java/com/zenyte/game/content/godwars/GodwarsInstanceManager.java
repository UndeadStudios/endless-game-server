...
public class GodwarsInstanceManager {
    ...
    public void addInstance(@NotNull final String clanOwner, @NotNull final GodwarsInstance area) {
        final com.zenyte.game.content.godwars.instance.GodwarsInstance existingInstance = clanInstances.get(clanOwner + "|" + area.getGod().name());
    ...
    public Optional<GodwarsInstance> findInstance(@NotNull final Player player, @NotNull final KillcountNPC.GodType god) {
        ...
        final java.lang.String owner = channel.getOwner();
    ...
    public static GodwarsInstanceManager getManager() {
        return GodwarsInstanceManager.manager;
    }
}
