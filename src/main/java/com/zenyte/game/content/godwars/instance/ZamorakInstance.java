...
public class ZamorakInstance extends GodwarsInstance {
    ...
    public void constructed() {
        ...
        final com.zenyte.game.content.godwars.npcs.KrilTsutsaroth kril = new KrilTsutsaroth(minions, NpcId.KRIL_TSUTSAROTH, getLocation(new ImmutableLocation(1195, 4363, 0)), Direction.SOUTH, 2);
