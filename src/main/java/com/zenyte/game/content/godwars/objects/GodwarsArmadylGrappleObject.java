...
public class GodwarsArmadylGrappleObject implements ObjectAction {
    ...
    public void handle(Player player, WorldObject object, String name, int optionId, String option) {
        final com.zenyte.game.world.entity.Location location = player.getY() >= 5279 ? SOUTH_TO_NORTH_LOCATION : NORTH_TO_SOUTH_LOCATION;
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        final com.zenyte.game.world.object.WorldObject pillar = World.getObjectWithType(PILLAR_LOCATION, 10);
        ...
        final com.zenyte.game.world.entity.Location location = player.getY() >= 5279 ? NORTH_TO_SOUTH_LOCATION : SOUTH_TO_NORTH_LOCATION;
        final com.zenyte.game.world.entity.masks.Animation animation = player.getY() >= 5279 ? NORTH_TO_SOUTH_ANIM : SOUTH_TO_NORTH_ANIM;
        player.lock(5);
