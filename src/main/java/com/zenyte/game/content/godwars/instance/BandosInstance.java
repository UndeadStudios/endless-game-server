...
public class BandosInstance extends GodwarsInstance {
    ...
    public void constructed() {
        ...
        final com.zenyte.game.content.godwars.npcs.GeneralGraardor graardor = new GeneralGraardor(minions, NpcId.GENERAL_GRAARDOR, getLocation(new ImmutableLocation(1205, 4308, 0)), Direction.SOUTH, 2);
    ...
    @Override
    void destroyed() {
        for (final com.zenyte.game.world.entity.npc.NPC npc : killcountNPCS) {
            npc.finish();
        }
    }
