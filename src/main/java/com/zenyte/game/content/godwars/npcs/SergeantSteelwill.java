...
public class SergeantSteelwill extends GodwarsBossMinion implements Spawnable, CombatScript {
    ...
    public int attack(final Entity target) {
        final com.zenyte.game.content.godwars.npcs.SergeantSteelwill npc = this;
        ...
        final com.zenyte.game.world.entity.masks.Hit hit = new Hit(npc, getRandomMaxHit(npc, npc.getCombatDefinitions().getMaxHit(), MAGIC, target), HitType.MAGIC);
        ...
        final com.zenyte.game.world.entity.masks.Graphics gfxType = hit.getDamage() == 0 ? splashGraphics : targetGraphics;
