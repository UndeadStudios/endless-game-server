...
public enum ZulrahPosition {
	SOUTH(new Location(2266, 3062, 0), new Location(2268, 3068, 0)), WEST(new Location(2257, 3071, 0), new Location(2268, 3073, 0)), CENTER(new Location(2266, 3073, 0), new Location(2268, 3065, 0)), EAST(new Location(2276, 3072, 0), new Location(2270, 3074, 0));
