...
public class DarkAltar implements ObjectAction, ItemOnObjectAction {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DarkAltar.class);
                        ...
                        public void run() {
                            ...
                            case 5: 
                                try {
                                    ...
                                    final com.zenyte.game.content.boss.skotizo.instance.SkotizoInstance instance = new SkotizoInstance(player, area);
