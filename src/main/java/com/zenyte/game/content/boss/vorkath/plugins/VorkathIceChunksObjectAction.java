...
public final class VorkathIceChunksObjectAction implements ObjectAction {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(VorkathIceChunksObjectAction.class);
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        WorldTasksManager.schedule(() -> {
            ...
            try {
                ...
                final com.zenyte.game.content.boss.vorkath.VorkathInstance instance = new VorkathInstance(player, area);
    ...
    private void quit(final Player player) {
        ...
        final com.zenyte.game.content.boss.vorkath.VorkathInstance instance = (VorkathInstance) area;
        player.lock();
