...
public final class ZulrahInstance extends DynamicArea implements DeathPlugin, PartialMovementPlugin, CannonRestrictionPlugin, LootBroadcastPlugin {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ZulrahInstance.class);
    ...
    public static final void launch(final Player player) {
        try {
            ...
            final com.zenyte.game.content.boss.zulrah.ZulrahInstance instance = new ZulrahInstance(player, fadeScreen, area);
    ...
    public void constructed() {
        final com.zenyte.game.world.entity.Location position = getLocation(2268, 3068, 0);
        final com.zenyte.game.world.entity.Location camPos = getLocation(2256, 3064, 0);
        final com.zenyte.game.world.entity.Location camLook = getLocation(2275, 3080, 0);
        WorldTasksManager.schedule(new TickTask() {
            ...
            public void run() {
                ...
                case 0: 
                    ...
                    return;
                case 1: 
                    final com.zenyte.game.world.entity.Location tile = player.getLastLoadedMapRegionTile();
