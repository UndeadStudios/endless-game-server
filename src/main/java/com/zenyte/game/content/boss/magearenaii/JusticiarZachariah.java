...
public class JusticiarZachariah extends MageArenaBossBase {
    ...
    int special(final Entity target) {
        ...
        WorldTasksManager.schedule(() -> {
            ...
            final com.zenyte.game.world.entity.player.action.combat.magic.CombatSpell spell = CombatSpell.WATER_BLAST;
            final com.zenyte.game.world.entity.masks.Graphics graphics = spell.getHitGfx();
            ...
            final com.zenyte.game.world.entity.Location teleTile = getFaceLocation(target, getSize() + 2);
            ...
            target.lock(1);
            target.setForceMovement(new ForceMovement(teleTile, 30, Utils.getFaceDirection(getX() - (target.getX() + (target.getSize() / 2.0F)), getY() - (target.getY() + (target.getSize() / 2.0F)))));
