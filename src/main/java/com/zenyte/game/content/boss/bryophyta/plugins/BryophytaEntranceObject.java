...
public class BryophytaEntranceObject implements ObjectAction {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BryophytaEntranceObject.class);
                ...
                options("Are you sure you wish to open it?", "Yes, let\'s go!", "I don\'t think I\'m quite ready yet.").onOptionOne(() -> {
                    ...
                    new FadeScreenAction(player, 2, () -> {
                        try {
                            ...
                            final com.zenyte.game.content.boss.bryophyta.BryophytaInstance instance = new BryophytaInstance(player, area);
