...
public class CerberusLair extends Area implements EntityAttackPlugin, CannonRestrictionPlugin, LootBroadcastPlugin {
    ...
    public void enter(Player player) {
        ...
        final com.zenyte.game.world.object.WorldObject existingFire = World.getObjectWithType(player.getLocation(), 10);
    ...
    public boolean attack(Player player, Entity entity) {
        if (entity instanceof NPC) {
            final java.lang.String name = ((NPC) entity).getDefinitions().getName();
