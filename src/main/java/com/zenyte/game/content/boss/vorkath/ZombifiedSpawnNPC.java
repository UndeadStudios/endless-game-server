...
public final class ZombifiedSpawnNPC extends NPC {
	...
	public void processNPC() {
		...
		if (!isFrozen() && !hasWalkSteps()) {
			...
			final com.zenyte.game.world.entity.pathfinding.RouteResult steps = RouteFinder.findRoute(getX(), getY(), getPlane(), getSize(), new TileStrategy(target.getX(), target.getY()), true);
