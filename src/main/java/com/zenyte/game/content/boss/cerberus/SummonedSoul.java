...
public class SummonedSoul extends NPC {
     ...
     */
    private void attack() {
        final com.zenyte.game.content.boss.cerberus.SummonedSoul.SpiritShieldType spiritShieldType = hasElysianShield() ? SpiritShieldType.ELYSIAN : hasSpectralShield() ? SpiritShieldType.SPECTRAL : SpiritShieldType.NONE;
        final com.zenyte.game.world.entity.Entity targetPlayer = target.get();
        final com.zenyte.game.content.boss.cerberus.Cerberus cerberus = this.cerberus.get();
        ...
        final com.zenyte.game.world.entity.player.Player player = ((Player) targetPlayer);
        faceEntity(player);
        if (isMelee()) {
    ...
    private boolean hasElysianShield() {
        final com.zenyte.game.world.entity.Entity player = target.get();
