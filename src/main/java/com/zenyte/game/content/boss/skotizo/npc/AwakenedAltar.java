...
public class AwakenedAltar extends NPC {
    ...
    public void awaken() {
        final com.zenyte.game.content.boss.skotizo.npc.Skotizo skotizo = instance.getSkotizo();
        setAwakened(true);
    ...
    protected void onDeath(Entity source) {
        ...
        final com.zenyte.game.content.boss.skotizo.npc.AwakenedAltar lastSlainAltar = instance.getLastSlainAltar();
