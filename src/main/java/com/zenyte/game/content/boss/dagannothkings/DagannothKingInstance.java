...
public class DagannothKingInstance extends DynamicArea implements CannonRestrictionPlugin, DeathPlugin, LogoutPlugin, DropPlugin, LootBroadcastPlugin {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DagannothKingInstance.class);
    ...
    public void constructed() {
        ...
        final com.zenyte.game.world.region.RSPolygon polygon = new RSPolygon(array);
