...
public class Dusk extends NPC implements CombatScript {
            ...
            WorldTasksManager.schedule(new WorldTask() {
                ...
                public void run() {
                    ...
                    case 1: 
                        ...
                        final java.util.List<com.zenyte.game.world.entity.Location> tiles = Utils.calculateLine(player.getX(), player.getY(), px, py, player.getPlane());
                        if (!tiles.isEmpty()) {
                            tiles.remove(0);
                        }
                        destination = new Location(player.getLocation());
                        for (final com.zenyte.game.world.entity.Location tile : tiles) {
    ...
    public void prisonAttack(final boolean first) {
        ...
        final com.zenyte.game.world.entity.Location randomPoint = instance.getRandomPoint();
        final com.zenyte.game.world.region.RSPolygon boundary = instance.getPrisonBoundary();
        while (true) {
        ...
        final com.zenyte.game.world.entity.Location center = optionalCenter.get().transform(2, 2, 0);
        final com.zenyte.game.world.entity.player.Player player = instance.getPlayer();
    ...
    private void createPrison(final Location center) {
        final com.zenyte.game.world.entity.Location[] edge = new Location[16];
        final com.zenyte.game.world.entity.Location[] corners = new Location[4];
        final com.zenyte.game.world.entity.Location[] middle = new Location[9];
        Location exit;
        int index = 0;
        for (int i = -2; i < 2; i++) {
            //north
        ...
        for (final com.zenyte.game.world.entity.Location location : edge) {
        ...
        WorldTasksManager.schedule(new WorldTask() {
            ...
            public void run() {
                switch (ticks++) {
                case 3: 
                    for (final com.zenyte.game.world.entity.Location location : middle) {
                        World.sendGraphics(PRISON_ATTACK_GFX, location);
                    }
                    break;
                case 6: 
    ...
    protected void drop(final Location tile) {
        final com.zenyte.game.world.entity.player.Player killer = instance.getPlayer();
        if (killer == null) {
            return;
        }
        ...
        final com.zenyte.game.world.entity.npc.drop.matrix.NPCDrops.DropTable drops = NPCDrops.getTable(id);
        if (drops == null) {
            return;
        }
