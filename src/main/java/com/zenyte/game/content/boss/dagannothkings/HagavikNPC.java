    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                options(new DialogueOption("Who are you?", key(100)),
                        new DialogueOption("What are you doing here?", key(200)),
                        new DialogueOption("What is this crack in the floor?", key(300)),
                        new DialogueOption("Nothing.", key(400)));
                ...
                npc("People can make an instance of the lair using the crack, if they so prefer. It'll cost them " + Utils.format(DagannothKingsInstanceConstants.COST) + " coins to do so.");
