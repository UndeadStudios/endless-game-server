...
public final class VorkathNPC extends NPC implements CombatScript {
    ...
    private int sendHighDamageDragonfireAttack(final Player player) {
        ...
        final com.zenyte.game.world.entity.Location startPosition = getFaceLocation(player, 5);
    ...
    private int sendIceDragonfireAttack(final Entity target) {
        ...
        final com.zenyte.game.world.entity.Location startTile = getFaceLocation(target, 6);
    ...
    private int sendMagicAttack(final Player player) {
        setAnimation(basicAttackAnimation);
        final com.zenyte.game.world.entity.Location startTile = getFaceLocation(player, 6);
    ...
    private int sendPrayerDragonfireAttack(final Player player) {
        ...
        final com.zenyte.game.world.entity.npc.impl.slayer.dragons.Dragonfire.DragonfireBuilder dragonfire = getBuilder(player);
    ...
    private int sendRegularDragonfireAttack(final Player player) {
        setAnimation(basicAttackAnimation);
        final com.zenyte.game.world.entity.Location startTile = getFaceLocation(player, 6);
        final com.zenyte.game.world.entity.npc.impl.slayer.dragons.Dragonfire.DragonfireBuilder dragonfire = new Dragonfire.DragonfireBuilder(DragonfireType.STRONG_DRAGONFIRE, 70, DragonfireProtection.getProtection(player), builder) {
            @Override
