	...
	public void attack(final ZulrahNPC zulrah, final ZulrahInstance instance, final Player target) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				final com.zenyte.game.world.entity.masks.Hit hit = new Hit(zulrah, CombatUtilities.getRandomMaxHit(zulrah, 41, mage ? CombatScript.MAGIC : CombatScript.RANGED, target), mage ? HitType.MAGIC : HitType.RANGED);
				if (mage) {
