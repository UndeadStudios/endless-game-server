...
public class CreatedCreatureNpc extends NPC {
    ...
    public void dropItem(final Player killer, Item item, final Location tile, boolean guaranteedDrop) {
        final com.zenyte.game.content.creaturecreation.SymbolOfLife symbol = SymbolOfLife.of(getId());
        final java.util.Optional<com.zenyte.game.content.achievementdiary.DiaryReward> diary = symbol.getDiaryForNoted();
