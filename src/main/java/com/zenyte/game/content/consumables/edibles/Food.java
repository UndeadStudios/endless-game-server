...
public enum Food implements Edible {
	...
	SHRIMP(315, 3), ANCHOVIES(319, 1), SARDINE(325, 4), SALMON(329, 9), TROUT(333, 7), GIANT_CARP(337, 6), COD(339, 7), HERRING(347, 5), PIKE(351, 8), MACKEREL(355, 6), TUNA(361, 10), BASS(365, 13), SWORDFISH(373, 14), LOBSTER(379, 12), SHARK(385, 20), MANTA_RAY(391, 22), SEA_TURTLE(397, 21), EDIBLE_SEAWEED(403, 4), STRANGE_FRUIT(464, 0) {
	...
	UGTHANKI_MEAT(1861, 3), CHOPPED_TOMATO(1869, 2, new Item(1923)), CHOPPED_ONION(1871, 1, new Item(1923)) {
		@Override
	...
	PUMPKIN(1959, 14), EASTER_EGG(1961, 14), BANANA(1963, 2), CABBAGE(1965, 1) {
		@Override
		public String startMessage() {
	...
	SPINACH_ROLL(1969, 2), KEBAB(1971, 0) {
		@Override
		public void onConsumption(final Player player) {
	...
	CHOCOLATE_BAR(1973, 3), TOMATO(1982, 2), ROTTEN_APPLE(1984, 0) {
		@Override
		public void onConsumption(final Player player) {
	...
	CHEESE(1985, 2), STEW(2003, 11, new Item(1923)), CURRY(2011, 19, new Item(1923)), LEMON(2102, 2), LEMON_CHUNKS(2104, 2), LEMON_SLICES(2106, 2), ORANGE(2108, 2), ORANGE_CHUNKS(2110, 2), ORANGE_SLICES(2112, 2), TURKEY_DRUMSTICK(ChristmasConstants.TURKEY_DRUMSTICK, 1), ROAST_POTATOES(ChristmasConstants.ROAST_POTATOES, 1), YULE_LOG(ChristmasConstants.YULE_LOG, 1), PINEAPPLE(2114, 0) {
		@Override
		public boolean canConsume(final Player player) {
			player.sendMessage("You can\'t consume the pineapple whole!");
			return false;
	...
	PINEAPPLE_CHUNKS(2116, 2), PINEAPPLE_RING(2118, 2), LIME(2120, 2), LIME_CHUNKS(2122, 2), LIME_SLICES(2124, 2), DWELLBERRIES(2126, 2), EQUA_LEAVES(2128, 1) {
		@Override
		public String startMessage() {
	...
	CHICKEN(2140, 3), MEAT(2142, 3), LAVA_EEL(2149, 11), TOADS_LEGS(2152, 3) {
		@Override
		public String startMessage() {
	...
	KING_WORM(2162, 2), ODD_GNOMEBOWL(2173, 0) {
		@Override
		public boolean canConsume(final Player player) {
	...
	WORM_HOLE(2191, 12), UNFINISHED_VEG_BOWL(2193, 0) {
		@Override
		public boolean canConsume(final Player player) {
			player.sendMessage("I should finish the bowl first.");
			return false;
	...
	VEG_BALL(2195, 12), ODD_CRUNCHIES(2197, 0) {
		@Override
		public boolean canConsume(final Player player) {
	...
	//TODO: Find info
	WORM_CRUNCHIES(2205, 8), UNFINISHED_CHOCO_CRUNCHY(2207, 0) {
		@Override
		public boolean canConsume(final Player player) {
	...
	//TODO: Find info
	CHOCCHIP_CRUNCHIES(2209, 7), UNFINISHED_SPICY_CRUNCHIES(2211, 0) {
		@Override
		public boolean canConsume(final Player player) {
			player.sendMessage("I should finish these crunchies first.");
			return false;
	...
	//TODO: Find info
	SPICY_CRUNCHIES(2213, 7), UNFINISHED_TOAD_CRUNCHIES(2215, 0) {
		@Override
		public boolean canConsume(final Player player) {
			player.sendMessage("I should finish these crunchies first.");
			return false;
	...
	//TODO: Find info
	TOAD_CRUNCHIES(2217, 8), PREMADE_WM_BATTA(2219, 11), PREMADE_TD_BATTA(2221, 11), PREMADE_CT_BATTA(2223, 11), PREMADE_FRT_BATTA(2225, 11), PREMADE_VEG_BATTA(2227, 11), PREMADE_CHOC_BOMB(2229, 15), PREMADE_TTL(2231, 15), PREMADE_WORM_HOLE(2233, 12), PREMADE_VEG_BALL(2235, 12), PREMADE_WM_CRUN(2237, 8), PREMADE_CH_CRUNCH(2239, 7), PREMADE_SY_CRUNCH(2241, 7), PREMADE_TD_CRUNCH(2243, 7), ODD_BATTA(2245, 0) {
		@Override
		public boolean canConsume(final Player player) {
	...
	//TODO: Find info
	WORM_BATTA(2253, 11), TOAD_BATTA(2255, 11), UNFINISHED_CHEESE_TOM_BATTA(2257, 0) {
		@Override
		public boolean canConsume(final Player player) {
			player.sendMessage("I should finish this batta first.");
			return false;
	...
	//TODO: Find info
	CHEESE_TOM_BATTA(2259, 11), UNFINISHED_FRUIT_BATTA1(2261, 0) {
		@Override
		public boolean canConsume(final Player player) {
			player.sendMessage("I should finish this batta first.");
			return false;
	...
	//TODO: Find info
	FRUIT_BATTA(2277, 11), UNFINISHED_VEGETABLE_BATTA(2279, 0) {
		@Override
		public boolean canConsume(final Player player) {
			player.sendMessage("I should finish this batta first.");
			return false;
	...
	//TODO: Find info
	VEGETABLE_BATTA(2281, 11), PLAIN_PIZZA(2289, 7, new Item(2291)) {
		@Override
		public int delay() {
			return 1;
		}
	...
	BREAD(2309, 5), APPLE_PIE(2323, 7, new Item(2335)), REDBERRY_PIE(2325, 5, new Item(2333)), MEAT_PIE(2327, 6, new Item(2331)), HALF_OF_A_MEAT_PIE(2331, 6), HALF_A_REDBERRY_PIE(2333, 5, new Item(2313)), HALF_AN_APPLE_PIE(2335, 7, new Item(2313)), OOMLIE_WRAP(2343, 0) {
		@Override
		public String startMessage() {
	...
	ROCK_CAKE(2379, 0) {
		...
		public void onConsumption(final Player player) {
			...
			if (player.getHitpoints() > 1) player.applyHit(new Hit((int) Math.ceil(player.getHitpoints() * 0.1F), HitType.REGULAR));
		}
	...
	CAVE_NIGHTSHADE(2398, 0) {
		...
		public void onConsumption(final Player player) {
			...
			if (player.getHitpoints() > 1) player.applyHit(new Hit(Math.min(player.getHitpoints() - 1, 15), HitType.REGULAR));
		}
	...
	COOKED_CHOMPY(2878, 10), COOKED_KARAMBWAN(3144, 18) {
		@Override
		public boolean canConsume(final Player player) {
	...
	POISON_KARAMBWAN(3146, 0) {
		@Override
		public void onConsumption(final Player player) {
			if (player.getHitpoints() > 1) player.applyHit(new Hit(Math.min(player.getHitpoints() - 1, 5), HitType.POISON));
		}
	...
	SLICED_BANANA(3162, 2), SEAWEED_SANDWICH(3168, 0) {
		@Override
		public boolean canConsume(final Player player) {
	...
	COOKED_RABBIT(3228, 5), THIN_SNAIL_MEAT(3369, 0) {
		@Override
		public int healedAmount(Player player) {
			return Utils.random(5, 7);
		}
	},
	LEAN_SNAIL_MEAT(3371, 8), FAT_SNAIL_MEAT(3373, 0) {
		@Override
		public int healedAmount(Player player) {
	...
	MONKEY_NUTS(4012, 4), MONKEY_BAR(4014, 4), BANANA_STEW(4016, 11, new Item(1923)), UNDEAD_COOKED_CHICKEN(4291, 1), UNDEAD_COOKED_MEAT(4293, 1), WHITE_PEARL(4485, 2, new Item(4486)) {
		@Override
		public String startMessage() {
	...
	BAKED_POTATO(6701, 4), POTATO_WITH_BUTTER(6703, 14), POTATO_WITH_CHEESE(6705, 16), POISONED_CHEESE(6768, 0) {
		@Override
		public boolean canConsume(final Player player) {
	...
	CHOC_ICE(6794, 6), PEACH(6883, 8), BAGUETTE(6961, 6), TRIANGLE_SANDWICH(6962, 6), ROLL(6963, 6), SQUARE_SANDWICH(6965, 6), ALT_SHARK(6969, 20), CHILLI_POTATO(7054, 14), EGG_POTATO(7056, 16), MUSHROOM_POTATO(7058, 20), TUNA_POTATO(7060, 22), CHILLI_CON_CARNE(7062, 0, new Item(1923)), //TODO: Find out amount
	EGG_AND_TOMATO(7064, 8, new Item(1923)), MUSHROOM_AND_ONION(7066, 0, new Item(1923)), //TODO: Find out amount
	TUNA_AND_CORN(7068, 13, new Item(1923)), MINCED_MEAT(7070, 0, new Item(1923)), //TODO: Find out amount
	SPICY_SAUCE(7072, 0, new Item(1923)), //TODO: Find out amount
	SCRAMBLED_EGG(7078, 5, new Item(1923)), FRIED_MUSHROOMS(7082, 5, new Item(1923)), FRIED_ONIONS(7084, 0, new Item(1923)), //TODO: Find out amount
	CHOPPED_TUNA(7086, 10, new Item(1923)), SWEETCORN(7088, 0), //TODO: Find out amount or circumstances cuz raw
	DRAGONFRUIT(ItemId.DRAGONFRUIT, 10), GARDEN_PIE(7178, 6, new Item(7180)) {
		@Override
		public Boost[] boosts() {
	...
	ROAST_RABBIT(7223, 7), ROASTED_CHOMPY(7228, 10), SPICY_STEW(7479, 0, new Item(1923)),  //TODO: Affects a lot! http://oldschoolrunescape.wikia.com/wiki/Spicy_stew
	COOKED_CRAB_MEAT1(7521, 2, new Item(7523)), COOKED_CRAB_MEAT2(7523, 2, new Item(7524)), COOKED_CRAB_MEAT3(7524, 2, new Item(7525)), COOKED_CRAB_MEAT4(7525, 2, new Item(7526)), COOKED_CRAB_MEAT5(7526, 2), COOKED_FISHCAKE(7530, 11), COOKED_JUBBLY(7568, 15), RED_BANANA(7572, 5), TCHIKI_MONKEY_NUTS(7573, 5), //TODO: Does NOT add a delay in combat.
	...
	STUFFED_SNAKE(7579, 20), FIELD_RATION(7934, 10), FRESH_MONKFISH(7943, 1), MONKFISH(7946, 16), LOCUST_MEAT(9052, 3) {
		@Override
		public String startMessage() {
	...
	ALT_FRUIT_BATTA(9527, 11), ALT_TOAD_BATTA(9529, 11), ALT_WORM_BATTA(9531, 11), ALT_VEGETABLE_BATTA(9533, 11), ALT_CHEESE_TOM_BATTA(9535, 11), ALT_TOAD_CRUNCHIES(9538, 8), ALT_SPICY_CRUNCHIES(9540, 7), ALT_WORM_CRUNCHIES(9542, 8), ALT_CHOCCHIP_CRUNCHIES(9544, 7), ALT_WORM_HOLE(9547, 12), ALT_VEG_BALL(9549, 12), ALT_TANGLED_TOADS_LEGS(9551, 15) {
		//TODO: Healing is delayed by one tick.
	},
	ALT_CHOCOLATE_BOMB(9553, 15) {
		//TODO: Can be eaten at the same tick as another food!
	},
	ROAST_BIRD_MEAT(9980, 6), ROAST_BEAST_MEAT(9988, 8), SPICY_TOMATO(9994, 0, new Item(1923)), //TODO: Find out amount
	SPICY_MINCED_MEAT(9996, 0, new Item(1923)), //TODO: Find out amount
	RAINBOW_FISH(10136, 11), STACKABLE_PURPLE_SWEETS(10476, 0) {
		@Override
	...
	GREEN_GLOOP_SOUP(10960, 2), FROGBURGER(10962, 2), COATED_FROGS_LEGS(10963, 2), BAT_SHISH(10964, 2), FINGERS(10965, 2), GRUBS_A_LA_MODE(10966, 2), ROAST_FROG(10967, 2), MUSHROOMS(10968, 2), FILLETS(10969, 2), LOACH(10970, 3) {
		@Override
		public Boost[] boosts() {
			return new Boost[] {new Boost(Skills.COOKING, 0, 1)};
		}
	},
	EEL_SUSHI(10971, 10), SHRUNK_OGLEROOT(11205, 0), //TODO: Find out amount
	ROE(11324, 3), CAVIAR(11326, 3), CHOCOLATE_STRAWBERRY(11910, 2), DARK_CRAB(11936, 22), SACRED_EEL(13339, 0), //TODO: Find out amount
	...
	ALT_2_SHARK(20390, 20), ALT_MONKFISH(20547, 16), PYSK_FISH(20856, 5), SUPHI_FISH(20858, 8), LECKISH_FISH(20860, 11), BRAWK_FISH(20862, 14), MYCIL_FISH(20864, 17), ROQED_FISH(20866, 20), KYREN_FISH(20868, 23), PRAEL_BAT(20873, 8), GIRAL_BAT(20875, 11), PHLUXIA_BAT(20877, 14), KRYKET_BAT(20879, 17), MURNG_BAT(20881, 20), PSYKK_BAT(20883, 23) {
		@Override
