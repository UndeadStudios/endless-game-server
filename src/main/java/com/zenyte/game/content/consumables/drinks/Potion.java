...
public enum Potion implements Drinkable {
    STRENGTH_POTION(new int[] {119, 117, 115, 113}, new Boost(Skills.STRENGTH, 0.1F, 3)), ATTACK_POTION(new int[] {125, 123, 121, 2428}, new Boost(Skills.ATTACK, 0.1F, 3)), DEFENCE_POTION(new int[] {137, 135, 133, 2432}, new Boost(Skills.DEFENCE, 0.1F, 3)), SUPER_ATTACK_POTION(new int[] {149, 147, 145, 2436}, new Boost(Skills.ATTACK, 0.15F, 5)), FISHING_POTION(new int[] {155, 153, 151, 2438}, new Boost(Skills.FISHING, 0, 3)), SUPER_STRENGTH_POTION(new int[] {161, 159, 157, 2440}, new Boost(Skills.STRENGTH, 0.15F, 5)), SUPER_DEFENCE_POTION(new int[] {167, 165, 163, 2442}, new Boost(Skills.DEFENCE, 0.15F, 5)), RANGING_POTION(new int[] {173, 171, 169, 2444}, new Boost(Skills.RANGED, 0.1F, 4)), ZAMORAK_BREW(new int[] {193, 191, 189, 2450}, new Boost(Skills.ATTACK, 0.2F, 2), new Boost(Skills.STRENGTH, 0.12F, 2), new Debuff(Skills.DEFENCE, 0.1F, 2), new Restoration(Skills.PRAYER, 0.1F, 0)) {
        @Override
    ...
    AGILITY_POTION(new int[] {3038, 3036, 3034, 3032}, new Boost(Skills.AGILITY, 0, 3)), MAGIC_POTION(new int[] {3046, 3044, 3042, 3040}, new Boost(Skills.MAGIC, 0, 4)), SARADOMIN_BREW(new int[] {6691, 6689, 6687, 6685}, new Boost(Skills.HITPOINTS, 0.15F, 2), new Boost(Skills.DEFENCE, 0.2F, 2), new Debuff(Skills.STRENGTH, 0.1F, 2), new Debuff(Skills.ATTACK, 0.1F, 2), new Debuff(Skills.MAGIC, 0.1F, 2), new Debuff(Skills.RANGED, 0.1F, 2)) {
        @Override
        public String startMessage() {
            return "You drink some of the foul liquid.";
        }
    },
    MAGIC_ESSENCE(new int[] {9024, 9023, 9022, 9021}, new Boost(Skills.MAGIC, 0, 3)), COMBAT_POTION(new int[] {9745, 9743, 9741, 9739}, new Boost(Skills.ATTACK, 0.1F, 3), new Boost(Skills.STRENGTH, 0.1F, 3)), HUNTER_POTION(new int[] {10004, 10002, 10000, 9998}, new Boost(Skills.HUNTER, 0, 3)), SUPER_RANGING(new int[] {11725, 11724, 11723, 11722}, new Boost(Skills.RANGED, 0.15F, 5)) {
        @Override
    ...
    SUPER_COMBAT_POTION(new int[] {12701, 12699, 12697, 12695}, new Boost(Skills.ATTACK, 0.15F, 5), new Boost(Skills.STRENGTH, 0.15F, 5), new Boost(Skills.DEFENCE, 0.15F, 5)), ALT_PRAYER_POTION(new int[] {20396, 20395, 20394, 20393}, new Restoration(Skills.PRAYER, 0.25F, 7)), BATTLEMAGE_POTION(new int[] {22458, 22455, 22452, 22449}, new Boost(Skills.MAGIC, 0, 4), new Boost(Skills.DEFENCE, 0.15F, 5)) {
        @Override
        public String startMessage() {
    ...
    PRAYER_POTION(new int[] {143, 141, 139, 2434}, new Restoration(Skills.PRAYER, 0.25F, 7)), ANTIPOISON(new int[] {179, 177, 175, 2446}) {
        @Override
        public void onConsumption(final Player player) {
    ...
    RESTORE_POTION(new int[] {131, 129, 127, 2430}, Drinkable.getRestorations(0.3F, 10, Skills.DEFENCE, Skills.ATTACK, Skills.STRENGTH, Skills.MAGIC, Skills.RANGED)), SUPER_RESTORE_POTION(new int[] {3030, 3028, 3026, 3024}, Drinkable.getRestorations(0.25F, 8, Drinkable.getAllSkillsExcluding(Skills.HITPOINTS))), SANFEW_SERUM(new int[] {10931, 10929, 10927, 10925}, Drinkable.getRestorations(0.25F, 8, Drinkable.getAllSkillsExcluding(Skills.HITPOINTS))) {
        @Override
        public void onConsumption(final Player player) {
            player.getToxins().cureToxin(Toxins.ToxinType.POISON);
    ...
    static {
        for (final com.zenyte.game.content.consumables.drinks.Potion potion : values) {
