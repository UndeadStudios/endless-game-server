...
public class BountyHunter {
    ...
    public static final void onInit(final InitializationEvent event) {
        ...
        final com.zenyte.game.content.bountyhunter.BountyHunter savedBounty = savedPlayer.getBountyHunter();
    ...
    public static final void onDeath(final PlayerDeathEvent event) {
        final com.zenyte.game.world.entity.player.Player player = event.getPlayer();
        final com.zenyte.game.world.entity.Entity source = event.getSource();
        final com.zenyte.game.content.bountyhunter.BountyHunter bh = player.getBountyHunter();
        final com.zenyte.game.world.entity.player.Player target = bh.target;
        if (source == null) {
            bh.reset();
    ...
    private static final void setTargetIndividually(@NotNull final Player player) {
        final com.zenyte.game.content.bountyhunter.BountyHunter bh = player.getBountyHunter();
        final com.zenyte.game.world.entity.player.Player target = Objects.requireNonNull(bh.target);
    ...
    public void searchTarget() {
        ...
        for (final com.zenyte.game.world.entity.player.Player target : availablePlayers) {
            if (target == player) {
                continue;
            }
    ...
    public void abandonTarget() {
        final com.zenyte.game.world.entity.player.Player target = this.target;
        if (target == null) {
            return;
        }
        reset();
    ...
    private final void reset() {
        ...
        final com.zenyte.game.content.bountyhunter.BountyHunter bh = target.getBountyHunter();
        bh.target = null;
    }
