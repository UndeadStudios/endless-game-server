...
public class RockySupport extends NPC {
    ...
    public void sendDeath() {
        for (final com.zenyte.game.content.minigame.inferno.npc.impl.JalNib nibbler : inferno.getNPCs(JalNib.class)) {
        ...
        final com.zenyte.game.world.entity.npc.NPC fallenPillar = new NPC(7710, getLocation(), Direction.SOUTH, 0);
        fallenPillar.lock();
