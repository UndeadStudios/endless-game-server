...
public class JalMejRah extends InfernoNPC {
    ...
    private static final int[] drainableStats = {Skills.ATTACK, Skills.DEFENCE, Skills.STRENGTH, Skills.RANGED, Skills.MAGIC, Skills.HITPOINTS};
    /**
            ...
            if (sapCount < 10 && Utils.random(9 + sapCount) == 0) {
                ...
                for (int i = 0; i < drainableStats.length; i++) {
                    ...
                    if (skill == Skills.HITPOINTS) {
                        ...
                        final com.zenyte.game.world.entity.npc.combatdefs.StatType statType = statTypes[i];
                        if (statType == null) {
                            continue;
                        }
