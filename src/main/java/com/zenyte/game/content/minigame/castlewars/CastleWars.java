...
public class CastleWars {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(CastleWars.class);
    ...
    public static void preloadItemMap() {
        for (final ItemDefinitions defs : ItemDefinitions.definitions) {
            ...
            if (!defs.getName().contains("rune")) {
                ...
                final java.lang.String[] nameArray = defs.getName().split(" ");
    ...
    public static void finish() {
        final java.util.ArrayList<com.zenyte.game.world.entity.player.Player> players = new ArrayList<Player>();
    ...
    public static void setVarbit(final CastleWarsTeam team, final CWarsOverlayVarbit k, final int v) {
        ...
        if (!k.isUniversal()) {
            final java.util.List<com.zenyte.game.world.entity.player.Player> teamList = team.equals(CastleWarsTeam.SARADOMIN) ? SARADOMIN_TEAM : ZAMORAK_TEAM;
    ...
    public static boolean isTimerStarted() {
        return CastleWars.timerStarted;
    }

    public static void setTimerStarted(final boolean timerStarted) {
