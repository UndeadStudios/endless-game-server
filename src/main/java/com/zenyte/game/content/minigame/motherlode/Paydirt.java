...
public enum Paydirt {
    ...
    COAL(453, 3028, 30, 0), GOLDEN_NUGGET(12012, 0, 30, 0), //Keep golden nugget weight at 0, it's an exception!
    GOLD_ORE(444, 2267, 40, 15), MITHRIL_ORE(447, 2786, 55, 30), ADAMANTITE_ORE(449, 1651, 70, 45), RUNITE_ORE(451, 178, 85, 75);
    ...
    public static final Optional<Paydirt> generate(@NotNull final Player player) {
        ...
        int current = 0;
        for (final com.zenyte.game.content.minigame.motherlode.Paydirt value : values) {
    ...
    private Paydirt(final int id, final int weight, final int level, final int xp) {
        this.id = id;
        this.weight = weight;
        this.level = level;
        this.xp = xp;
