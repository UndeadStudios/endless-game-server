...
public enum BlastFurnaceOre {
    ...
    COAL(453, 2932, 2353), TIN_ORE(438, 2924, 2349), COPPER_ORE(436, 2925, 2349), IRON_ORE(440, 2926, 2351), SILVER_ORE(442, 2930, 2355), GOLD_ORE(444, 2931, 2357), MITHRIL_ORE(447, 2927, 2359), ADAMANTITE_ORE(449, 2928, 2361), RUNITE_ORE(451, 2929, 2363);
    ...
    private BlastFurnaceOre(final int itemId, final int npcId, final int barId) {
        this.itemId = itemId;
        this.npcId = npcId;
        this.barId = barId;
    }
