...
public enum PestPortal {
    WESTERN(1739, 1743, "Western shield", "Western health", new Location(2628, 2591, 0), new Location(2631, 2591, 0), "The purple, western portal shield has dropped!"), SOUTH_WESTERN(1742, 1746, "South-Western shield", "South-Western health", new Location(2645, 2569, 0), new Location(2645, 2572, 0), "The red, south-western portal shield has dropped!"), SOUTH_EASTERN(1741, 1745, "South-Eastern shield", "South-Eastern health", new Location(2669, 2570, 0), new Location(2669, 2573, 0), "The yellow, south-eastern portal shield has dropped!"), EASTERN(1740, 1744, "Eastern shield", "Eastern health", new Location(2680, 2588, 0), new Location(2677, 2588, 0), "The blue, eastern portal shield has dropped!");
    public static final PestPortal[] VALUES = values();
    private final int id;
    private final int protectedId;
    private final String shieldComponentName;
    private final String healthComponentName;
    private final Location tile;
    private final Location npcSpawnTile;
