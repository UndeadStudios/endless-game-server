...
public enum CastleWarsTeam {
    SARADOMIN(SARADOMIN_RESPAWN, SARADOMIN_LOBBY_SPAWN, new IntArrayList(SARADOMIN_DOORS), Arrays.asList(CastlewarsRockPatch.SOUTH, CastlewarsRockPatch.EAST)), ZAMORAK(ZAMORAK_RESPAWN, ZAMORAK_LOBBY_SPAWN, new IntArrayList(ZAMORAK_DOORS), Arrays.asList(CastlewarsRockPatch.NORTH, CastlewarsRockPatch.WEST));
    ...
    private CastleWarsTeam(final Location respawn, final Location lobbySpawn, final IntList largeCastleDoors, final List<CastlewarsRockPatch> rockPatches) {
