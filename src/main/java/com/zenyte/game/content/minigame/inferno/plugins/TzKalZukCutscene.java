...
public class TzKalZukCutscene extends Cutscene {
    ...
    public void build() {
        addActions(0, () -> {
            ...
            for (final com.zenyte.game.world.object.WorldObject rocks : inferno.getFallingRocks()) {
                World.spawnObject(rocks);
            }
            for (final com.zenyte.game.world.object.WorldObject patch : inferno.getWallPatches()) {
