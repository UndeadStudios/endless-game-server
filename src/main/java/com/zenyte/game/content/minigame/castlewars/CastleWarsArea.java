...
public class CastleWarsArea extends Area implements LoginPlugin, CannonRestrictionPlugin, RandomEventRestrictionPlugin, EntityAttackPlugin, DeathPlugin, EquipmentPlugin, LayableTrapRestrictionPlugin, CycleProcessPlugin, TeleportPlugin {
    ...
    public boolean attack(final Player player, final Entity entity) {
        ...
        final com.zenyte.game.world.entity.player.Player opponent = (Player) entity;
    ...
    public static void handleFlagDrop(final Player player, final boolean leave) {
        ...
        final com.zenyte.game.world.object.WorldObject object = getDroppedFlagObject(player, leave, objectId);
        final com.zenyte.game.content.minigame.castlewars.CastleWarsOverlay.CWarsOverlayVarbit varbit = objectId == CastleWarsFlagObject.SARADOMIN_FLAG_GROUND ? CWarsOverlayVarbit.SARADOMIN_FLAG : CWarsOverlayVarbit.ZAMORAK_FLAG;
