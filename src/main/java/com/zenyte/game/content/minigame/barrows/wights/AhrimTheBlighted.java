...
public class AhrimTheBlighted extends BarrowsWightNPC implements Spawnable, CombatScript {
	...
	public int attack(final Entity target) {
		final com.zenyte.game.world.entity.player.action.combat.magic.CombatSpell spell = Utils.random(6) != 0 ? CombatSpell.FIRE_WAVE : Utils.getRandomElement(CombatSpell.CONFUSE, CombatSpell.WEAKEN, CombatSpell.CURSE);
