...
public class JalXil extends InfernoNPC {
    ...
    private void rangedAttack(final Entity target) {
        final com.zenyte.game.world.entity.Location left = getFaceLocation(target, getSize(), 512);
        final com.zenyte.game.world.entity.Location right = getFaceLocation(target, getSize(), 1536);
