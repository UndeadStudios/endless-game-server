...
public class CastleWarsLobby extends Area implements LoginPlugin, CannonRestrictionPlugin, RandomEventRestrictionPlugin, EquipmentPlugin, CycleProcessPlugin {
    ...
    public void dispatchLateInvites(final Set<Player> lobby) {
        final com.zenyte.game.content.minigame.castlewars.CastleWarsTeam team = lobby.equals(SARADOMIN_LOBBY) ? CastleWarsTeam.SARADOMIN : CastleWarsTeam.ZAMORAK;
    ...
    public static int getSaradominInvites() {
        return CastleWarsLobby.saradominInvites;
    }

    public static void setSaradominInvites(final int saradominInvites) {
        CastleWarsLobby.saradominInvites = saradominInvites;
    }

    public static int getZamorakInvites() {
        return CastleWarsLobby.zamorakInvites;
    }

    public static void setZamorakInvites(final int zamorakInvites) {
        CastleWarsLobby.zamorakInvites = zamorakInvites;
    }

    public static int getTicks() {
        return CastleWarsLobby.ticks;
    }
