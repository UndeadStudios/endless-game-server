 ...
 */
public enum Tax {
    SMALL_TAX(pot -> pot < MILLION.get(10), 0.25F), MEDIUM_TAX(pot -> pot >= MILLION.get(10) && pot < MILLION.get(100), 0.5F), LARGE_TAX(pot -> pot >= MILLION.get(100), 1.0F);
    ...
    public static Tax getTax(final int amount) {
        for (final com.zenyte.game.content.minigame.duelarena.Tax tax : VALUES) {
    ...
    private Tax(final Function<Long, Boolean> function, final float rate) {
