...
public class MotherlodeArea extends Area implements CannonRestrictionPlugin, LayableTrapRestrictionPlugin {
    ...
    private enum NuggetRefund {
        ...
        private NuggetRefund(final int id, final int originalCost) {
            this.id = id;
    ...
    public static final void onLogin(final LoginEvent event) {
        ...
        int count = 0;
        for (final com.zenyte.game.content.minigame.motherlode.MotherlodeArea.NuggetRefund nuggetReward : NuggetRefund.values) {
    ...
    void spawn() {
        final com.zenyte.game.world.region.Region region = World.getRegion(14936, true);
        ...
        for (final com.zenyte.game.world.object.WorldObject object : objects) {
            if (object.getId() > 26664 && object.getId() < 26669) {
                final com.zenyte.game.content.minigame.motherlode.OreVein vein = new OreVein(object);
