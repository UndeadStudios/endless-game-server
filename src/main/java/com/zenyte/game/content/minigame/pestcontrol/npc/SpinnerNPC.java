...
public final class SpinnerNPC extends PestNPC {
	...
	public void processNPC() {
		if (exploding) {
			if (++ticks == 2) {
				finish();
				final java.util.List<com.zenyte.game.world.entity.Entity> targets = getPossibleTargets(EntityType.BOTH);
				final com.zenyte.game.world.entity.Location location = getLocation();
				for (final com.zenyte.game.world.entity.Entity target : targets) {
