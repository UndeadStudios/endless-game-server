...
public class TzHaarKetKeh extends NPCPlugin {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TzHaarKetKeh.class);
    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                final java.lang.Object hasSpoken = player.getAttributes().get("spokenToTzhaarKetKeh");
                if (hasSpoken == null) {
    ...
    private static void practiceMode(final Player player, final NPC npc) {
        player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                final java.lang.String feeLocation = mode.equals(GameMode.ULTIMATE_IRON_MAN) ? "inventory" : "bank";
                if (player.getNumericAttribute("infernoVar").intValue() < 2) {
                ...
                npc(16, "At which wave would you like to start your practice run?").executeAction(() -> {
                    ...
                    player.sendInputInt("Start the Inferno Practice run at wave (1 - 69):", value -> {
                        ...
                        final com.zenyte.game.content.minigame.inferno.model.InfernoWave wave = InfernoWave.get(value);
                        if (wave == null) {
                            setKey(30);
                            return;
                        }
                            ...
                            public void buildDialogue() {
                                ...
                                npc("Very well, JalYt.").executeAction(() -> {
                                    try {
                                        ...
                                        final com.zenyte.game.content.minigame.inferno.instance.Inferno inferno = new Inferno(player, area, true);
