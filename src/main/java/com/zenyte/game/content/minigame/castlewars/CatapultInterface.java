...
public class CatapultInterface extends Interface {
    ...
    protected void build() {
        ...
        bind("Fire", player -> {
            ...
            final com.zenyte.game.world.entity.Location destination = getDestination(player);
    ...
    private void refreshDigits(@NotNull final Player player) {
        ...
        final java.lang.String horizontalCoordsString = Integer.toString(horizontalClicks);
        final java.lang.String verticalCoordsString = Integer.toString(verticalClicks);
    ...
    private Location getDestination(@NotNull final Player player) {
        ...
        assert horizontalClicks >= 0 && horizontalClicks <= MAX_CLICKS;
        assert verticalClicks >= 0 && verticalClicks <= MAX_CLICKS;
        final com.zenyte.game.world.entity.Location startTile = team == CastleWarsTeam.SARADOMIN ? SARADOMIN_CATAPULT_LOWEST_LAND_COORDS : ZAMORAK_CATAPULT_LOWEST_LAND_COORDS;
