        ...
        if (option.equalsIgnoreCase(PEEK)) {
            player.getDialogueManager().start(new Dialogue(player) {
                ...
                public void buildDialogue() {
                    ...
                    final java.lang.String prefix = noOfPlayers == 1 ? "is" : "are";
                    final java.lang.String affix = noOfPlayers == 0 ? "no" : Integer.toString(noOfPlayers);
                    final java.lang.String suffix = noOfPlayers == 1 ? "player" : "players";
                    final java.lang.String players = prefix + " " + affix + " " + suffix;
