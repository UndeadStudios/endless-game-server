...
public class TzKalZuk extends InfernoNPC {
    ...
    public void processNPC() {
        ...
        if (xilAndZekSpawnDelay == 0) {
            final com.zenyte.game.content.minigame.inferno.npc.impl.JalXil xil = (JalXil) new JalXil(inferno.getLocation(jalXilSpawnLocation), inferno).spawn();
            final com.zenyte.game.content.minigame.inferno.npc.impl.JalZek zek = (JalZek) new JalZek(inferno.getLocation(jalZekSpawnLocation), inferno).spawn();
            xil.setTarget(glyph);
        ...
        if (!spawnedJad && getHitpoints() <= 480) {
            final com.zenyte.game.content.minigame.inferno.npc.impl.JalTokJad jad = new JalTokJad(inferno.getLocation(jadSpawnLocation), inferno);
            ...
            for (final com.zenyte.game.world.entity.Location location : healerSpawnLocations) {
        ...
        if (healing) {
            ...
            boolean check = false;
            for (final com.zenyte.game.content.minigame.inferno.npc.impl.zuk.JalMejJak healer : healers) {
                final com.zenyte.game.world.entity.Entity target = healer.getCombat().getTarget();
    ...
    public void setGlyph(final AncestralGlyph glyph) {
        this.glyph = glyph;
    }
