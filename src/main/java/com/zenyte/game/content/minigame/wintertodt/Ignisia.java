...
public class Ignisia extends NPCPlugin {
    ...
    public void handle() {
        bind("Trade-in", (player, npc) -> {
            ...
            for (final it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<java.lang.String> entry : tradeableItems.int2ObjectEntrySet()) {
    ...
    private void tradeItem(final Player player, final Item itemToTrade) {
        final com.zenyte.game.item.Item crate = new Item(RewardCrate.SUPPLY_CRATE);
        int rolls = 1;
