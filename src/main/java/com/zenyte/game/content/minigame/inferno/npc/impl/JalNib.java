...
public class JalNib extends InfernoNPC {
    ...
    public void processNPC() {
        ...
        if (combat.getTarget() instanceof RockySupport) {
            final com.zenyte.game.content.minigame.inferno.model.RockySupport support = (RockySupport) combat.getTarget();
    ...
    public boolean isProjectileClipped(final Position target, final boolean closeProximity) {
        for (final com.zenyte.game.content.minigame.inferno.model.RockySupport support : inferno.getRockySupports()) {
    ...
    public void playAttackSound(final Entity target) {
        final com.zenyte.game.world.entity.npc.combatdefs.AttackDefinitions attDefs = combatDefinitions.getAttackDefinitions();
