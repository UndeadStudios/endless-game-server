...
public enum PortalSequence {
	SEQUENCE_1(EASTERN, SOUTH_WESTERN, SOUTH_EASTERN, WESTERN), SEQUENCE_2(EASTERN, WESTERN, SOUTH_WESTERN, SOUTH_EASTERN), SEQUENCE_3(WESTERN, EASTERN, SOUTH_EASTERN, SOUTH_WESTERN), SEQUENCE_4(WESTERN, SOUTH_EASTERN, EASTERN, SOUTH_WESTERN), SEQUENCE_5(SOUTH_EASTERN, SOUTH_WESTERN, WESTERN, EASTERN), SEQUENCE_6(SOUTH_EASTERN, WESTERN, SOUTH_WESTERN, EASTERN);
