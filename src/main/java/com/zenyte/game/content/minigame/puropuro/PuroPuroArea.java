...
public class PuroPuroArea extends Area implements CycleProcessPlugin, LoginPlugin {
    ...
    private static class PuroPuroImplingSpawn {
        ...
        public boolean equals(@org.jetbrains.annotations.Nullable final Object o) {
            ...
            if (this$impling == null ? other$impling != null : !this$impling.equals(other$impling)) return false;
            return true;
        }
    ...
    public static class MagicalWheatSpawn {
        ...
        public void spawn() {
            spawnCooldown = true;
            visible = true;
            final com.zenyte.game.world.object.WorldObject first = new WorldObject(GROWING_WHEAT, 22, isVertical() ? 0 : 1, getFirst());
            final com.zenyte.game.world.object.WorldObject second = new WorldObject(GROWING_WHEAT, 22, isVertical() ? 0 : 1, getSecond());
        ...
        public void despawn() {
            spawnCooldown = true;
            visible = false;
            final com.zenyte.game.world.object.WorldObject first = new WorldObject(WILTING_WHEAT, 22, isVertical() ? 0 : 1, getFirst());
            final com.zenyte.game.world.object.WorldObject second = new WorldObject(WILTING_WHEAT, 22, isVertical() ? 0 : 1, getSecond());
        ...
        private void moveEntitiesOffWheat() {
            CharacterLoop.forEach(first, 0, Entity.class, e -> {
                final com.zenyte.game.world.entity.Location newLocation = e.getLocation().transform(isVertical() ? Direction.EAST : Direction.NORTH, 1);
                e.resetWalkSteps();
