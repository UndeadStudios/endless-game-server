...
public class ElnockInquisitor extends NPCPlugin {
    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> {
            final java.lang.Boolean receivedStarterEquipment = player.getAttributeOrDefault(ELNOCK_EQUIPMENT_ATTRIBUTE, false);
            if (receivedStarterEquipment) {
                player.getDialogueManager().start(new Dialogue(player, npc) {
                    @Override
                    public void buildDialogue() {
                        npc("Ah, good day, it\'s you again. What can I do for you?");
                        final java.lang.Boolean overlayEnabled = player.getAttributeOrDefault(PuroPuroImplingOverlay.PURO_PURO_OVERLAY_ATTRIBUTE, false);
