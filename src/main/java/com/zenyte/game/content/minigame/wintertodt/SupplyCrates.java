...
public class SupplyCrates implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        final mgi.types.config.items.ItemDefinitions item = ItemDefinitions.getOrThrow(WintertodtCrate.VALUE_MAP.get(objectId));
    ...
    private enum WintertodtCrate {
        ...
        static {
            for (final com.zenyte.game.content.minigame.wintertodt.SupplyCrates.WintertodtCrate crate : VALUES) {
        ...
        private WintertodtCrate(final int itemId, final int objectId) {
            this.itemId = itemId;
