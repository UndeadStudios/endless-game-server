...
public class CollectTearAction extends Action {
    ...
    public int processWithDelay() {
        final com.zenyte.game.content.tog.TearsOfGuthix tears = tearsOfGuthixWall.getCurrentTears();
    ...
    public CollectTearAction(final TearsOfGuthixWall tearsOfGuthixWall, final WorldObject object) {
