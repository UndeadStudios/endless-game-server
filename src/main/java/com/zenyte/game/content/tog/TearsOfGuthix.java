...
public enum TearsOfGuthix {
    BLUE(ObjectId.BLUE_TEARS_6665, 1), GREEN(ObjectId.GREEN_TEARS_6666, -1), ABSENCE(ObjectId.ABSENCE_OF_TEARS_6667, 0);
    ...
    private TearsOfGuthix(final int objectId, final int pointModifier) {
