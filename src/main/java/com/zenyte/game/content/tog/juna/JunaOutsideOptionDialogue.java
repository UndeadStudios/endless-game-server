...
public class JunaOutsideOptionDialogue extends Dialogue {
    ...
    public void buildDialogue() {
        ...
        final java.lang.String reminderToggleOption = reminderEnabled ? "I don\'t want any messages reminding me to return here." : "I\'d like to receive messages prompting me to return here.";
        ...
        final java.lang.String reminderNpcChat = "Very well, " + (reminderEnabled ? "when you are eligible to drink from the Tears, you shall be reminded daily." : "it will be up to you to remember when you can return. It is good that you are willing to take responsibility for yourself in this way.");
