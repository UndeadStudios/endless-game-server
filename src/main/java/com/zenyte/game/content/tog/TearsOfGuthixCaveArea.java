...
public class TearsOfGuthixCaveArea extends TearsOfGuthixArea implements CycleProcessPlugin, DeathPlugin, TeleportPlugin, EquipmentPlugin {
    ...
    private static int getLowestSkill(@NotNull final Player player) {
        ...
        for (final java.lang.Integer skillId : Skills.SKILL_IDS) {
    ...
    public void enter(Player player) {
        ...
        for (final com.zenyte.game.constants.GameInterface position : TABS_INTERFACE_POS) {
    ...
    public void process() {
        ...
        for (final com.zenyte.game.content.tog.TearsOfGuthixWall weepingWall : TearsOfGuthixWall.WALLS) {
            weepingWall.process();
        }
    }
