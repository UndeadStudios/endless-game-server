...
public enum BeginnerClueNPC implements ClueNPC {
    ...
    static {
        for (final com.zenyte.game.content.treasuretrails.npcs.drops.BeginnerClueNPC value : values()) {
            final java.util.List<com.zenyte.game.content.treasuretrails.npcs.drops.PredicatedClueDrop> list = mappedNPCs.computeIfAbsent(value.monsterName, __ -> new LinkedList<>());
    ...
    private BeginnerClueNPC(final String monsterName, final double rate, final Predicate<NPCDefinitions> predicate) {
