...
public enum HardClueNPC implements ClueNPC {
    ...
    static {
        for (final com.zenyte.game.content.treasuretrails.npcs.drops.HardClueNPC value : values()) {
    ...
    private HardClueNPC(final String monsterName, final double rate, final Predicate<NPCDefinitions> predicate) {
