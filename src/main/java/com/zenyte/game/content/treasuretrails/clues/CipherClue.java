...
public enum CipherClue implements Clue {
	BMJ_UIF_LFCBC_TFMMFS(MEDIUM, ChallengeScroll.ALI_THE_KEBAB_SELLER, 3536), ECRVCKP_MJCNGF(MEDIUM, ChallengeScroll.CAPTAIN_KHALED, 6971, 6972), 
	...
	QSPGFTTPS_HSBDLMFCPOF(MEDIUM, ChallengeScroll.PROFESSOR_GRACKLEBONE, 7048), USBJCPSO(MEDIUM, ChallengeScroll.TRAIBORN, 5081), UZZU_MUJHRKYYKJ(HARD, ChallengeScroll.OTTO_GODBLESSED, 2914, 2915), VTYR_APCNTGLW(HARD, ChallengeScroll.KING_PERCIVAL, 4058), ZCZL(MEDIUM, ChallengeScroll.ADAM, 311), ZHLUG_ROG_PDQ(HARD, ChallengeScroll.WEIRD_OLD_MAN, 954), ZSBKDO_ZODO(HARD, null, 601, 602, 3389, 4814, 4816);
	//PUZZLE BOX
	...
	static {
		for (final com.zenyte.game.content.treasuretrails.clues.CipherClue value : values) {
