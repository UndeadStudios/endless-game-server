...
public class AncientWizard extends TreasureGuardian implements CombatScript {
    ...
    public void processNPC() {
        ...
        if (++ticks > 50 || !owner.getLocation().withinDistance(this, 15)) {
            final java.lang.Object list = owner.getTemporaryAttributes().get("TT Guardian NPC");
            if (list instanceof Collection) {
                for (final java.lang.Object n : ((Collection) list)) {
    ...
    public int attack(final Entity target) {
        ...
        case 7307: 
            {
                final com.zenyte.game.world.entity.player.action.combat.magic.CombatSpell spell = CombatSpell.BLOOD_BLITZ;
                setAnimation(spell.getAnimation());
                final com.zenyte.game.world.Projectile proj = spell.getProjectile();
        ...
        case 7308: 
            {
                final com.zenyte.game.world.entity.player.action.combat.AmmunitionDefinitions defs = AmmunitionDefinitions.RUNITE_BOLT;
                setAnimation(new Animation(7552));
                final com.zenyte.game.world.Projectile proj = defs.getProjectile();
