...
public enum MediumClueNPC implements ClueNPC {
    ...
    static {
        for (final com.zenyte.game.content.treasuretrails.npcs.drops.MediumClueNPC value : values()) {
    ...
    private MediumClueNPC(final String monsterName, final double rate, final Predicate<NPCDefinitions> predicate) {
