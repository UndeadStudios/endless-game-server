...
public enum EasyClueNPC implements ClueNPC {
    ...
    static {
        for (final com.zenyte.game.content.treasuretrails.npcs.drops.EasyClueNPC value : values()) {
    ...
    private EasyClueNPC(final String monsterName, final double rate, final Predicate<NPCDefinitions> predicate) {
