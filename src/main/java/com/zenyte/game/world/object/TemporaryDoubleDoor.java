...
public final class TemporaryDoubleDoor {
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TemporaryDoubleDoor.class);
	...
	public static void handleBarrowsDoubleDoor(final Player player, final WorldObject object, final Consumer<Location> callback) {
		final com.zenyte.game.world.object.WorldObject nearbyDoor = getNearbyDoor(player, object);
		if (nearbyDoor == null) {
			return;
		}
		final com.zenyte.game.world.entity.Location walkLocation = getWalkLocation(player, object);
		player.lock();
