...
public class PickPlant extends Action {
	...
	public enum Pickables {
		WHEAT("wheat", new Item(1947, 1)), ONION("onion", new Item(1957, 1)), POTATO("potato", new Item(1942, 1)), CABBAGE("cabbage", new Item(1965, 1)), FLAX("flax", new Item(1779, 1)), NETTLES("nettles", new Item(4241, 1));
		private String name;
		private Item item;
		...
		static {
			for (Pickables entry : Pickables.VALUES) map.put(entry.getName(), entry);
		}
