...
public class ElderChaosDruid extends NPC implements CombatScript, Spawnable {
	...
	public void processNPC() {
		...
		if (Utils.random(15) == 0) {
			...
			final com.zenyte.game.world.entity.Location location = new Location(getLocation());
	...
	public int attack(Entity target) {
		final com.zenyte.game.world.Projectile projectile = CombatSpell.WIND_WAVE.getProjectile();
