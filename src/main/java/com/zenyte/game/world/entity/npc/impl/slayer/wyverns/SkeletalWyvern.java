...
public class SkeletalWyvern extends Wyvern {
    ...
    public int attack(final Entity target) {
        ...
        final com.zenyte.game.world.entity.npc.combatdefs.AttackType currentStyle = combatDefinitions.getAttackStyle();
        final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.entity.npc.combatdefs.AttackType> styles = new ObjectArrayList<AttackType>(Arrays.asList(ATTACK_STYLES));
