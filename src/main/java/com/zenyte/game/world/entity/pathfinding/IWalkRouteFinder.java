...
public class IWalkRouteFinder {
    ...
    private final int DIR_SOUTH = 4;
    private final int DIR_WEST = 8;
     ...
     */
    public synchronized int findRoute(final int srcX, final int srcY, final int srcZ, final int srcSizeXY, final RouteStrategy strategy, final boolean findAlternative) {
        try {
            isAlternative = false;
    ...
    private boolean performCalculationS1(final int srcX, final int srcY, final RouteStrategy strategy) {
        ...
        while (read != write) {
            ...
            if (currentGraphX > 0 && tileDirections[currentGraphX - 1][currentGraphY] == 0 && (clipMasks[currentGraphX - 1][currentGraphY] & (Flags.BLOCK_EAST)) == 0) {
            ...
            if (currentGraphX < (GRAPH_SIZE - 1) && tileDirections[currentGraphX + 1][currentGraphY] == 0 && (clipMasks[currentGraphX + 1][currentGraphY] & (Flags.BLOCK_WEST)) == 0) {
            ...
            if (currentGraphY > 0 && tileDirections[currentGraphX][currentGraphY - 1] == 0 && (clipMasks[currentGraphX][currentGraphY - 1] & (Flags.BLOCK_NORTH)) == 0) {
            ...
            if (currentGraphY < (GRAPH_SIZE - 1) && tileDirections[currentGraphX][currentGraphY + 1] == 0 && (clipMasks[currentGraphX][currentGraphY + 1] & (Flags.BLOCK_SOUTH)) == 0) {
            ...
            if (currentGraphX > 0 && currentGraphY > 0 && tileDirections[currentGraphX - 1][currentGraphY - 1] == 0 && (clipMasks[currentGraphX - 1][currentGraphY - 1] & (Flags.BLOCK_NORTH_EAST)) == 0 && (clipMasks[currentGraphX - 1][currentGraphY] & (Flags.BLOCK_EAST)) == 0 && (clip[currentGraphX][currentGraphY - 1] & (Flags.BLOCK_NORTH)) == 0) {
            ...
            if (currentGraphX < (GRAPH_SIZE - 1) && currentGraphY > 0 && tileDirections[currentGraphX + 1][currentGraphY - 1] == 0 && (clipMasks[currentGraphX + 1][currentGraphY - 1] & (Flags.BLOCK_NORTH_WEST)) == 0 && (clipMasks[currentGraphX + 1][currentGraphY] & (Flags.BLOCK_WEST)) == 0 && (clipMasks[currentGraphX][currentGraphY - 1] & (Flags.BLOCK_NORTH)) == 0) {
            ...
            if (currentGraphX > 0 && currentGraphY < (GRAPH_SIZE - 1) && tileDirections[currentGraphX - 1][currentGraphY + 1] == 0 && (clipMasks[currentGraphX - 1][currentGraphY + 1] & (Flags.BLOCK_SOUTH_EAST)) == 0 && (clipMasks[currentGraphX - 1][currentGraphY] & (Flags.BLOCK_EAST)) == 0 && (clipMasks[currentGraphX][currentGraphY + 1] & (Flags.BLOCK_SOUTH)) == 0) {
            ...
            if (currentGraphX < (GRAPH_SIZE - 1) && currentGraphY < (GRAPH_SIZE - 1) && tileDirections[currentGraphX + 1][currentGraphY + 1] == 0 && (clipMasks[currentGraphX + 1][currentGraphY + 1] & (Flags.BLOCK_SOUTH_WEST)) == 0 && (clipMasks[currentGraphX + 1][currentGraphY] & (Flags.BLOCK_WEST)) == 0 && (clipMasks[currentGraphX][currentGraphY + 1] & (Flags.BLOCK_SOUTH)) == 0) {
    ...
    private void transmitClipData(final int x, final int y, final int z) {
        ...
        for (int transmitRegionX = graphBaseX >> 6; transmitRegionX <= (graphBaseX + (GRAPH_SIZE - 1)) >> 6; transmitRegionX++) {
            for (int transmitRegionY = graphBaseY >> 6; transmitRegionY <= (graphBaseY + (GRAPH_SIZE - 1)) >> 6; transmitRegionY++) {
                final int startX = Math.max(graphBaseX, transmitRegionX << 6);
                final int startY = Math.max(graphBaseY, transmitRegionY << 6);
                final int endX = Math.min(graphBaseX + GRAPH_SIZE, (transmitRegionX << 6) + 64);
                final int endY = Math.min(graphBaseY + GRAPH_SIZE, (transmitRegionY << 6) + 64);
