...
public class SpittingWyvern extends Wyvern {
    ...
    public int attack(Entity target) {
        ...
        if (style == 0) {
            ...
            final com.zenyte.game.world.entity.masks.Hit originalHit = ranged(target, 4);
            final com.zenyte.game.world.entity.masks.Hit hit = new Hit(originalHit.getSource(), originalHit.getDamage(), originalHit.getHitType());
            final com.zenyte.game.world.entity.masks.Hit[] hits = new Hit[hitAmount];
            final org.apache.commons.lang3.mutable.MutableBoolean dealtDamage = new MutableBoolean();
