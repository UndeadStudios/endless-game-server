...
public class PerkManager {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PerkManager.class);
    ...
    private Perk getPerk(final PerkWrapper wrapper) {
        final java.lang.Class<? extends com.zenyte.game.world.entity.player.perk.Perk> parent = wrapper.getPerk();
        try {
    ...
    public boolean unlock(final PerkWrapper wrapper) {
        final com.zenyte.game.world.entity.player.perk.Perk perk = getPerk(wrapper);
