		...
		if (sizeXY == 1) {
			...
			if (targetType == 6 || targetType == 7) {
				...
				if (targetRotation == 0) {
					...
					if (currentX >= targetX && targetX <= i_66_ && currentY == (targetY - sizeXY) && (clip[targetX][targetY] & Flags.WALL_NORTH) == 0) {
						return true;
					}
				} else if (targetRotation == 1) {
					...
					if (targetX >= currentX && targetX <= i_66_ && currentY == (targetY - sizeXY) && (clip[targetX][targetY] & Flags.WALL_NORTH) == 0) {
						return true;
					}
				} else if (targetRotation == 2) {
					...
					if (targetX >= currentX && targetX <= i_66_ && currentY == (targetY + sizeXY) && (clip[targetX][targetY] & Flags.WALL_SOUTH) == 0) {
						return true;
					}
				} else if (targetRotation == 3) {
					...
					if (currentX >= targetX && targetX <= i_66_ && currentY == (targetY + sizeXY) && (clip[targetX][targetY] & Flags.WALL_SOUTH) == 0) {
						return true;
					}
				}
			} else if (targetType == 8) {
				...
				if (currentX == (targetX + sizeXY) && currentY >= (targetY - sizeXY) && currentY <= (targetY + sizeXY) && (clip[targetX][targetY] & Flags.WALL_WEST) == 0) {
					return true;
				}
			}
		}
