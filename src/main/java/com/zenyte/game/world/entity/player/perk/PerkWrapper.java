...
public enum PerkWrapper {
    MASTER_MINER(MasterMinerPerk.class, 30003), ATHLETIC_RUNNER(AthleticRunnerPerk.class, 30004), MASTER_FISHERMAN(MasterFisherManPerk.class, 30005), 
    ...
    static {
        for (final com.zenyte.game.world.entity.player.perk.PerkWrapper value : VALUES) {
    ...
    private PerkWrapper(final Class<? extends Perk> perk, final int id) {
        this.perk = perk;
        this.id = id;
    }
}
