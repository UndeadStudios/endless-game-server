...
public class RuneDragon extends NPC implements CombatScript, Spawnable {
    ...
    public void processNPC() {
        ...
        if (ticks >= 7) {
            for (final com.zenyte.game.world.entity.npc.NPC lightning : lightnings) {
                if (lightning == null) {
                    continue;
                }
                lightning.finish();
    ...
    private int attackFromDistance(final Entity target) {
        ...
        if (style <= 3) {
            ...
            final com.zenyte.game.world.entity.Location[] locations = new Location[2];
            ...
            final com.zenyte.game.world.Projectile projectile = AmmunitionDefinitions.ENCHANTED_ONYX_BOLT.getProjectile();
    ...
    private int dragonfire(final Entity target) {
        ...
        final com.zenyte.game.world.entity.npc.impl.slayer.dragons.Dragonfire dragonfire = new Dragonfire(DragonfireType.CHROMATIC_DRAGONFIRE, 50, DragonfireProtection.getProtection(player));
