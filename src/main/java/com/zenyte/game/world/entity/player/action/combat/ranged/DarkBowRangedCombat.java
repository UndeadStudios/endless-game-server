...
public final class DarkBowRangedCombat extends RangedCombat {
	...
	private enum Arrow {
		...
		private Arrow(final AmmunitionDefinitions definitions, final Graphics drawback, final Projectile firstProjectile, final Projectile secondProjectile) {
	...
	public int processWithDelay() {
		...
		final com.zenyte.game.item.Item ammo = player.getAmmo();
		...
		animate();
		final com.zenyte.game.world.entity.player.action.combat.ranged.DarkBowRangedCombat.Arrow arrow = Arrow.map.get(ammunition);
		...
		final com.zenyte.game.world.entity.masks.Hit firstHit = getHit(player, target, 1, 1, 1, false);
		final com.zenyte.game.world.entity.masks.Hit secondHit = getHit(player, target, 1, 1, 1, false);
