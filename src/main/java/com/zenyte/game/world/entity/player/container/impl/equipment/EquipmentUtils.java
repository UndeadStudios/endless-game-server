...
public class EquipmentUtils {
	...
	public static boolean containsFullGraceful(final Player player) {
		for (final com.zenyte.game.world.entity.player.container.impl.equipment.EquipmentSlot slot : GRACEFUL_SLOTS) {
	...
	public static boolean containsAbyssalBracelet(final Player player) {
		final com.zenyte.game.item.Item hands = player.getEquipment().getItem(EquipmentSlot.HANDS);
		if (hands == null) {
			return false;
		}
