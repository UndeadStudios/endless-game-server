...
abstract class CrashSiteGorilla extends NPC implements CombatScript {
    ...
    public NPC spawn() {
        missedHits = 0;
        final com.zenyte.game.world.entity.npc.NPC npc = super.spawn();
    ...
    public void processNPC() {
        final com.zenyte.game.world.entity.npc.combatdefs.AttackType combatStyle = combatDefinitions.getAttackStyle();
    ...
    public void applyHit(@NotNull final Hit hit) {
        ...
        if (combatStyle.isMelee()) {
            if (meleeSwitchTick < (WorldThread.WORLD_CYCLE - MELEE_SWITCH_DELAY)) {
                final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.entity.npc.combatdefs.AttackType> availableAttackStyle = new ObjectArrayList<>(Arrays.asList(MAGIC, RANGED));
                final com.zenyte.game.world.entity.Entity source = hit.getSource();
                if (source instanceof Player) {
                    final com.zenyte.game.content.skills.prayer.PrayerManager prayers = ((Player) source).getPrayerManager();
    ...
    private final int getDistance2D(@NotNull final Location source, final int sourceSize, @NotNull final Location target, final int targetSize) {
        final com.zenyte.game.world.entity.Location p1 = getAxisDistances(source, sourceSize, target);
        final com.zenyte.game.world.entity.Location p2 = getAxisDistances(target, targetSize, source);
    ...
    private final void onFailedCloseAttack(@NotNull final Entity target) {
        ...
        final it.unimi.dsi.fastutil.objects.ObjectArrayList<com.zenyte.game.world.entity.npc.combatdefs.AttackType> nextPossibleAttacks = new ObjectArrayList<AttackType>();
    ...
    private final void switchStyleTo(@NotNull final AttackType type, final boolean correctlyPrayed) {
        missedHits = 0;
        final com.zenyte.game.world.entity.npc.combatdefs.AttackType previousType = combatDefinitions.getAttackType();
    ...
    private void meleeAttack(final Entity target) {
        ...
        final com.zenyte.game.world.entity.masks.Hit hit = new Hit(this, getRandomMaxHit(this, getCombatDefinitions().getMaxHit(), MELEE, target), HitType.MELEE);
    ...
    private void rangedAttack(final Entity target) {
        ...
        final com.zenyte.game.world.entity.masks.Hit hit = new Hit(this, getRandomMaxHit(this, getCombatDefinitions().getMaxHit(), RANGED, target), HitType.RANGED);
    ...
    private void magicAttack(final Entity target) {
        ...
        final com.zenyte.game.world.entity.masks.Hit hit = new Hit(this, getRandomMaxHit(this, getCombatDefinitions().getMaxHit(), MAGIC, target), HitType.MAGIC);
    ...
    private void boulderAttack(final Entity target) {
        final com.zenyte.game.world.entity.Location collisionTile = new Location(target.getX(), target.getY(), target.getPlane());
        final com.zenyte.game.world.entity.Location from = collisionTile.transform(Direction.NORTH);
