...
public class Default implements CombatScript {
	...
	public int attack(final NPC npc, final Entity target) {
		...
		final com.zenyte.game.world.entity.npc.combatdefs.AttackType style = defs.getAttackStyle();
		final com.zenyte.game.world.entity.npc.combatdefs.AttackDefinitions attDefs = defs.getAttackDefinitions();
		final com.zenyte.game.world.Projectile proj = attDefs.getProjectile();
		final com.zenyte.game.world.entity.masks.Graphics drawback = attDefs.getDrawbackGraphics();
		if (drawback != null) {
