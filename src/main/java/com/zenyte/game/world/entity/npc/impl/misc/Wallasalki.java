...
public class Wallasalki extends NPC implements CombatScript, Spawnable {
    ...
    public int attack(Entity target) {
        animate();
        attackSound();
        final com.zenyte.game.world.entity.npc.impl.misc.Wallasalki npc = this;
        int delay = 1;
        int clientDelay = 30;
        final com.zenyte.game.world.entity.player.action.combat.magic.CombatSpell spell = CombatSpell.WATER_WAVE;
        if (projectile != null) {
        ...
        final com.zenyte.game.world.entity.HitEntry hitEntry = new HitEntry(npc, delay, magic(target, combatDefinitions.getMaxHit()));
