...
public class Gorak extends NPC implements Spawnable, CombatScript {
    ...
    public int attack(Entity target) {
        animate();
        final com.zenyte.game.world.entity.masks.Hit hit = new Hit(this, getRandomMaxHit(this, combatDefinitions.getMaxHit(), AttackType.CRUSH, target), HitType.REGULAR);
