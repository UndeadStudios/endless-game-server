...
public class SkillMessage implements Message {
	...
	public SkillMessage(final int maxQuantity, final boolean maxTen, final String message, final Item... items) {
		final java.lang.StringBuilder builder = new StringBuilder(message);
	...
	public void display(final Player player) {
		final java.lang.Object lastAmount = player.getTemporaryAttributes().get("lastSkillDialogueAmount");
