...
public class FloorItemEvent extends RouteEvent<Player, FloorItemStrategy> {
	...
	public boolean process() {
		...
		if (!entity.hasWalkSteps()) {
			for (final com.zenyte.game.world.entity.pathfinding.RouteStrategy strategy : strategies) {
				final com.zenyte.game.world.entity.pathfinding.RouteResult steps = RouteFinder.findRoute(entity, entity.getSize(), strategy, true);
