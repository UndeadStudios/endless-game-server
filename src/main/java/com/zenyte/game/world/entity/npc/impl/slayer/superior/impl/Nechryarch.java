...
public class Nechryarch extends SuperiorNPC implements CombatScript {
    ...
    public void onDeath(final Entity source) {
        ...
        for (final com.zenyte.game.world.entity.npc.NPC spawn : spawns) {
            spawn.sendDeath();
        }
        spawnCount = 0;
    }
    ...
    public int attack(Entity target) {
        ...
        if (Utils.random(5) == 0) {
            for (int i = 0; i < 3; i++) {
                ...
                if (spawnCount <= 3) {
                    final com.zenyte.game.world.entity.npc.impl.slayer.DeathSpawn spawn = new DeathSpawn(i == 0 ? 6716 : i == 1 ? 6723 : 7649, tile, Direction.SOUTH, 5);
                    spawn.spawn();
                    spawns.add(spawn);
                    spawnCount += 1;
