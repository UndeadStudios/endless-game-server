    ...
    private int attackFromDistance(final Entity target) {
        ...
        if (style <= 2) {
            ...
            WorldTasksManager.schedule(() -> {
                ...
                final java.util.ArrayList<com.zenyte.game.world.entity.Location> locations = new ArrayList<Location>(2);
                ...
                for (final com.zenyte.game.world.entity.Location l : locations) {
                    WorldTasksManager.schedule(() -> {
            ...
            //blood forfeit
            final com.zenyte.game.world.Projectile projectile = AmmunitionDefinitions.ENCHANTED_RUBY_BOLT.getProjectile();
