...
public class DarkWizard extends NPC implements Spawnable, CombatScript {
    ...
    public int attack(final Entity target) {
        ...
        final com.zenyte.game.world.entity.player.action.combat.magic.CombatSpell spell = spellType <= 4 ? (combat == 7 ? CombatSpell.WATER_STRIKE : CombatSpell.EARTH_STRIKE) : (combat == 7 ? CombatSpell.CONFUSE : CombatSpell.WEAKEN);
