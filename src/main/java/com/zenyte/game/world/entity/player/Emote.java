...
public enum Emote {
	ACHIEVEMENT_DIARY_CAPE(-1, player -> {
		final int delay = EmoteSequence.ACHIEVEMENT_DIARY_ANIM.getDuration();
	...
	}), YES(0, new Animation(855)), NO(1, new Animation(856)), BOW(2, new Animation(858)), ANGRY(3, new Animation(864)), THINK(4, new Animation(857)), WAVE(5, new Animation(863)), SHRUG(6, new Animation(2113)), CHEER(7, new Animation(862)), BECKON(8, new Animation(859)), LAUGH(9, new Animation(861)), JUMP_FOR_JOY(10, new Animation(2109)), YAWN(11, new Animation(2111)), DANCE(12, new Animation(866)), JIG(13, new Animation(2106)), SPIN(14, new Animation(2107)), HEADBANG(15, new Animation(2108)), CRY(16, new Animation(860)), BLOW_KISS(17, new Animation(1368), new Graphics(574)), PANIC(18, new Animation(2105)), RASPBERRY(19, new Animation(2110)), CLAP(20, new Animation(865)), SALUTE(21, new Animation(2112)), GOBLIN_BOW(22, 532, new Animation(2127)), GOBLIN_SALUTE(23, 532, new Animation(2128)), GLASS_BOX(24, 1368, new Animation(1131)), CLIMB_ROPE(25, 1369, new Animation(1130)), LEAN(26, 1370, new Animation(1129)), GLASS_WALL(27, 1367, new Animation(1128)), IDEA(28, 2311, new Animation(4276), new Graphics(712)), STAMP(29, 2312, new Animation(4278)), FLAP(30, 2309, new Animation(4280)), SLAP_HEAD(31, 2310, new Animation(4275)), ZOMBIE_WALK(32, 1921, new Animation(3544)), ZOMBIE_DANCE(33, 1920, new Animation(3543)), SCARED(34, 1371, new Animation(2836)), RABBIT_HOP(35, 2055, new Animation(6111)), SIT_UP(36, 4732, new Animation(2763)), PUSH_UP(37, 4732, new Animation(2762)), STAR_JUMP(38, 4732, new Animation(2761)), JOG(39, 4732, new Animation(2764)), ZOMBIE_HAND(40, 1000, new Animation(4513), new Graphics(320)), HYPERMOBILE_DRINKER(41, 4802, new Animation(7131)), SKILL_CAPE(42, player -> {
		...
		final com.zenyte.game.world.entity.player.CapesData cape = CapesData.MAP.get(capeId);
		if (cape == null) {
		...
		final int delay = cape.getAnimation() == null ? 7200 : cape.getAnimation().getDuration();
		addDelay(player, delay);
	...
	}), AIR_GUITAR(43, 4673, new Animation(4751), new Graphics(1239)), URI_TRANSFORM(44, 5104, player -> {
	...
	}), SMOOTH_DANCE(45, 5597, new Animation(7533)), CRAZY_DANCE(46, 5598, player -> {
		...
		final com.zenyte.game.world.entity.masks.Animation anim = cycle == 0 ? EmoteSequence.CRAZY_DANCE_A : EmoteSequence.CRAZY_DANCE_B;
	...
	}), TRICK(48, -2, new Animation(15247), new Graphics(2517)), GIVE_THANKS(49, -2, null, null), SNOWMAN_DANCE(50, 15024, new Animation(15094), null), FREEZE(51, 15025, new Animation(15093), new Graphics(2505)), DRAMATIC_POINT(52, 15026, new Animation(15084), new Graphics(2502)), AROUND_THE_WORLD_IN_EGGTY_DAYS(53, 15051, new Animation(15231), new Graphics(2514));
	...
	public static void play(final Player player, final String emoteName) {
		final com.zenyte.game.world.entity.player.Emote emote = MAP.get(emoteName);
		if (emote == null) {
			return;
		}
		...
		if (emote == TRICK) {
			...
			final int delay = (int) Math.ceil(emote.animation.getDuration() / 600.0F);
	...
	static {
		for (final com.zenyte.game.world.entity.player.Emote emote : VALUES) {
