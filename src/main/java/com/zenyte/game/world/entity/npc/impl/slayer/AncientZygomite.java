...
public class AncientZygomite extends NPC implements Spawnable, CombatScript {
    ...
    public void processNPC() {
        ...
        if (getId() == 7797) {
            if ((Utils.currentTimeMillis() - getAttackingDelay()) >= 5000) {
                final com.zenyte.game.world.entity.npc.spawns.NPCSpawn spawn = getNpcSpawn();
                final com.zenyte.game.world.entity.Location location = spawn == null ? getLocation() : new Location(spawn.getX(), spawn.getY(), spawn.getZ());
                cancelCombat();
    ...
    public void sendDeath() {
        ...
        final java.lang.Object usedOn = getTemporaryAttributes().remove("used_fungicide_spray");
        final java.lang.Object obj = isUnlocked && usedOn == null ? FungicideSpray.get(source) : usedOn;
        if (getHitpoints() == 0 && obj == null) {
            ...
            final java.lang.Object[] info = (Object[]) obj;
            assert info != null && info[0] instanceof FungicideSpray;
            final com.zenyte.game.item.enums.FungicideSpray spray = (FungicideSpray) info[0];
