...
public class BattleMageNPC extends NPC implements Spawnable, CombatScript {
    ...
    protected boolean isAcceptableTarget(final Entity target) {
        if (target instanceof Player) {
            final com.zenyte.game.item.Item cape = ((Player) target).getCape();
    ...
    public int attack(final Entity target) {
        final com.zenyte.game.world.entity.player.action.combat.magic.CombatSpell spell = def.getSpell();
    ...
    private enum BattleMage {
        ...
        private BattleMage(final int mageId, final int capeId, final CombatSpell spell) {
            this.mageId = mageId;
            this.capeId = capeId;
            this.spell = spell;
        }
        ...
        public static int[] getMageIds() {
            return BattleMage.mageIds;
        }

        public static CombatSpell[] getSpells() {
            return BattleMage.spells;
        }
    }
    ...
    public static final class BattleMageProcessor extends DropProcessor {
        ...
        public void onDeath(final NPC npc, final Player killer) {
            ...
            if (random < 6) {
                ...
                final boolean master = random(1000) == 0;
                final boolean teacher = random(500) == 0;
                final boolean apprentice = random(250) == 0;
                final boolean beginner = random(125) == 0;
                if (master) {
