...
public class BrutalDragon extends NPC implements Spawnable, CombatScript {
    ...
    public int attack(final Entity target) {
        final com.zenyte.game.world.entity.npc.impl.slayer.dragons.BrutalDragon npc = this;
        ...
        if (style == 0) {
            ...
            final com.zenyte.game.world.entity.npc.impl.slayer.dragons.Dragonfire dragonfire = new Dragonfire(DragonfireType.CHROMATIC_DRAGONFIRE, 50, DragonfireProtection.getProtection(player, true));
            ...
            final com.zenyte.game.world.Projectile projectile = name.contains("green") ? greenDragonProjectile : name.contains("blue") ? blueDragonProjectile : name.contains("red") ? redDragonProjectile : blackDragonProjectile;
