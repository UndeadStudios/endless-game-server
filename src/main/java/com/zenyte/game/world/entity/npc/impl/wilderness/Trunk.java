...
public class Trunk extends NPC {
    ...
    public static final class TrunkPlugin extends NPCPlugin {
        ...
        private enum TrunkLogs {
            LOGS(1, new Item(1512)), OAK_LOGS(15, new Item(1522)), WILLOW_LOGS(30, new Item(1520, 2)), MAPLE_LOGS(45, new Item(1518, 2)), YEW_LOGS(60, new Item(1516, 2)), MAGIC_LOGS(75, new Item(1514, 2));
            private static final TrunkLogs[] values = values();
            private final int level;
            private final Item logs;

            private TrunkLogs(final int level, final Item logs) {
                this.level = level;
                this.logs = logs;
            }
        }
        ...
        public void handle() {
            bind("Chop", (player, npc) -> player.getActionManager().setAction(new Action() {
                ...
                public boolean start() {
                    ...
                    final java.util.Optional<com.zenyte.game.content.skills.woodcutting.actions.Woodcutting.AxeResult> result = Woodcutting.getAxe(player);
                    if (!result.isPresent()) {
                    ...
                    for (final com.zenyte.game.world.entity.npc.impl.wilderness.Trunk.TrunkPlugin.TrunkLogs log : TrunkLogs.values) {
                        if (level >= log.level) {
                            logs.add(log);
                        }
                    }
                ...
                public int processWithDelay() {
                    ...
                    final com.zenyte.game.world.entity.npc.impl.wilderness.Trunk.TrunkPlugin.TrunkLogs log = Utils.getRandomCollectionElement(logs);
