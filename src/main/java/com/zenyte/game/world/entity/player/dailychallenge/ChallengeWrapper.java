...
public class ChallengeWrapper {
    ...
    static {
        for (final com.zenyte.game.world.entity.player.dailychallenge.challenge.SkillingChallenge challenge : SkillingChallenge.all) {
            challenges.put(challenge.name(), challenge);
        }
        for (final com.zenyte.game.world.entity.player.dailychallenge.challenge.CombatChallenge challenge : CombatChallenge.all) {
            challenges.put(challenge.name(), challenge);
        }
    }
