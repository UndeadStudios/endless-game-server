...
public class Dragonfire {
    ...
    public static abstract class DragonfireBuilder extends Dragonfire {
        ...
        public float getAccumulativeTier() {
            ...
            for (final com.zenyte.game.world.entity.npc.impl.slayer.dragons.DragonfireProtection protection : affectedProtections) {
    ...
    private void filter() {
        ...
        for (final com.zenyte.game.world.entity.npc.impl.slayer.dragons.DragonfireProtection protection : this.protection) {
