...
public class OgressShaman extends NPC implements CombatScript, Spawnable {
    ...
    public int attack(Entity target) {
        animate();
        final com.zenyte.game.world.entity.player.action.combat.magic.CombatSpell spell = CombatSpell.EARTH_BOLT;
        ...
        final com.zenyte.game.world.entity.HitEntry hitEntry = new HitEntry(this, delay, magic(target, combatDefinitions.getMaxHit()));
