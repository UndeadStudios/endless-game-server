...
public final class AnimationMask extends UpdateMask {
	...
	public void writePlayer(final RSBuffer buffer, final Player player, final Player processedPlayer) {
		final com.zenyte.game.world.entity.masks.Animation animation = Utils.getOrDefault(processedPlayer.getAnimation(), Animation.STOP);
	...
	public void writeNPC(final RSBuffer buffer, final Player player, final NPC npc) {
		final com.zenyte.game.world.entity.masks.Animation animation = Utils.getOrDefault(npc.getAnimation(), Animation.STOP);
		buffer.writeShort(animation.getId());
