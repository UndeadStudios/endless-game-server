...
public class LocationMap {
    ...
    public static void add(final Player player) {
        ...
        it.unimi.dsi.fastutil.objects.ObjectLinkedOpenHashSet<com.zenyte.game.world.entity.player.Player> set = tiles.get(bitpacked);
        if (set == null) {
            set = emptySets.poll();
    ...
    public static void iterate(final Player player, Predicate<ObjectLinkedOpenHashSet<Player>> consumer) {
        ...
        final it.unimi.dsi.fastutil.objects.ObjectLinkedOpenHashSet<com.zenyte.game.world.entity.player.Player> set = tiles.get(location.getPositionHash());
        if (set != null) {
    ...
    private static boolean process(final int x, final int y, final int plane, Predicate<ObjectLinkedOpenHashSet<Player>> consumer) {
        final it.unimi.dsi.fastutil.objects.ObjectLinkedOpenHashSet<com.zenyte.game.world.entity.player.Player> set = tiles.get(Location.getHash(x, y, plane));
        if (set != null) {
