...
public final class Chunk implements MapSquare {
	...
	public void clearFloorItems() {
		...
		for (final com.zenyte.game.world.flooritem.FloorItem floorItem : floorItems) {
	...
	public boolean equals(@org.jetbrains.annotations.Nullable final Object o) {
		...
		if (this$multiPolygons == null ? other$multiPolygons != null : !this$multiPolygons.equals(other$multiPolygons)) return false;
		return true;
	}
