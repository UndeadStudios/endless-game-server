...
public interface LootBroadcastPlugin {
    ...
    default void broadcast(@NotNull final String name, @NotNull final Item loot, @NotNull final Location location, final boolean guaranteedDrop, final boolean informSelf) {
        ...
        final com.zenyte.game.world.region.Area area = (Area) this;
        final int maximumDistance = maximumDistance();
        final java.lang.String message = Colour.RS_GREEN.wrap(Utils.formatString(name) + " received a drop: " + loot.getAmount() + " x " + loot.getName());
        final java.lang.String username = Utils.formatUsername(name);
        for (final com.zenyte.game.world.entity.player.Player player : area.getPlayers()) {
    ...
    static void fireEvent(@NotNull final String name, @NotNull final Item loot, @NotNull final Location location, boolean guaranteedDrop, boolean informSelf) {
        final com.zenyte.game.world.region.Area area = GlobalAreaManager.getArea(location);
