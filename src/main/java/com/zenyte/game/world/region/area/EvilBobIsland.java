...
public class EvilBobIsland extends Area implements DeathPlugin, TeleportPlugin, RandomEventRestrictionPlugin {
            ...
            bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
                ...
                public void buildDialogue() {
                    ...
                    npc("Look... over t-t-there! That fishing spot c-c-contains the f-f-f-fish he likes.").executeAction(() -> {
                        final com.zenyte.game.world.region.area.EvilBobIsland.FishSpot direction = getDirection(player);
        ...
        public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
            ...
            player.getActionManager().setAction(new Action() {
                ...
                public int processWithDelay() {
                    ...
                    final com.zenyte.game.item.Item fish = correctSpot ? new Item(6202) : new Item(6206);
    ...
    public static final class AntiqueLamp extends ItemPlugin {
        ...
        public void handle() {
            bind("Rub", (player, item, container, slotId) -> {
                final java.lang.Object[] args = new Object[] {750, 1, slotId, item};
    ...
    private enum FishSpot {
        ...
        private FishSpot(final Predicate<Player> predicate, final Location cameraPosition, final Location cameraLook) {
    ...
    private static final FishSpot getDirection(@NotNull final Player player) {
        ...
        final java.lang.Object attribute = player.getAttributes().get("evil bob fish direction");
        if (attribute == null) {
