...
public class Skeleton extends NPC implements Spawnable {
    ...
    public void onFinish(final Entity source) {
        if (delayUntilBurning == 0) {
            ...
            final com.zenyte.game.world.object.WorldObject existingObject = World.getObjectOfSlot(tile, 10);
            if (existingObject == null) {
                final com.zenyte.game.world.object.WorldObject bones = new WorldObject(3862, 10, 0, tile);
