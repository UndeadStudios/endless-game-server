...
public class KuraskProcessor extends DropProcessor {
    ...
    public void attach() {
        //Leaf-bladed sword
        appendDrop(new DisplayedDrop(11902, 1, 1, 384));
        //Mystic robe top (light)
        appendDrop(new DisplayedDrop(4111, 1, 1, 512));
        //Leaf-bladed battleaxe
        appendDrop(new DisplayedDrop(20727, 1, 1, 1026));
        //Kurask head
        appendDrop(new DisplayedDrop(7978, 1, 1, 3000));
    }
