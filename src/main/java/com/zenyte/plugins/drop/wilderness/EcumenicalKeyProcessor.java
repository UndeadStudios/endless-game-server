...
public class EcumenicalKeyProcessor extends DropProcessor {
    ...
    private int rate(final Player player) {
        final int maxCount = DiaryReward.WILDERNESS_SWORD3.eligibleFor(player) ? 5 : DiaryReward.WILDERNESS_SWORD2.eligibleFor(player) ? 4 : 3;
    ...
    public int[] ids() {
        ...
        final com.zenyte.game.world.region.RSPolygon polygon = WildernessGodwarsDungeon.polygon;
