...
public final class GemCuttingItemAction implements ItemOnItemAction {
	...
	public void handleItemOnItemAction(final Player player, final Item from, final Item to, final int fromSlot, final int toSlot) {
		final com.zenyte.game.content.skills.crafting.CraftingDefinitions.GemCuttingData gem = GemCuttingData.getDataByMaterial(from, to);
	...
	public int[] getItems() {
		...
		for (final com.zenyte.game.content.skills.crafting.CraftingDefinitions.GemCuttingData data : GemCuttingData.VALUES_ARR) {
