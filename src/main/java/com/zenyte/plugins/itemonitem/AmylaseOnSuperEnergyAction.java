...
public class AmylaseOnSuperEnergyAction implements ItemOnItemAction {
	...
	public void handleItemOnItemAction(final Player player, final Item from, final Item to, final int fromSlot, final int toSlot) {
		...
		final com.zenyte.game.item.Item amylase = from.getId() == ItemId.AMYLASE_CRYSTAL ? from : to;
		final com.zenyte.game.item.Item potion = from.getId() != ItemId.AMYLASE_CRYSTAL ? from : to;
		final java.lang.Integer dose = Integer.valueOf(potion.getName().substring(13, 14));
