    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        player.getActionManager().setAction(new Action() {
            ...
            public int processWithDelay() {
                ...
                final com.zenyte.game.item.Item item = random < ONYX_CHANCE ? new Item(ItemId.ONYX_BOLT_TIPS) : random < (ONYX_CHANCE + LAVA_SCALE_SHARD_CHANCE) ? new Item(ItemId.LAVA_SCALE_SHARD, Utils.random(1, 5)) : new Item(ItemId.TOKKUL, Utils.random(15, 30));
