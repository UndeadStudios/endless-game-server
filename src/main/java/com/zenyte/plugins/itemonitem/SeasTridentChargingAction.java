...
public final class SeasTridentChargingAction implements PairedItemOnItemPlugin {
    ...
    public void handleItemOnItemAction(final Player player, final Item from, final Item to, final int fromSlot, final int toSlot) {
        final com.zenyte.game.item.Item tridentItem = SeaTrident.allTridentsMap.keySet().contains(from.getId()) ? from : to;
        final com.zenyte.plugins.item.trident.SeaTrident tridentDef = SeaTrident.allTridentsMap.get(tridentItem.getId());
