...
public final class LeatherShieldCraftingItemAction implements ItemOnItemAction {
	...
	public void handleItemOnItemAction(final Player player, final Item from, final Item to, final int fromSlot, final int toSlot) {
		if (LeatherShieldData.isMaterial(from, to)) {
			final com.zenyte.game.content.skills.crafting.CraftingDefinitions.LeatherShieldData data = LeatherShieldData.getDataByMaterials(from, to);
			if (data != null) {
	...
	public int[] getItems() {
		...
		for (final com.zenyte.game.content.skills.crafting.CraftingDefinitions.LeatherShieldData data : LeatherShieldData.VALUES) {
