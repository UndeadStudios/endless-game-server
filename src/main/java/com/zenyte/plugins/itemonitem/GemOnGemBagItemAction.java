...
public class GemOnGemBagItemAction implements ItemOnItemAction {
    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        ...
        final com.zenyte.game.item.containers.GemBag bag = player.getGemBag();
        final com.zenyte.game.item.Item gem = from.getId() != GEM_BAG_ID ? from : to;
        ...
        final java.lang.String name = GemBag.GEMS.get(gem.getId()).toLowerCase();
        if (size == 300) {
