...
public class AmuletStringingItemAction implements ItemOnItemAction {
	...
	public void handleItemOnItemAction(final Player player, final Item from, final Item to, final int fromSlot, final int toSlot) {
		final com.zenyte.game.item.Item string = from.getId() == 1759 || from.getId() == 6038 ? from : to;
	...
	public ItemPair[] getMatchingPairs() {
		...
		for (final com.zenyte.game.content.skills.crafting.CraftingDefinitions.AmuletStringingData stringing : AmuletStringingData.VALUES_ARR) {
