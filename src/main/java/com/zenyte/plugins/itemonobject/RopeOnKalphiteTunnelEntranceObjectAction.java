...
public class RopeOnKalphiteTunnelEntranceObjectAction implements ItemOnObjectAction {
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		final com.zenyte.game.world.entity.player.Setting setting = object.getId() == 3827 ? Setting.KALPHITE_LAIR_TUNNEL_ENTRANCE : Setting.KALPHITE_QUEEN_TUNNEL_ENTRANCE;
		final com.zenyte.game.world.entity.Location location = setting.equals(Setting.KALPHITE_LAIR_TUNNEL_ENTRANCE) ? INSIDE_LAIR_LOCATION : INSIDE_BOSS_LOCATION;
