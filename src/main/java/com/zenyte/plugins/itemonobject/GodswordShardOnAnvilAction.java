...
public class GodswordShardOnAnvilAction implements ItemOnObjectAction {
	...
	public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
		final com.zenyte.game.content.skills.smithing.GodswordShardCombination combination = GodswordShardCombination.getCombination(player.getInventory().getContainer().getItems().values());
		if (combination != null) {
