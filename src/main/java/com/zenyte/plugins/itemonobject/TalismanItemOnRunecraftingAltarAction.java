...
public final class TalismanItemOnRunecraftingAltarAction implements ItemOnObjectAction {
	...
	public void handleItemOnObjectAction(final Player player, final Item item, int slot, final WorldObject object) {
		final com.zenyte.game.content.skills.runecrafting.Runecrafting rune = Runecrafting.getRuneByAltarObject(object.getId());
		if (rune == null) {
			return;
		}
		if (player.getInventory().containsItem(5525, 1)) {
			final com.zenyte.game.content.skills.runecrafting.Tiara tiara = Tiara.getTiara(player, item, object.getId());
			if (tiara != null) {
	...
	public Object[] getItems() {
		final java.util.HashSet<java.lang.Object> list = new HashSet<Object>();
