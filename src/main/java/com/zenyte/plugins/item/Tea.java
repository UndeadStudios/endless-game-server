...
public class Tea extends ItemPlugin {
    ...
    @Override
    public int[] getItems() {
        final it.unimi.dsi.fastutil.ints.IntArrayList itemIds = new IntArrayList();
        for (final com.zenyte.plugins.itemonitem.GuthixRestTeaMixing.PartialTea tea : GuthixRestTeaMixing.PartialTea.values()) {
