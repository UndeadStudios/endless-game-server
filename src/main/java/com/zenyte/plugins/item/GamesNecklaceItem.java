...
public class GamesNecklaceItem extends ItemPlugin {
    ...
    private enum GamesNecklace {
        ...
        static {
            for (final com.zenyte.plugins.item.GamesNecklaceItem.GamesNecklace value : values()) {
        ...
        private GamesNecklace(final Item item, final Item result, final int charges) {
            this.item = item;
            this.result = result;
    ...
    private static final class NecklaceTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            final com.zenyte.plugins.item.GamesNecklaceItem.GamesNecklace necklace = GamesNecklace.get(item);
            final int charges = necklace.getCharges();
            final java.lang.String message = charges == 1 ? "<col=7F00FF>Your games necklace crumbles to dust.</col>" : charges == 2 ? "<col=7F00FF>Your games necklace has one charge left..</col>" : "<col=7F00FF>Your games necklace has " + Utils.format(charges - 1) + " charges left.</col>";
