...
public enum SeaTrident implements Trident {
    SEA_TRIDENT(ItemId.UNCHARGED_TRIDENT, ItemId.TRIDENT_OF_THE_SEAS, 2500), SEA_TRIDENT_FULL(ItemId.UNCHARGED_TRIDENT, ItemId.TRIDENT_OF_THE_SEAS_FULL, 0), SEA_TRIDENT_ENHANCED(ItemId.UNCHARGED_TRIDENT_E, ItemId.TRIDENT_OF_THE_SEAS_E, 20000);
    ...
    private static final Item[] chargingRunes = new Item[] {new Item(ItemId.DEATH_RUNE), new Item(ItemId.CHAOS_RUNE), new Item(ItemId.FIRE_RUNE, 5)};
    public static final Item[] chargingMaterials = new Item[] {new Item(ItemId.DEATH_RUNE), new Item(ItemId.CHAOS_RUNE), new Item(ItemId.FIRE_RUNE, 5), new Item(ItemId.COINS_995, 10)};
    ...
    private SeaTrident(final int unchargedId, final int chargedId, final int maxCharges) {
