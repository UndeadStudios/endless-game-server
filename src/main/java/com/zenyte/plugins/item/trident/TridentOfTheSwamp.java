...
public class TridentOfTheSwamp extends ItemPlugin {
    ...
    private void dismantle(final Player player, final Item item, final int slotId) {
        final com.zenyte.plugins.item.trident.SwampTrident tridentDef = SwampTrident.unchargedMap.get(item.getId());
    ...
    private void uncharge(final Player player, final Item item, final int slotId) {
        final com.zenyte.plugins.item.trident.SwampTrident tridentDef = SwampTrident.chargedMap.get(item.getId());
