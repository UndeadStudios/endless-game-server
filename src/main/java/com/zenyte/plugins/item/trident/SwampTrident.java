...
public enum SwampTrident implements Trident {
    SWAMP_TRIDENT(ItemId.UNCHARGED_TRIDENT, ItemId.UNCHARGED_TOXIC_TRIDENT, ItemId.TRIDENT_OF_THE_SWAMP, 2500), SWAMP_TRIDENT_E(ItemId.UNCHARGED_TRIDENT_E, ItemId.UNCHARGED_TOXIC_TRIDENT_E, ItemId.TRIDENT_OF_THE_SWAMP_E, 20000);
    ...
    public static final Item[] chargingMaterials = new Item[] {new Item(ItemId.DEATH_RUNE), new Item(ItemId.CHAOS_RUNE), new Item(ItemId.FIRE_RUNE, 5), new Item(ItemId.ZULRAHS_SCALES)};
    ...
    private SwampTrident(final int baseId, final int unchargedId, final int chargedId, final int maxCharges) {
        this.baseId = baseId;
