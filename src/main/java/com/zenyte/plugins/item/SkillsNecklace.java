...
public class SkillsNecklace extends ItemPlugin {
    ...
    private enum SkillsNecklaceItem {
        ...
        static {
            for (final com.zenyte.plugins.item.SkillsNecklace.SkillsNecklaceItem value : values()) {
        ...
        private SkillsNecklaceItem(final Item item, final Item result, final int charges) {
            this.item = item;
            this.result = result;
    ...
    private static final class NecklaceTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            final com.zenyte.plugins.item.SkillsNecklace.SkillsNecklaceItem necklace = SkillsNecklaceItem.get(item);
            final int charges = necklace.getCharges();
            final java.lang.String message = charges == 1 ? "<col=7F00FF>You use your skills necklace\'s last charge.</col>" : charges == 2 ? "<col=7F00FF>Your skills necklace has one charge left.</col>" : "<col=7F00FF>Your skills necklace has " + Utils.format(charges - 1) + " charges left.</col>";
