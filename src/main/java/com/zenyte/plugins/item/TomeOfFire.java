...
public class TomeOfFire extends ItemPlugin implements PairedItemOnItemPlugin {
    ...
    private static final void addPages(final Player player, final Item item, final int slotId, final Container container) {
    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        final com.zenyte.game.item.Item burntPages = from.getId() == BURNT_PAGE ? from : to;
        final com.zenyte.game.item.Item book = burntPages == from ? to : from;
