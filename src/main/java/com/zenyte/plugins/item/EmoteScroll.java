...
public class EmoteScroll extends ItemPlugin {
    ...
    public void handle() {
        bind("Read", (player, item, inventorySlot) -> {
            final java.util.ArrayList<com.zenyte.game.world.entity.player.Emote> options = new ArrayList<Emote>();
            for (final com.zenyte.game.world.entity.player.Emote unlockableEmote : unlockableEmotes) {
            ...
            final java.util.ArrayList<java.lang.String> optionNameList = new ArrayList<String>(options.size());
            for (final com.zenyte.game.world.entity.player.Emote option : options) {
