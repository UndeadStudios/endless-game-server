...
public class SherlocksNotes extends ItemPlugin implements PairedItemOnItemPlugin {
    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        final com.zenyte.game.item.Item paper = from.getId() == SHERLOCKS_NOTES ? from : to;
        final com.zenyte.game.item.Item clue = paper == from ? to : from;
        final java.util.List<java.lang.String> list = TreasureTrail.getCluesList(clue);
        if (list == null) {
