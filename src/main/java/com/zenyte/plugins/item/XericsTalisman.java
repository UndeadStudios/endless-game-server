...
public class XericsTalisman extends ItemPlugin implements PairedItemOnItemPlugin {
    ...
    public void handle() {
        ...
        bind("Uncharge", (player, item, container, slotId) -> {
            ...
            final com.zenyte.game.item.Item talisman = new Item(13392, 1);
            final com.zenyte.game.item.Item fangs = new Item(13391, item.getCharges());
    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        if (from.getId() == 21046 || to.getId() == 21046) {
            final com.zenyte.game.item.Item tablet = from.getId() == 21046 ? from : to;
            final com.zenyte.game.item.Item amulet = from == tablet ? to : from;
            if (player.getAttributes().containsKey("xeric\'s honour")) {
        ...
        final com.zenyte.game.item.Item amulet = (from.getId() == 13392 || from.getId() == 13393) ? from : to;
        final com.zenyte.game.item.Item fangs = amulet == from ? to : from;
