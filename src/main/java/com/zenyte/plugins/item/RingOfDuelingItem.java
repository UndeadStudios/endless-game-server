...
public class RingOfDuelingItem extends ItemPlugin {
    ...
    private enum RingOfDueling {
        ...
        static {
            for (final com.zenyte.plugins.item.RingOfDuelingItem.RingOfDueling value : values()) {
        ...
        private RingOfDueling(final Item item, final Item result, final int charges) {
            this.item = item;
            this.result = result;
    ...
    private static final class RingTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            final com.zenyte.plugins.item.RingOfDuelingItem.RingOfDueling ring = RingOfDueling.get(item);
            final int charges = ring.getCharges();
            final java.lang.String message = charges == 1 ? "<col=7F00FF>Your ring of dueling crumbles to dust.</col>" : charges == 2 ? "<col=7F00FF>Your ring of dueling has one charge left..</col>" : "<col=7F00FF>Your ring of dueling has " + Utils.format(charges - 1) + " charges left.</col>";
