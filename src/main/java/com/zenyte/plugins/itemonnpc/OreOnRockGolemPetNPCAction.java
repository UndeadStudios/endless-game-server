...
public class OreOnRockGolemPetNPCAction implements ItemOnNPCAction {
    ...
    public void handleItemOnNPCAction(Player player, Item item, int slot, NPC npc) {
        final com.zenyte.plugins.itemonnpc.OreOnRockGolemPetNPCAction.RockGolemCombination combination = RockGolemCombination.get(item.getId());
        if (combination == null) {
            return;
        }
        ...
        final com.zenyte.game.content.follower.Pet currentPet = player.getFollower().getPet();
    ...
    private enum RockGolemCombination {
        ...
        static {
            for (final com.zenyte.plugins.itemonnpc.OreOnRockGolemPetNPCAction.RockGolemCombination combination : ALL) {
