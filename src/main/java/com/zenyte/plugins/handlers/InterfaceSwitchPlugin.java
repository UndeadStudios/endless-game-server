 ...
 */
public interface InterfaceSwitchPlugin {

	public void switchItem(final Player player, final int fromInterface, final int toInterface, final int fromComponent,
