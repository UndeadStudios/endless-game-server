...
public enum MakeType {
    MAKE(0, 1), MAKE_SETS(2, 3), BUY(4), BUY_SETS(5), COOK(6, 8), FIRE(9), STRING(10), CHARGE(11), CUT(12), SMELT(13), USE(14), UPGRADE(15), SPIN(16), TAKE(17), REQUEST(18), ENCHANT(19);
