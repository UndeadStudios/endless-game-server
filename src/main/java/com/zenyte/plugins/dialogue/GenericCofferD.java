...
public class GenericCofferD extends Dialogue {
    ...
    private void handleWithdraw() {
        ...
        final java.lang.String amount = player.getNumericAttribute(attribute).intValue() > goldTilFull ? TextUtils.formatCurrency(goldTilFull) : TextUtils.formatCurrency(player.getNumericAttribute(attribute).intValue());
        player.sendInputInt("How much do you want to withdraw? (" + amount + ")", withdrawAmt -> {
            ...
            if (player.getNumericAttribute(attribute).intValue() >= withdrawAmt) {
                ...
                final com.zenyte.game.item.Item goldItem = cofferNew < 10000 ? (cofferNew < 1000 ? CASH_SMALL : CASH_MED) : CASH_BIG;
    ...
    private void handleDeposit() {
        ...
        final java.lang.String amount = player.getInventory().getAmountOf(995) > goldTilFull ? TextUtils.formatCurrency(goldTilFull) : TextUtils.formatCurrency(player.getInventory().getAmountOf(995));
