...
public class EstateAgentD extends Dialogue {
	...
	public void buildDialogue() {
		...
		} else if (player.getSkills().getLevel(Skills.CONSTRUCTION) < House.RIMMINGTON.getLevel()) {
		...
		if (player.getConstruction().getHouse().equals(House.TAVERLY)) {
			npc("Your house is already there!");
		} else if (player.getSkills().getLevel(Skills.CONSTRUCTION) < House.TAVERLY.getLevel()) {
		...
		if (player.getConstruction().getHouse().equals(House.POLLNIVNEACH)) {
			npc("Your house is already there!");
		} else if (player.getSkills().getLevel(Skills.CONSTRUCTION) < House.POLLNIVNEACH.getLevel()) {
		...
		if (player.getConstruction().getHouse().equals(House.KOUREND)) {
			npc("Your house is already there!");
		} else if (player.getSkills().getLevel(Skills.CONSTRUCTION) < House.KOUREND.getLevel()) {
		...
		if (player.getConstruction().getHouse().equals(House.RELLEKKA)) {
			npc("Your house is already there!");
		} else if (player.getSkills().getLevel(Skills.CONSTRUCTION) < House.RELLEKKA.getLevel()) {
		...
		if (player.getConstruction().getHouse().equals(House.BRIMHAVEN)) {
			npc("Your house is already there!");
		} else if (player.getSkills().getLevel(Skills.CONSTRUCTION) < House.BRIMHAVEN.getLevel()) {
		...
		if (player.getConstruction().getHouse().equals(House.YANILLE)) {
			npc("Your house is already there!");
		} else if (player.getSkills().getLevel(Skills.CONSTRUCTION) < House.YANILLE.getLevel()) {
