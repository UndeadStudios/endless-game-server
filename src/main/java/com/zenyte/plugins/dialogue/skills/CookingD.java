...
public class CookingD extends SkillDialogue {
    ...
    public void run(final int slotId, final int amount) {
        ...
        final com.zenyte.game.content.skills.cooking.CookingDefinitions.CookingData cookable = cookableList == null ? CookingData.getDataByProduct(items[slotId]) : cookableList.get(slotId);
        if (cookable != null) {
