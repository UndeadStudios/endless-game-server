...
public class LevelUpDialogue extends Dialogue {
	...
	public static final void sendSkillDialogue(final Player player, final int skill) {
		final java.lang.Object dialogue = player.getTemporaryAttributes().get("skillDialogue");
		final com.zenyte.plugins.dialogue.LevelUpDialogue skillDialogue = dialogue == null ? null : (LevelUpDialogue) dialogue;
