...
public class CastlewarsBandageOnPlayerPlugin implements ItemOnPlayerPlugin {
    ...
    public void handleItemOnPlayerAction(final Player player, final Item item, final int slot, final Player target) {
        ...
        final com.zenyte.game.content.minigame.castlewars.CastleWarsTeam playerTeam = CastleWars.getTeam(player);
        final com.zenyte.game.content.minigame.castlewars.CastleWarsTeam targetTeam = CastleWars.getTeam(player);
