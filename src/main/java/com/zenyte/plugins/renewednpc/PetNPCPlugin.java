...
public class PetNPCPlugin extends NPCPlugin {
    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> {
            final com.zenyte.game.content.follower.Pet pet = PetWrapper.getByPet(npc.getId());
            final java.lang.Class<? extends com.zenyte.game.world.entity.player.dialogue.Dialogue> dialogue = pet.dialogue();
