    ...
    public void handle() {
        bind("Talk-to", new OptionHandler() {
            ...
            public void handle(Player player, NPC npc) {
                ...
                final com.zenyte.game.content.AccomplishmentCape untrimmedCape = AccomplishmentCape.getBySkill(untrimmed);
                player.getDialogueManager().start(new Dialogue(player, npc) {
                    ...
                    public void buildDialogue() {
                        ...
                        npc(22, "So <col=00080>" + untrimmedCape + " skillcape</col>, that will be " + Utils.format(UNTRIMMED_CAPE_COST.getAmount()) + " coins.");
                        options("Buy the <col=00080>" + untrimmedCape + " skillcape</col> for " + Utils.format(UNTRIMMED_CAPE_COST.getAmount()) + " coins?", "Yes.", "Nevermind").onOptionOne(() -> {
