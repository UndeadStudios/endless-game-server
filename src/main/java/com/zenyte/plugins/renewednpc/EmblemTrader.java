...
public class EmblemTrader extends NPCPlugin implements ItemOnNPCAction {
    ...
    private static final void sell(final Player player, final Item item, final NPC npc) {
        ...
        for (final com.zenyte.plugins.renewednpc.EmblemTrader.AncientArtefact artefact : AncientArtefact.values) {
    ...
    private enum AncientArtefact {
        EMBLEM(21807, 500000), TOTEM(21810, 1000000), STATUETTE(21813, 2000000), MEDALLION(22299, 4000000), EFFIGY(22302, 8000000), RELIC(22305, 16000000);
        private static final AncientArtefact[] values = values();
        private final int id;
        private final int coins;

        private AncientArtefact(final int id, final int coins) {
            this.id = id;
            this.coins = coins;
        }
    }
