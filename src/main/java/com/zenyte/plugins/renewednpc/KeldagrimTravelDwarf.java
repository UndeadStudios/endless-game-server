...
public class KeldagrimTravelDwarf extends NPCPlugin {
    ...
    public void handle() {
        bind("Travel", (player, npc) -> {
            final com.zenyte.game.world.entity.Location destination = npc.getId() == 4896 ? PAST_RIVER_KELDA : npc.getId() == 2432 ? KELDAGRIM : npc.getId() == 2433 ? BEYOND_RIVER_KELDA : SOUTH_EAST_DOCKS;
