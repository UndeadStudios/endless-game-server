                ...
                if (player.carryingAny(PlunderReward.getItemIds())) {
                    ...
                    player(5, "Yes, show me the money.").executeAction(() -> {
                        for (int itemId : PlunderReward.getItemIds()) {
                            final com.zenyte.game.content.pyramidplunder.PlunderReward artefact = PlunderReward.getByItem(itemId);
                    ...
                    final com.zenyte.game.item.Item agilityArtefact = new Item(ItemId.PYRAMID_TOP, player.getInventory().getAmountOf(ItemId.PYRAMID_TOP));
                    ...
                    final java.lang.String amountString = agilityArtefact.getAmount() == 1 ? "one" : "some";
                    final java.lang.String itemPronoun = (agilityArtefact.getAmount() == 1 ? "it" : "them");
