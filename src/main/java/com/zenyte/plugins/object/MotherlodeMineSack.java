...
public class MotherlodeMineSack implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        if (option.equals("Search")) {
            ...
            final it.unimi.dsi.fastutil.ints.IntArrayList removed = new IntArrayList();
            ...
            final it.unimi.dsi.fastutil.ints.IntArrayList dirt = player.getPaydirt();
            for (final java.lang.Integer taken : removed) {
                dirt.rem(taken);
            }
