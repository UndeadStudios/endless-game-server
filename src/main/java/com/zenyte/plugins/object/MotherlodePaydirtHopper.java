...
public class MotherlodePaydirtHopper implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        final org.apache.commons.lang3.mutable.MutableInt conveyorAmount = new MutableInt();
        CharacterLoop.forEach(object, 15, NPC.class, npc -> {
            if (npc instanceof PaydirtNPC) {
                final com.zenyte.game.world.entity.player.Player target = ((PaydirtNPC) npc).getPlayer();
