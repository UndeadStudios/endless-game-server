...
public class MotherlodeUpperLadder implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        } else player.getDialogueManager().start(new NPCChat(player, 6562, "Ye wants to go up there, eh? Well, ye\'ll need at least 72 Mining first. An\' don\'t think you can fool me with yer potions and fancy stat-boosts. Get yer level up for real. Ye also need to buy upstairs access from me."));
    }
