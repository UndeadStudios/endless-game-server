...
public class CorporealBeastPrivatePortalOA implements ObjectAction {
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(CorporealBeastPrivatePortalOA.class);
	...
	public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
		if (option.equals("Enter")) {
			...
			final com.zenyte.game.content.boss.corporealbeast.CorporealBeastDynamicArea area = CorporealBeastDynamicArea.getArea(player);
			if (area == null) {
	...
	private static final class InstanceStartDialogue extends Dialogue {
		...
		public void buildDialogue() {
			options("Start private a clan instance for 200,000 gp?", "Yes, start the instance.", "No.").onOptionOne(() -> {
				...
				try {
					final com.zenyte.game.world.region.dynamicregion.AllocatedArea allocatedArea = MapBuilder.findEmptyChunk(6, 7);
