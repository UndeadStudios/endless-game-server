...
public final class CorporealBeastPassageOA implements ObjectAction {
	...
	public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
		if (option.equals("Go-through")) {
			...
			final java.util.Optional<com.zenyte.game.world.entity.npc.NPC> corp = World.findNPC(319, player.getLocation(), 25);
			if (corp.isPresent()) {
				final com.zenyte.game.world.entity.npc.NPC c = corp.get();
