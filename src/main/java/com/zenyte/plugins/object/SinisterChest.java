...
public class SinisterChest implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        WorldTasksManager.schedule(() -> {
            ...
            if (player.getVariables().getTime(TickVariable.POISON_IMMUNITY) > 0 || Utils.findMatching(inventory.getContainer().getItems().values(), value -> value != null && protectiveAntipoisons.contains(value.getId())) != null) {
            ...
            for (final com.zenyte.game.item.Item item : loot) {
