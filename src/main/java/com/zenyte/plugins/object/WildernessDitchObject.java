...
public final class WildernessDitchObject implements ObjectAction {
	...
	public static final void jump(@NotNull final Player player, @NotNull final WorldObject object) {
		...
		final com.zenyte.game.util.Direction direction = ((object.getRotation() & 1) != 0) ? (player.getX() > object.getX()) ? Direction.WEST : Direction.EAST : (player.getY() > object.getY()) ? Direction.SOUTH : Direction.NORTH;
		player.lock(2);
