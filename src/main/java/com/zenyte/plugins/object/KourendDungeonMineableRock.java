...
public class KourendDungeonMineableRock implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        if (option.equals("Mine")) {
            final java.util.Optional<com.zenyte.game.content.skills.mining.MiningDefinitions.PickaxeDefinitions.PickaxeResult> axe = MiningDefinitions.PickaxeDefinitions.get(player, true);
            if (!axe.isPresent()) {
