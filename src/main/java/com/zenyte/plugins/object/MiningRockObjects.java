...
public final class MiningRockObjects implements ObjectAction {
	...
	public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
		if (option.equalsIgnoreCase("Prospect")) {
			...
			player.getActionManager().setAction(new Mining(object));
		} else if (object.getId() == 7468 || object.getId() == 7469 || object.getId() == 30373 || object.getId() == 33253) player.sendMessage("There is currently no ore available in this rock.");
	}
	...
	public Object[] getObjects() {
		final it.unimi.dsi.fastutil.ints.IntArrayList list = new IntArrayList(MiningDefinitions.ores.keySet());
		list.add(7468);
		list.add(7469);
		list.add(30373);
		list.add(33253);
