    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        if (player.getLocation().matches(mainland) || player.getLocation().matches(mainlandInside)) {
            ...
            WorldTasksManager.schedule(() -> {
                final com.zenyte.game.world.entity.Location tile = outside ? offlandInside : offland;
            ...
            WorldTasksManager.schedule(() -> {
                final com.zenyte.game.world.entity.Location tile = outside ? mainlandInside : mainland;
                player.addWalkSteps(tile.getX(), tile.getY(), 1, false);
            });
        }
    }
