...
public class TrapdoorObject implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        final com.zenyte.game.world.object.Trapdoor trapdoor = Trapdoor.trapdoors.get(object.getPositionHash());
    ...
    public Object[] getObjects() {
        ...
        for (final com.zenyte.game.world.object.Trapdoor door : Trapdoor.values) {
