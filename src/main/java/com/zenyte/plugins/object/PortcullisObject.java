...
public class PortcullisObject implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        final com.zenyte.game.content.boss.cerberus.CerberusRoom position = object.getX() == 1239 ? CerberusRoom.WEST : object.getX() == 1367 ? CerberusRoom.EAST : CerberusRoom.NORTH;
