    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        if (object.getId() == 9100) {
            ...
            for (final BlastFurnaceOre ore : BlastFurnaceOre.VALUES) {
                ...
                if (player.getInventory().containsItem(ore.getItemId(), 1)) {
                    final com.zenyte.game.content.skills.smithing.SmeltableBar bar = SmeltableBar.getDataByBar(ore.getBarId());
                    ...
                    final com.zenyte.game.item.Item ores = new Item(ore.getItemId(), amount);
        ...
        if (object.getId() == 9092) {
            ...
            if (object.getId(player) == 9096) {
                ...
                ArrayUtils.reverse(barsArray);
                if (barsArray.length != 0) {
                    if (player.getInventory().hasFreeSlots()) player.getDialogueManager().start(new BlastFurnaceBarD(player, barsArray));
