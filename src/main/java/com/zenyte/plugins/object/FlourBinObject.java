...
public class FlourBinObject implements ObjectAction {
	...
	public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
		if(name.toLowerCase().equals("flour bin")) {
		...
		if(name.toLowerCase().equals("hopper controls") || object.getId() == 22424) {
			if(option.toLowerCase().equals("operate") || option.toLowerCase().equals("pull")) {
