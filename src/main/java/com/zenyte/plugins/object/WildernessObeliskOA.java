...
public final class WildernessObeliskOA implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        if (option.equals("Teleport to Destination")) {
            ...
            final java.lang.Object obj = player.getTemporaryAttributes().get("ObeliskDestinationIndex");
            ...
            final java.util.ArrayList<com.zenyte.game.world.entity.Location> list = new ArrayList<Location>(Arrays.asList(CENTER_OBELISK_TILES));
            Collections.shuffle(list);
            for (final com.zenyte.game.world.entity.Location tile : list) {
        ...
        final com.zenyte.game.world.entity.Location tile = dest;
        ...
        WorldTasksManager.schedule(new WorldTask() {
            ...
            public void run() {
                ...
                case 1: 
                    {
                        final com.zenyte.game.world.entity.Location center = CENTER_OBELISK_TILES[index];
