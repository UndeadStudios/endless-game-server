...
public abstract class WorldMapNode {
    ...
    private void decodeLarge(int x, int y, final ByteBuffer areaBuffer) {
        ...
        if (containsObjects) {
            for (int z = 0; z < highestPlaneWithObjects; ++z) {
                ...
                if (length != 0) {
                    final mgi.types.worldmap.WorldMapGameObject[] array = this.objects[z][x][y] = new WorldMapGameObject[length];
    ...
    private void encodeLarge(final int x, final int y, final ByteBuffer areaBuffer) {
        ...
        if (containsObjects) {
            for (int z = 0; z < objectTileHeight; ++z) {
                ...
                if (length != 0) {
                    for (int index = 0; index < length; index++) {
                        final mgi.types.worldmap.WorldMapGameObject object = objects[z][x][y][index];
    ...
    public String toString() {
        return "WorldMapNode(minPlane=" + this.minPlane + ", maxPlane=" + this.maxPlane + ", centerRegionX=" + this.centerRegionX + ", centerRegionY=" + this.centerRegionY + ", regionX=" + this.regionX + ", regionY=" + this.regionY + ", underlays=" + java.util.Arrays.deepToString(this.underlays) + ", overlays=" + java.util.Arrays.deepToString(this.overlays) + ", overlayShapes=" + java.util.Arrays.deepToString(this.overlayShapes) + ", overlayRotations=" + java.util.Arrays.deepToString(this.overlayRotations) + ", objects=" + java.util.Arrays.deepToString(this.objects) + ", flags=" + java.util.Arrays.deepToString(this.flags) + ", overlayTileHeights=" + java.util.Arrays.deepToString(this.overlayTileHeights) + ", offsetChunksX=" + this.offsetChunksX + ", offsetChunksY=" + this.offsetChunksY + ", hue=" + java.util.Arrays.deepToString(this.hue) + ", saturation=" + java.util.Arrays.deepToString(this.saturation) + ", lightness=" + java.util.Arrays.deepToString(this.lightness) + ", count=" + java.util.Arrays.deepToString(this.count) + ")";
    }
}
