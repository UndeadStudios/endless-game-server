...
public class ExperienceModeSelection extends ComponentDefinitions {
    public ArrayList<ComponentDefinitions> assemble() {
        ...
        mgi.types.component.ComponentDefinitions component = new ComponentDefinitions(); //1
        ...
        add(componentId++, component);
        final java.lang.String[] xpModes = new String[] {"50x Combat<br>25x Skilling", "10x Combat<br>10x Skilling", "5x Combat<br>5x Skilling"};
        final java.lang.String[] ops = new String[] {"50x Combat & 25x Skilling", "10x Combat & 10x Skilling", "5x Combat & 5x Skilling"};
        ...
        component = new TextComponent("If you choose choose the 5x or 10x combat & skilling mode, you can always talk to the " + GameConstants.SERVER_NAME + " guide in Edgeville to change it to the easier 50x combat & 25x skilling one.", "ffffff", 494, CENTER, CENTER);
        ...
        add(componentId++, component);
        final java.util.ArrayList<mgi.types.component.ComponentDefinitions> list = new ArrayList<ComponentDefinitions>();
        list.add(this);
        for (final mgi.types.component.ComponentDefinitions c : getChildren()) {
            if (c == null) {
                continue;
            }
            list.add(c);
