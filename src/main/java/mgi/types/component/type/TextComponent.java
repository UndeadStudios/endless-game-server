 ...
 */
public class TextComponent extends ComponentDefinitions {

	public static final int LEFT = 0, CENTER = 1, RIGHT = 2;
	public static final int FONT_SMALL = 494, FONT_REGULAR = 495, FONT_BOLD = 496, FONT_LARGE_STYLE = 497;

	public TextComponent(final String text, final String color, final int font, final int verticalAlignment, final int horizontalAlignment) {
		super();
		this.type = 4;
		this.isIf3 = true;
	...
	public TextComponent(final String text, final int font, final int verticalAlignment, final int horizontalAlignment) {
