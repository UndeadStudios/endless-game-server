...
public final class IntEnum extends AbstractEnum<Integer> {
    ...
    public ByteBuffer encode() {
        ...
        if (intMap != null) {
            ...
            for (final it.unimi.dsi.fastutil.ints.Int2IntMap.Entry entry : intMap.int2IntEntrySet()) {
    ...
    public void forEach(final Consumer<Int2IntMap.Entry> consumer) {
        for (final it.unimi.dsi.fastutil.ints.Int2IntMap.Entry entry : getValues().int2IntEntrySet()) {
