...
public final class StringEnum extends AbstractEnum<String> {
    ...
    public ByteBuffer encode() {
        final mgi.utilities.ByteBuffer buffer = new ByteBuffer(encodedSize());
        buffer.writeByte(1);
        ...
        if (stringMap != null) {
            ...
            for (final it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<java.lang.String> entry : stringMap.int2ObjectEntrySet()) {
    ...
    boolean populate(final Map<Integer, ?> map, final Map<Integer, String> populatedMap, final Map<String, Integer> reversePopulatedMap) {
        ...
        for (final java.util.Map.Entry<java.lang.Integer, ?> entry : map.entrySet()) {
            key = entry.getKey();
    ...
    public OptionalInt getKeyIgnoreCase(final String value) {
        for (final it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<java.lang.String> entry : getValues().int2ObjectEntrySet()) {
