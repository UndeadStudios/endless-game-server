...
public class ByteBuffer {
    ...
    private byte[] buffer;
    private static char[] unicodeTable = {'€', '\000', '‚', 'ƒ', '„', '…', '†', '‡', 'ˆ', '‰', 'Š', '‹', 'Œ', '\000', 'Ž', '\000', '\000', '‘', '’', '“', '”', '•', '–', '—', '˜', '™', 'š', '›', 'œ', '\000', 'ž', 'Ÿ'};
    ...
    public final long readDynamic(int numBytes) throws IllegalArgumentException {
        ...
        long value = 0L;
        for (int bitsLeft = numBytes * 8; bitsLeft >= 0; bitsLeft -= 8) value |= ((long) this.buffer[this.position++] & 255L) << bitsLeft;
        return value;
    }

    public final void writeDynamic(int numBytes, long value) {
        if (--numBytes < 0 || numBytes > 7) throw new IllegalArgumentException();
        for (int bitsLeft = numBytes * 8; bitsLeft >= 0; bitsLeft -= 8) this.buffer[this.position++] = (byte) (int) (value >> bitsLeft);
    }
    ...
    public Int2ObjectOpenHashMap<Object> readParameters() {
        ...
        final it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap<java.lang.Object> parameters = new Int2ObjectOpenHashMap<Object>(length);
    ...
    public void writeParameters(final Int2ObjectOpenHashMap<Object> parameters) {
        ...
        for (final it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<java.lang.Object> parameter : parameters.int2ObjectEntrySet()) {
            final int key = parameter.getIntKey();
            final java.lang.Object value = parameter.getValue();
