...
public class ThanksgivingPacker {
    ...
    private static void packStartAnimation() {
        ...
        final mgi.types.config.AnimationDefinitions def = AnimationDefinitions.get(828);
        def.setId(11008);
    ...
    private static final void packGraphics() {
        final mgi.types.config.GraphicsDefinitions gfxDef = GraphicsDefinitions.get(678);
