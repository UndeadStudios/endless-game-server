...
public class ChristmasMapPacker {
    ...
    public void packFull() throws IOException {
        ...
        packItems();
        packMusic();
        final java.util.Collection<com.zenyte.game.world.object.WorldObject> objs = MapUtils.decode(new ByteBuffer(Files.readAllBytes(Paths.get("assets/christmas/objects.dat"))));
        objs.forEach(o -> {
            set.add(o.getId());
            o.setId(transformedObjects.getOrDefault(o.getId(), o.getId()));
        });
        final java.util.Collection<com.zenyte.game.world.object.WorldObject> scourgeObjs = MapUtils.decode(new ByteBuffer(Files.readAllBytes(Paths.get("assets/christmas/scourge objects.dat"))));
    ...
    private static final void bellsSwayAnimation() {
        ...
        final mgi.types.config.AnimationDefinitions def = AnimationDefinitions.get(4131);
        def.setId(11012);
    ...
    public void packVarbits() throws IOException {
        ...
        for (int i = 15024; i <= 15026; i++) {
            final mgi.types.config.VarbitDefinitions def = new VarbitDefinitions(i, new ByteBuffer(new byte[1]));
            def.setBaseVar(3702);
    ...
    public void packObjects() throws IOException {
        ...
        for (final it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<java.io.File> entry : sortedMap.int2ObjectEntrySet()) {
            final java.io.File file = entry.getValue();
            final mgi.types.config.ObjectDefinitions def = new ObjectDefinitions(objectId, new ByteBuffer(FileUtils.readFileToByteArray(file)));
    ...
    public void packGraphics() throws IOException {
        ...
        for (final it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<java.io.File> entry : sortedMap.int2ObjectEntrySet()) {
            final java.io.File file = entry.getValue();
            final mgi.types.config.GraphicsDefinitions def = new GraphicsDefinitions(graphicsId++, new ByteBuffer(FileUtils.readFileToByteArray(file)));
    ...
    public void packItems() throws IOException {
        ...
        for (final it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<java.io.File> entry : sortedMap.int2ObjectEntrySet()) {
            final java.io.File file = entry.getValue();
            final mgi.types.config.items.ItemDefinitions def = new ItemDefinitions(itemId++, new ByteBuffer(FileUtils.readFileToByteArray(file)));
    ...
    public void packNPCs() throws IOException {
        ...
        for (final it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<java.io.File> entry : sortedMap.int2ObjectEntrySet()) {
            final java.io.File file = entry.getValue();
            final mgi.types.config.npcs.NPCDefinitions def = new NPCDefinitions(npcId, new ByteBuffer(FileUtils.readFileToByteArray(file)));
            def.setVarbit(transformedVarbits.getOrDefault(def.getVarbit(), def.getVarbit()));
            objSet.add(def);
            final int originalId = entry.getIntKey();
        ...
        for (final mgi.types.config.npcs.NPCDefinitions obj : objSet) {
            ...
            if (obj.getId() == 15022) {
                final mgi.types.config.npcs.NPCDefinitions otherDef = Utils.findMatching(objSet, o -> o.getId() == 15021);
                obj.setStandAnimation(otherDef.getStandAnimation());
                obj.setWalkAnimation(otherDef.getWalkAnimation());
                obj.setRotate90Animation(otherDef.getRotate90Animation());
                obj.setRotate180Animation(otherDef.getRotate180Animation());
