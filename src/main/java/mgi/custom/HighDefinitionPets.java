...
public class HighDefinitionPets {
    ...
    private void packAnimationBase(@NotNull final AnimationBase base, final int[] anims) throws IOException {
        for (int anim : anims) {
            final java.io.File file = new File("assets/pets/animation definitions/" + anim + ".dat");
...
*/
    ...
    public void packItems() throws IOException {
        ...
        final it.unimi.dsi.fastutil.objects.Object2ObjectAVLTreeMap<java.lang.String, ModelInfo> customItems = new Object2ObjectAVLTreeMap<String, ModelInfo>();
        ...
        for (final it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<java.lang.String, ModelInfo> custom : customItems.object2ObjectEntrySet()) {
            assert def != null;
    ...
    public void packModels() throws IOException {
        ...
        for (final java.lang.Integer originalId : list) {
            final java.io.File file = new File("assets/pets/models/" + originalId + ".dat");
    ...
    public void packNPCs() throws IOException {
        ...
        for (final it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<java.io.File> entry : sortedMap.int2ObjectEntrySet()) {
            final java.io.File file = entry.getValue();
            for (int i = 0; i < 1; i++) {
                final mgi.types.config.npcs.NPCDefinitions def = new NPCDefinitions(ChristmasMapPacker.npcId, new mgi.utilities.ByteBuffer(FileUtils.readFileToByteArray(file)));
                objSet.add(def);
