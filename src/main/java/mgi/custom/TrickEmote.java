...
public class TrickEmote {
    ...
    private void packAnimationBase(@NotNull final AnimationBase base, final int[] anims) throws IOException {
        for (int anim : anims) {
            final java.io.File file = new File("assets/halloween/animations/definitions/" + anim + ".dat");
    ...
    public void packModels() throws IOException {
        ...
        for (final java.lang.Integer originalId : list) {
            final java.io.File file = new File("assets/halloween/models/" + originalId + ".dat");
